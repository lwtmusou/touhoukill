...
public:
    ...
    bool paintString(QPainter *painter, const QString &text, const int *font, const QColor &color, QSize &fontSize, int spacing, int weight, QRect &boundingBox,
                     const Qt::Orientation &orient, const Qt::Alignment &align);

    // Currently, we online support horizotal layout for multiline text
    bool paintStringMultiLine(QPainter *painter, const QString &text, const int *font, const QColor &color, QSize &fontSize, int spacing, int weight, QRect &boundingBox,
