...
class NostalOtherPackage: public Package{
    Q_OBJECT
...
public:
    ...
    bool xihua(ServerPlayer *yuji) const;
...
class NosMixinCard: public SkillCard{
    Q_OBJECT

public:
    Q_INVOKABLE NosMixinCard();
...
class NosFengyinCard: public SkillCard{
    Q_OBJECT

public:
    Q_INVOKABLE NosFengyinCard();
