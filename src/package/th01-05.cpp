...
bool BaosiCard::targetFilter(const QList<const Player *> & /*targets*/, const Player *to_select, const Player * /*Self*/) const
{
...
public:
    ...
    int getDistanceLimit(const Player * /*from*/, const Card *c) const override
    {
