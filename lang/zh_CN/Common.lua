CommonTranslationTable = {
	...
	["delayed_trick"] = "延时锦囊",
	["movable_delayed_trick"] = "流动性延时锦囊",
	["unmovable_delayed_trick"] = "一次性延时锦囊",
	["buff_card"] = "辅助伤害",
	["damage_spread"] = "伤害传导",
	["weapon"] = "武器",
	["armor"] = "防具",
	...
	["$MoveNCards"] = "%to 从 %from 处获得 %card 以及%arg 张牌",
	...
	["shown handcard self"] = "%1明置",
	["shown handcard by"] = "%1使%2明置",
	...
	["$PutNCards"] = "%from 的 %card 以及 %arg 张牌被置于摸牌堆",
	["#PutCard"] = "%from 的 %arg 张牌被置于摸牌堆",
	["normal_nature"] = "无属性",
	["fire_nature"] = "火焰属性",
	["thunder_nature"] = "雷电属性",
	...
	["$RemoveNCardsFromGame"] = "%card  以及 %arg2 张牌被作为 %arg 牌移出游戏",
