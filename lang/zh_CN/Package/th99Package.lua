...
--****************************
	...
	["zhuozhi"] = "酌志",
	[":zhuozhi"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一张【杀】当【以逸待劳】使用（选择目标含你）。此牌结算结束时，你展示一张手牌，然后获得一张与之类别相同的于此牌结算时因弃置而置入弃牌堆的牌。",
	["@zhuozhi-discard"] = "你发动酌志需要展示一张手牌",
	["wanshen"] = "完身",
	[":wanshen"] = "<font color=\"red\"><b>觉醒技，</b></font>结束阶段开始时，若你装备区里的牌数大于2，你可以减1点体力上限，获得一个额外的回合和“邪力”（出牌阶段，你可以横置装备区里的一张牌并视为使用【酒】）。",
