return{
	...
	["dangjia_attach"] = "当家拼点" ,
	[":dangjia_attach"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>若你属于外势力且拥有主公技“当家”的角色已受伤，你可以与其拼点，当你没赢后，其回复1点体力。" ,
...
--****************************
	...
	["xiufu"] = "修复" ,
	["#xiufu_temp"] = "修复" ,
	[":xiufu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一项：1.将弃牌堆里的一张装备牌置入一名角色的装备区（若已有同类装备则替换之）；2.若场上或弃牌堆里没有装备牌，你摸两张牌。" ,
...
--****************************
	...
	["@shitu-playerchoose1"] = "选择一名角色，令其获得一个额外的回合（在你回合结束后进行之）。此回合只有%arg2。",
	["@shitu-playerchoose2"] = "选择一名角色，令其获得一个额外的回合（在你回合结束后进行之）。此回合只有%arg和%arg2。",
	["ShituDrawPhase"] = "摸牌阶段",
	["ShituPlayPhase"] = "出牌阶段",
...
--****************************
	...
	["lianxi"] = "连系",
	[":lianxi"] = "当你使用或打出【杀】时，或于弃牌阶段弃置【杀】后，你可以视为使用或重铸【铁索连环】。",
	["@lianxi"]= "<font color=\"orange\"><b>连系：</b></font>你可以视为使用或重铸【铁索连环】。",
	["~lianxi"]= "选择一至两名角色为【铁索连环】的目标 -> 确定；或直接 确定 ->视为重铸一张【铁索连环】。",
	["yueshi"] = "月使",
	[":yueshi"] = "<font color=\"purple\"><b>觉醒技，</b></font>准备阶段开始时，若你处于异常状态，你减1点体力上限，摸两张牌，然后获得“睿智”（当普通锦囊牌对你结算结束时，若你已受伤，你可以判定，若结果为红色，你回复1点体力）。",
...
--****************************
	...
	["yushou"] = "御兽",
	[":yushou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一名角色装备区里的一张牌置入另一名角色的装备区里，然后前者可以对后者造成1点伤害。",
	["yushou_damage:confirm"]= "你可以通过 <font color=\"#FFFF00\"><b> “御兽”</b></font> 的效果，对<font color=\"#FF8000\"><b>%src </b></font> 造成1点伤害。",
...
--****************************
	...
	["wanshen"] = "完身",
	[":wanshen"] = "<font color=\"purple\"><b>觉醒技，</b></font>结束阶段开始时，若你装备区里的牌数大于2，你减1点体力上限，获得一个额外回合和“邪力”（出牌阶段，你可以横置装备区里的一张牌并视为使用【酒】）。",
