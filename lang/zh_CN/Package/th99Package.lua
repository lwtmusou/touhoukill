...
--****************************
	...
	["zhuozhi"] = "酌志",
	[":zhuozhi"] = "出牌阶段限一次，你可以弃置一张手牌，亮出牌堆顶四张牌并获得其中一张牌。若其中有装备牌或【杀】，你额外获得一张牌。",
	["wanshen"] = "完身",
	[":wanshen"] = "限定技，出牌阶段，若你装备区里的牌数大于2，你可以减1点体力上限，获得一个额外的回合和“邪力”。",
	["@kasenwanshen"] = "完",
	["$WanshenAnimate"] = "skill=kasen_sp:wanshen",
	["xieli"] = "邪力",
	[":xieli"] = "出牌阶段<b>空闲时间点</b>，你可以横置装备区里的一张牌并视为使用【酒】",
