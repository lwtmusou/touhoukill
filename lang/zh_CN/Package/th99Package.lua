return{
	...
	["dangjia"] = "当家" ,
	[":dangjia"] = "<font color=\"orange\"><b>主公技，</b></font><font color=\"green\"><b>其他外势力角色的出牌阶段限一次，</b></font>若你已受伤，其可以与你拼点，当其没赢后，你回复1点体力。",
	["dangjia_attach"] = "当家拼点" ,
	[":dangjia_attach"] = "若你属于外势力，你可以和已受伤且拥有主公技“当家”的角色拼点，当你没赢后，该角色回复1点体力。" ,
...
--****************************
	...
	["xiufu"] = "修复" ,
	["#xiufu_temp"] = "修复" ,
	[":xiufu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将弃牌堆里的一张装备牌置入一名角色的装备区（若已有同类型的牌则替换之）。" ,
	["@xiufu-move"] = "你可以将弃牌堆里的一张装备置入一名角色的装备区里，以此法可以替换已有的装备牌。",
	["~xiufumove"] = "选择弃牌堆里的一张装备牌 -> 选择一名角色",
...
--****************************
	...
	["@fandu-select"] = "由于“泛读”的效果，请选择一名其他角色，令其弃置你的一张手牌。",
	["taohuan"] = "讨还",
	[":taohuan"] = "当其他角色弃置你的一张非基本牌后或获得你的一张牌后，你可以与其拼点，当你赢后，你获得其一张牌。",
	["taohuanshow:show"] = "<font color=\"#00FF00\"><b>%src </b></font> 获得了你的手牌，你可以发动“讨还”。",
	["taohuanshow"]= "讨还",
...
--****************************
	...
	["@shitu-playerchoose"] = "选择一名角色，令其获得一个额外的回合（在你回合结束后进行之），但此回合只有摸牌阶段。",
...
--****************************
	...
	["~lianxi"]= "选择一至两名角色为【铁索连环】的目标 -> 确定；或直接 确定 ->视为重铸一张【铁索连环】。",
	["yueshi"] = "月使",
	[":yueshi"] = "<font color=\"purple\"><b>觉醒技，</b></font>准备阶段开始时，若你处于异常状态，你加1点体力上限，然后获得“睿智”（当普通锦囊牌对你结算结束时，若你已受伤，你可以判定，若结果为红色，你回复1点体力）。",
	["#YueshiWake"] = "%from 处于异常状态，触发“%arg”觉醒。",
...
--wai009  势力：外 4血
	...
	["jijing"] = "寂静",
	[":jijing"] = "你于回合内对其他角色造成伤害后，你可以选择包括其的至多x名其他角色，你与这些角色的距离于此回合内视为1。你于其他角色的回合内受到伤害后，你选择除其以外的至多x名角色，其与这些角色的距离于此回合内无限大。（x为你已损失体力且至少为1）",
	["@jijing-41"] = "你造成了伤害，请选择 %arg 名其他角色，你与这些角色的距离于此回合内视为1。",
	["@jijing-41i"] = "你对 %src 造成了伤害，请选择包含 %src 的 %arg 名其他角色，你与这些角色的距离于此回合内视为1。",
	["@jijing-42"] = "你受到了伤害，请选择除当前回合角色以外的 %arg 名角色，当前回合角色与这些角色的距离于此回合内无限大。",
	["@jijing"] = "寂静",
...
--****************************
	...
	["zhuxi"] = "助戏",
	[":zhuxi"] = "其他角色使用锦囊牌指定目标时，你可失去1点体力，取消此牌的一名目标角色。",
	["@zhuxi-cancel"] = "你可以发动“助戏”取消一名目标角色。",
...
--****************************
	...
	["zhujiu"] = "祝酒",
	[":zhujiu"] = "当其他角色成为【桃】或【酒】的目标后，你可以将一张牌交给其，你摸一张牌。",
	["@zhujiu"] = "你可以发动“祝酒”，交给 %src 一张牌，之后你摸一张牌",
	["yushou"] = "御兽",
	[":yushou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一名角色的装备区里的一张牌置入另一名角色的装备区，令前者选择是否对后者造成1点伤害。",
	["yushou_damage:confirm"]= "你可以通过 <font color=\"#00FF00\"><b> “御兽”</b></font> 的效果，对<font color=\"#FF8000\"><b>%src </b></font> 造成1点伤害。",
...
--****************************
	...
	["pandu"] = "判读",
	[":pandu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一名有手牌的其他角色的一张手牌，若此牌为：【杀】，其对你使用之（无距离限制）；非基本牌，你获得之。",
	["bihuo"] = "避祸",
...
--**************************************
	...
	["jidong"] = "急冻",
	[":jidong"] = "当你成为【杀】或【决斗】的目标后，你可以弃置一张基本牌，令此牌的使用者选择一项：弃置一张点数大于你弃置的牌的手牌；或令此牌对你无效。",
...
--**************************************
	...
	["#zhangmu_return"]= "%from 获得了人物牌上的 %arg2 张 “%arg”牌",
	["liyou"] = "利诱",
	[":liyou"] = "准备阶段开始时，你可以令一名其他角色视为对你使用【顺手牵羊】。",
	["@liyou"] = "若你区域里有牌，你可以发动“利诱”，选择一名角色，令其视为对你使用【顺手牵羊】（无距离限制）",
...
--****************************
	...
	["daoyao"] = "捣药",
	[":daoyao"] = "当一名角色回复体力后，你可以选择一项：令一名人物牌的横竖放置方式与你相同的其他角色摸一张牌；或令当前回合角色弃置一张牌。",
