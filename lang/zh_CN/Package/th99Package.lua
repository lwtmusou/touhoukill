...
--****************************
	...
	["pingyi"] = "凭依",
	[":pingyi"] = "当你对其他角色造成伤害后或当你受到其他角色造成的伤害后，若其存活，你可令该角色的一个有效的技能（主公技，限定技，觉醒技，永久技除外）无效，你获得此技能。若如此做，当你的回合结束时或你死亡时或下一次你发动“凭依”时，你失去此技能，该角色的此技能恢复有效。<font color=\"green\"><b>每回合限一次。</b></font>",
...
--****************************
	...
	["yushou"] = "御兽",
	[":yushou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一名角色装备区里的一张装备牌置入另一名角色的装备区，前者可以对后者造成1点伤害。",
...
--****************************
	...
	["bihuo"] = "避祸",
	[":bihuo"] = "当你成为【杀】的目标时，你可以将所有手牌交给一名其他角色，将此【杀】转移给该角色。若如此做，此回合结束时，其将等量的手牌交给你。",
