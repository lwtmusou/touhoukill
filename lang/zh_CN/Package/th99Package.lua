return{
	...
	["dangjia"] = "当家" ,
	[":dangjia"] = "<font color=\"orange\"><b>主公技，</b></font><font color=\"green\"><b>其他外势力角色的出牌阶段限一次，</b></font>若你已受伤，其可以与你拼点，若其没赢，你回复1点体力。",
	["dangjia_attach"] = "当家拼点" ,
...
--****************************
	...
	["taohuan"] = "讨还",
	[":taohuan"] = "当其他角色弃置你的一张非基本牌后或获得你的一张牌后，你可以与其拼点，若你赢，你获得其一张牌。",
...
--****************************
	...
	["zheshe"] = "折射",
	[":zheshe"] = "当你受到伤害时，若来源不是你，你可以弃置一张手牌，防止此伤害，并对一名角色造成1点伤害。此伤害结算结束时，其摸X张牌（X为其已损失的体力值）。",
...
--wai009  势力：外 4血
	...
	["jijing"] = "寂静",
	[":jijing"] = "<font color=\"blue\"><b>锁定技，</b></font>当其他角色于你的回合内受到伤害后，你与其的距离于此回合内视为1。",
	["@jijing"] = "寂静",
...
--****************************
	...
	["pandu"] = "判读",
	[":pandu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一名其他角色的一张手牌：若此牌为【杀】，其须对你使用此牌；若此牌不为基本牌，你获得此牌。",
	["bihuo"] = "避祸",
	[":bihuo"] = "当你成为【杀】的目标时，你可以将所有手牌交给一名不是此【杀】的使用者或目标的其他角色，令其代替你成为此【杀】的目标。若如此做，此回合结束时，其将等量的手牌交给你。",
...
--**************************************
	...
	["jidong"] = "急冻",
	[":jidong"] = "当你成为其他角色使用【杀】或【决斗】的目标后，你可以弃置一张与此牌类别相同的手牌，令其选择一项：弃置一张点数大于你弃置的牌的手牌，或令此牌对你无效。",
