...
--****************************
	...
	["pingyi"] = "凭依",
	[":pingyi"] = "当你对其他角色造成伤害后或当你受到其他角色造成的伤害后，若其存活，你可以选择该角色的一个有效的技能（主公技，限定技，觉醒技，永久技除外）。若如此做：你失去此前以此法获得的技能，令你选择的技能无效，你获得此技能；当该角色死亡后或失去以此法无效的技能后或你的回合结束时，你失去以此法获得的技能；当你死亡时或失去以此法获得的技能后，以此法无效的技能恢复有效。<font color=\"green\"><b>每回合限一次。</b></font>",
