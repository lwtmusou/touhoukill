...
--****************************
	...
	["shitu"] = "识途",
	[":shitu"] = "非额外的回合结束时，若你于此回合内没有造成过伤害，你可以令一名角色获得仅有摸牌阶段的一个额外的回合。",
...
--****************************
	...
	["daoyao"] = "捣药",
	[":daoyao"] = "当一名角色回复体力后，你可以选择一项：令人物牌的横竖放置方式与你相同的一名其他角色摸一张牌；或令当前回合角色弃置一张牌。",
	["daoyao_discard"]= "%src 发动“捣药” 令你弃置 1 张牌",
	["@daoyao"] = "你可以发动 “捣药” ，选择 人物牌的横竖放置方式与你相同 的一名其他角色 ，然后点击 确定 ，令该角色摸一张牌；<br />或直接点击 确定，令当前回合的角色弃置一张牌。",
