return{
    ...
    ["!wai005"] = "玛艾露贝莉",
    ["mengxian"] = "梦现", 
    [":mengxian"] = "<font color=\"purple\"><b>觉醒技，</b></font>回合开始阶段开始时，若你的人物牌上有不少于三张“境界”，你须失去1点体力上限，然后回复1点体力，并获得技能“乱影”（每当其他角色使用或打出一张基本牌时（代替判定牌时除外），你可以将一张与此牌颜色相同的“境界”加入该角色的手牌，并令此牌无效）。", 
