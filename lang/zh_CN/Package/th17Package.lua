...
--***********************************
	...
	["@zaoxing-show"] = "造形你可以明置至少一张花色相同的手牌",
	["~zaoxing1"] = "选择任意张手牌 -> “确定”",
	["@zaoxing-recast"] ="造形你可以重铸至少一张对应颜色的明知手牌",
	["~zaoxing2"] = "选择任意张明置手牌 -> “确定”",
	["lingshou"] = "灵守",
	[":lingshou"] = "结束阶段开始时，你可观看一名角色的手牌，并展示其中至多二张花色相同的牌，其须选择将这些牌重铸或当【杀】使用。",
	["@lingshou-kill"] = "灵守你可以观看一名角色的手牌",
	["@lingshou-slash"] = "灵守你因灵守的效果被展示了牌，你需要将这些牌重铸或当杀使用",
	["~LingshouOtherVS"] = "（如果使用【杀】）选择被展示的牌和目标 -> “确定”<br/> （如果重铸）“取消”",
	["zhuying"] = "祷应",
	[":zhuying"] = "主公技，鬼势力其他角色的出牌阶段限一次，其可以选择一名角色为目标并将一张手牌交给你，你可以令其他角色于此回合内与目标距离-1。",
	["zhuying_attach"] = "祷应贿赂",
	[":zhuying_attach"] = "出牌阶段限一次，你可以选择一名角色为目标并将一张手牌交给一名有“祷应”的角色。该角色可以令除该角色外的角色于此回合内于目标距离-1",
	["@zhuying-multilord"] = "祷应场上有多个拥有主公技祷应的角色，请选择你要贿赂的主公。",
	["zhuying-effect:effect"] = "祷应你可以接受贿赂，令其他角色与 %src 的距离 -1",
	...
	["bengluo:@bengluo-draw"] = "崩落：你可以摸 %arg 张牌来让【杀】的伤害+1<br /> <br /> 操作提示：“确定”",
