...
--***********************************
	...
	["@zaoxing-show"] = "造型你可以明置至少一张花色相同的手牌",
	["~zaoxing1"] = "选择任意涨手牌 -> “确定”",
	["@zaoxing-recast"] ="造型你可以重铸至少一张对应颜色的明知手牌",
	["~zaoxing2"] = "选择任意涨明置手牌 -> “确定”",
	["lingshou"] = "灵守",
	[":lingshou"] = "结束阶段开始时，你可观看一名角色的手牌，并展示其中至多二张花色相同的牌，其须选择将这些牌重铸或当【杀】使用。",
	["@lingshou-kill"] = "零售你可以观看一名角色的手牌",
	["@lingshou-slash"] = "零售你因零售的效果被展示了牌，你需要将这些牌重铸或当杀使用",
