...
--***********************************
	...
	["keiki"] = "埴安神袿姬" ,
	["#keiki"] = "孤立无援造就的造形神" ,
	["designer:keiki"] = "吉八弔千慧",
	["illustrator:keiki"] = "チーズロル",
	["origin:keiki"] = "p号：76339117；个人id：18498712",
	["zaoxing"] = "造形",
	[":zaoxing"] = "出牌阶段开始时，你可以明置至少一张花色相同的手牌；当其他角色成为牌的唯一目标时，你可以重铸至少一张与之花色相同的明置手牌，然后重铸牌数大于1，其摸一张牌。",
	["@zaoxing-show"] = "造形：你可以明置至少一张花色相同的手牌",
	["~zaoxing1"] = "选择要明置的花色相同的手牌 -> 确定",
	["@zaoxing-recast"] ="造形：你可以重铸至少一张与之花色相同的明置手牌，若重铸数量大于1，该角色摸一张牌",
	["~zaoxing2"] = "选择与之花色相同的明置手牌 -> “确定”",
	["lingshou"] = "灵守",
	...
	["zhuying"] = "祷应",
	[":zhuying"] = "<font color=\"orange\"><b>主公技，</b></font></font><font color=\"green\"><b>其他鬼势力角色的出牌阶段限一次，</b></font>其可以选择一名角色为目标并将一张手牌交给你，你可以令所有其他角色于此回合内与目标距离-1。",
	["zhuying_attach"] = "祷应贿赂",
	[":zhuying_attach"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名角色为目标并将一张手牌交给一名有“祷应”的角色，然后其可以令除其和目标外的角色于此回合内于目标距离-1",
	["@zhuying-multilord"] = "祷应场上有多个拥有主公技“祷应”的角色，请选择你要贿赂的角色。",
