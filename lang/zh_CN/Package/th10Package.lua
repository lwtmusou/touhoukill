return{
	...
	[":gongfeng_attach"]= "出牌阶段限一次，若你属于风势力，你可以于出牌阶段将一张【杀】交给拥有主公技“供奉”的角色。",
...
--************************************************
	...
	["@chuancheng"] = "指定一名其他角色，令其获得“传承”“乾坤”以及你区域里的所有牌。",
...
--************************************************
	...
	["changshi"] = "常识",
	[":changshi"] = "<font color=\"#808080\"><b>永久技，</b></font>回合开始时，你令所有其他角色的技能于此回合内无效（永久技除外），将其所有置于人物牌上和旁、移出游戏的游戏牌置入弃牌堆，弃所有标记。",
	["#changshi01"]= "%from 的 “%arg”被触发，所有其他角色的技能（永久技除外）于%from 的回合内无效。",
	["@changshi"] = "常识",
	["jinian"] = "纪念",
