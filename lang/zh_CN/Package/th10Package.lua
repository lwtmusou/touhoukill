...
--************************************************
    ...
    ["bushu"] = "不输",
    [":bushu"] = "每当你或你攻击范围内的一名角色受到伤害后，你可以与伤害来源拼点：若你赢，该角色回复1点体力；若你没赢，你获得伤害来源的拼点牌。",
...
--************************************************
    ...
    ["micai"] = "迷彩",
    [":micai"] = "<font color=\"blue\"><b>锁定技，</b></font>每当你受到伤害时，若此伤害多于X点（X为你的手牌数），防止多余的伤害。",
...
--************************************************
  ...
  --["designer:hina"] = "星野梦美 | 程序:三国有单", 
    ...
    ["jie"] = "集厄", 
	[":jie"] = "每当其他角色受到伤害时，你可以摸一张牌，并将此伤害转移给你。",
...
--************************************************
    ...
    ["@changshi"] = "常识",
    ["jinian"] = "纪念", 
    [":jinian"] = "若你失去最后的手牌，且这些牌置入弃牌堆后，你可以获得之。<font color=\"green\"><b>每阶段限一次，</b></font>",
