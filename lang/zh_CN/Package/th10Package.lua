...
--************************************************
	...
	["fengshen"] = "风神",
	[":fengshen"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张红色手牌并选择你攻击范围内的一名角色或距离为1的任意数量的角色，令这些角色各选择一项：弃置一张【杀】；或受到你造成的1点伤害。",
...
--************************************************
	...
	[":changshi"] = "回合开始时，你可以选择一至两项：令所有其他角色的技能于此回合内无效（除永久技外）；或视为使用【联军盛宴】。",
	["#changshi01"]= "%from 的 “%arg”被触发，所有其他角色的技能（除永久技外）于%from 的回合内无效。",
	["@changshi"] = "常识",
	["changshi:skillInvalid"] = "令全场技能失效",
