...
--*************************************
	...
	[":xianshi"] = "你使用基本牌或普通锦囊牌时可<font color=\"green\"><b>组合</b></font>一张此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />" ..
					"♦<font color=\"green\"><b>组合</b></font>后的效果为“被组合的效果A + 本牌效果B”。被组合的效果需对目标牌的使用者结算。【酒】被组合时，效果为回复体力。",
...
--*************************************
	...
	["qizhi"] = "气质",
	[":qizhi"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时或当你的体力值变化后，当前回合角色声明任意一张延时类锦囊牌（须与前一次选择不同），记为“气”。一名角色的判定阶段开始时，若其判定区没有牌，其执行“气”对应牌的效果。",
	["#qizhi"]= "%from 选择了 新的气质： %arg 。",
	["#qizhi_judge"]= "由于“%arg”的效果，%from 将执行 %arg2 的效果。",
	["tiandao"] = "天道",
	[":tiandao"] = "当一名角色的判定牌生效后，你可以对其使用此牌，若如此做，你中止此次判定的后续结算或效果。每轮限X次（X为你的体力值）",
	["@tiandao"] = "天道使用次数",
