return{
	...
	["chuanghuan"] = "创幻",
	[":chuanghuan"] = "<font color=\"#808080\"><b>永久技，</b></font>所有玩家亮出人物牌后，你随机观看游戏外人物牌堆中的X张牌（X为角色数），选择其中一张牌替换此人物牌（体力上限和体力值调整至调整至相应的数值，势力相应改变）。",
...
--*************************************
	...
	["jinguo"]= "禁果",
	[":jinguo"]= "<font color=\"blue\"><b>锁定技，</b></font>出牌阶段结束时，你判定，若结果为<font size=\"5\", color=\"#808080\"><b>♠</b></font>，你跳过弃牌阶段。否则你选择一项：弃置X张牌（X为“禁忌”标记数）；或失去X/2点体力（结果取整）。",
...
--*************************************
	...
	["zuosui:discard"]= "弃牌",
	["worao"] = "沃饶",
	[":worao"] = "当你成为其他角色使用【杀】或普通锦囊牌的目标后，若此牌为非转化牌，你可以摸两张牌并获得1枚“信仰”标记，然后将一张手牌交给其。",
...
--*************************************
	...
	["gaizong"]= "改宗",
	[":gaizong"]= "<font color=\"purple\"><b>觉醒技，</b></font>结束阶段开始时，若势力数不大于2，你减1点体力上限，然后重新决定势力，失去“弘佛”，获得“问道”（出牌阶段开始时，你可以选择至少一名势力各不相同的有手牌的角色，弃置这些角色的各一张手牌。若如此做，当你以此法弃置一张红色牌后，你回复1点体力）。",
	["#GaizongWake"] = "场上势力数不大于2， %from 触发“%arg”觉醒。",
	["$gaizongAnimate"]= "skill=miko_god:gaizong",
	["wendao"]= "问道",
	[":wendao"]= "出牌阶段开始时，你可以选择至少一名势力各不相同的有手牌的角色，弃置这些角色的各一张手牌。若如此做，每当你以此法弃置一张红色牌后，你回复1点体力。",
...
--*************************************
	...
	["xianshi"] = "贤石",
	[":xianshi"] = "你于出牌阶段的空闲时间点使用手牌里的普通锦囊牌/【杀】选择目标时，若此阶段内你使用的上一张牌为【杀】/普通锦囊牌，你可以将此牌的效果改为“上一张牌的效果+此牌的效果”。",
	...
	[":yueyao"] = "当你需要使用【闪】时，若当前回合角色处于异常状态，你可以视为使用【闪】。若如此做，此牌结算结束后，你视为使用【联军盛宴】。",
