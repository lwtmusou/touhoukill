...
--*************************************
	...
	["xuying"] = "虚影",
	[":xuying"] = "<font color=\"#808080\"><b>永久技，</b></font>当你抵消【杀】时，你摸一张牌。当【杀】对你生效时，若你有手牌，你弃置一半的手牌（向下取整且最少为一）。",
...
--*************************************
	...
	["shenshou"] = "神授",
	[":shenshou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可展示一张手牌并将其交给一名其他角色。若此牌为你最后的手牌，此牌视为【杀】，花色视为<font size=\"5\", color=\"#808080\"><b>♠</b></font>，点数视为5。<br /> 1. 若此牌为【杀】，你可令该角色视为对其攻击范围内的由你指定的一名角色使用【杀】。<br />2. 若此牌为<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你可令该角色获得其攻击范围内的由你指定的一名角色的一张手牌。 <br />3. 若此牌的点数为5-9，你可以摸一张牌。",
...
--*************************************
	...
	["huaxiang"] = "华想",
	[":huaxiang"] = "当你需要使用或打出基本牌或【无懈可击】时，你可以声明之（若你的体力上限大于3，不能声明【闪】；若你的体力上限大于2，不能声明【桃】；若你的体力上限大于1，不能声明【无懈可击】），并将一张与你人物牌上的任何一张牌花色均不同的手牌置于你的人物牌上，称为“虹”，你视为使用或打出了一张你声明的牌。",
...
--*************************************
	...
	["zuosui:discard"]= "弃牌",
	["worao"] = "沃饶",
	[":worao"] = "当你成为其他角色使用的【杀】或非延时类锦囊牌的目标后，你可以摸两张牌并获得一枚“信仰”标记，然后将一张手牌交给该角色。",
...
--*************************************
	...
	["#satori_god"] = "大家的心病",
	["xinhua"] = "心花",
	[":xinhua"] = "当你成为其他角色使用的牌的目标后或当你使用牌指定其他角色为目标后，你可以选择你和该角色的各一张手牌，交换之并依次明置之。",
	["dongcha"] = "洞察",
	[":dongcha"] = "当其他角色使用牌时，你可以暗置你的一张与此牌类别相同的明置手牌，取消此牌的所有目标。若此牌为明置手牌，你可以明置其一张手牌。",
	["@dongcha"] = "“洞察”： 你可以将一张明置的 %arg 暗置， 令 %dest 使用的 %src 无效",
	["zhuiyi"] = "追忆",
	...
	["#yuyuko_god"] = "天衣无缝的亡灵",
	["fanhun"] = "反魂",
	[":fanhun"] = "<font color=\"#808080\"><b>永久技，</b></font>你没有濒死状态。结束阶段开始时，若你体力小于1，你回复体力至体力上限，然后失去1点体力上限。",
	["youdie"] = "诱蝶",
	[":youdie"] = "<font color=\"blue\"><b>锁定技，</b></font>你的回合结束时，对于下列的前x项条件，若你满足其中任意一条，你获得x枚蝶标记，摸x牌。（X为你因反魂而失去的体力上限数+1。）其他角色回合结束时，对于下列的前x项条件，若其未能全部满足，你选择：弃1枚蝶标记，或 其与你依次失去1点体力。 <br />1当前回合人使用过牌  <br />2当前回合人造成过伤害  <br />3 当前回合人手牌数全场最少 <br />4 当前回合人体力全场最少  <br />5有角色进入过濒死状态",
	["@die"] = "蝶",
	...
	["#aya_god"] = "风雨之鸦" ,
	["tianqu"] = "天衢",
	[":tianqu"] = "<font color=\"blue\"><b>锁定技，</b></font>一名角色的准备阶段开始时，若没有角色有“路”标记，你获得一枚“路”标记。一名角色计算与另一名没有“路”标记的角色的距离时，视为其座位与有“路”标记的角色的座位相同。",
	["@road"] = "路",
	["duyu"] = "渡御",
	[":duyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当其他角色于其出牌阶段内第一次使用的【杀】结算完毕后，若有角色有“路”标记，你选择一项：对当前回合的角色使用【杀】；或弃一名角色的所有“路”标记，令其下家获得一枚“路”标记。",
	["@duyu"] = "渡御： 你须对 <font color=\"#00FF00\"><b>%src </b></font> 使用【杀】，或将  <font color=\"red\"><b>%dest </b></font> 的路标记移至下家",
	["fengmi"] = "风靡",
	[":fengmi"] = "你可以将X张手牌当【杀】使用，此【杀】无距离限制且目标须包含距离为X的角色。当你以此法使用红色【杀】时，你摸一张牌。",
