...
--*************************************
	...
	["chongneng"] = "充能",
	[":chongneng"] = "你使用<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌时，可以摸一张牌，然后将一张手牌置于人物牌上，称为“星”。",
	["chongneng-exchange"] = "你发动了“充能”，请将一张手牌作为“星”置于人物牌上",
	["stars"] = "星",
	["huixing"] = "彗星",
	[":huixing"] = "你使用基本牌或普通锦囊牌指定目标后，你可将一张“星”置入弃牌堆，令此牌的效果基数+1。你使用基本牌或普通锦囊牌对唯一目标结算完毕后，你可将一张“星”置入弃牌堆，视为对其下家使用同名牌。",
