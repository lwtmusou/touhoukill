...
--*************************************
	...
	["jinguo"]= "禁果",
	[":jinguo"]= "<font color=\"blue\"><b>锁定技，</b></font>出牌阶段结束时，你判定，若结果为<font size=\"5\", color=\"#808080\"><b>♠</b></font>，你弃1枚“禁忌”标记并跳过弃牌阶段，否则你选择一项：弃置X张牌；或失去X/2点体力（X为标记数,结果向下取整）。",
...
--*************************************
	...
	["anyun"] = "暗云",
	[":anyun"] = "游戏开始时，你随机将三张游戏外的人物牌扣置于一旁称为“X”；若你无明置“X”，你可以于相应时机明置一张“X”并发动或触发其上的技能，并于移除此“X”之前拥有其上所有技能（前述技能均不含永久、限定和觉醒技。回合开始时，你可以明置无发动时机或只能其他角色发动技能的一张“X”）。",
	["benzun"] = "本尊",
	[":benzun"] = "<font color=\"blue\"><b>锁定技，</b></font>一名角色的回合结束时，若你有明置的“X”，随机将游戏外的一张人物牌扣置于一旁称为“X”，移除明置的“X”，然后将体力上限调整至游戏开始时，弃相应的标记和将人物牌上的牌置入弃牌堆。 ",
...
--*************************************
	...
	["kuangji"] = "狂季",
	[":kuangji"] = "当你使用手牌结算完毕后，或当你受到伤害后，你可以选择一项：将牌堆顶的四张牌置入弃牌堆；或将所有“叶”以任意顺序置于牌堆底。",
	["kuangji:discardpile"] = "将牌堆顶的牌置入弃牌堆",
	["kuangji:putleaftoend"] = "将“叶”置于牌堆底",
	["#xiuye_temp"] = "朽叶",
