...
--*************************************
	...
	["bingfeng"] = "冰封",
	[":bingfeng"] = "<font color=\"#808080\"><b>永久技，</b></font>其他角色因受到你造成的伤害进入濒死状态时，其获得一枚“冰封”标记。你对有“冰封”标记的角色造成伤害时，此伤害-1。回合开始时，若所有其他角色均有“冰封”标记，你的阵营获胜。",
	["wushen"] = "武神",
...
--*************************************
	...
	["qinlue"] = "侵略" ,
	[":qinlue"] = "其他角色的出牌阶段开始前，你可以弃置一张【杀】或装备牌，令其选择一项：弃置一张【闪】，或跳过此出牌阶段。若其以此法跳过出牌阶段，此回合结束后，你进行一个仅有出牌阶段的额外回合。此额外回合开始时，你将所有手牌扣置于人物牌上，称为“战备”，然后获得其的所有手牌。此额外回合结束时，你将所有手牌交给其，然后获得所有“战备”。",
	["zhanbei"] = "战备" ,
...
--*************************************
	...
	["tongling"] = "通灵",
	[":tongling"] = "<font color=\"red\"><b>限定技，</b></font>回合开始时，你可以获得一名死亡角色的人物牌，并获得其上的一个技能（永久技，觉醒技，主公技除外，且名称与其他角色拥有的任何技能均不同）。",
