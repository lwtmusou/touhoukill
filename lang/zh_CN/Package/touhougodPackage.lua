...
--*************************************
	...
	["#xiuye_temp"] = "朽叶",
	["@kuangji"] = "狂季: 你可弃置任意张【%src】，令当前使用的牌：<br />1. 增加等量额外目标 <br /> 2.令此牌增加等量的效果值 ",
	["~kuangji"] = "选择角色->确定 为选项1，不选择->确定 为选项2",
	...
	["qizhi"] = "气质",
	[":qizhi"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时或你体力值变化后，当前回合人需选择一张延时锦囊名称（不得与前一次选择相同），称为“气”。一名角色的判定阶段开始时，若其判定区没有牌，其执行“气”对应的效果。",
	["#qizhi"]= "%from 选择了 新的气质： %arg 。",
	["#qizhi_judge"]= "由于“%arg”的效果，%from 将执行 %arg2 的效果。",
	["tiandao"] = "天道",
	[":tiandao"] = "一名角色的判定牌生效后，你可对其使用此牌。若如此做，中止此次判定的后续结算或效果。每轮限x次（x为你的体力值）",
	["@tiandao"] = "天道使用次数",
