...
--*************************************
	...
	["rainbow"] = "虹",
	["caiyu"] = "彩雨",
	[":caiyu"] = "一名角色的结束阶段开始时，若“虹”数大于3，你可以获得所有“虹”，弃置两张手牌，然后你可以减1点体力上限。",
...
--*************************************
	...
	["hongfo"]= "弘佛",
	[":hongfo"]= "摸牌阶段摸牌后，你可以令势力与你相同的所有角色各摸一张牌，然后令与你势力不同的一名角色将其势力改变为你的势力。",
	...
	["gaizong"]= "改宗",
	[":gaizong"]= "<font color=\"purple\"><b>觉醒技，</b></font>结束阶段开始时，若势力数不大于2，你减1点体力上限，然后重新决定势力，失去“弘佛”，获得“问道”（出牌阶段开始时，你可以选择势力各不相同的有手牌的至少一名角色，弃置这些角色的各一张手牌，每当你以此法弃置一张红色牌后，你回复1点体力）。",
	["#GaizongWake"] = "场上势力数不大于2， %from 触发“%arg”觉醒。",
	["$gaizongAnimate"]= "skill=miko_god:gaizong",
	["wendao"]= "问道",
	[":wendao"]= "出牌阶段开始时，你可以选择势力各不相同的有手牌的至少一名角色，弃置这些角色的各一张手牌。每当你以此法弃置一张红色牌后，你回复1点体力。",
...
--*************************************
	...
	["huixing"] = "彗星",
	[":huixing"] = "当你使用基本牌或普通锦囊牌对唯一角色目标结算完毕后，你可以弃1枚“星”标记，视为对其下家使用同名牌且继承效果值。",
...
--*************************************
	...
	["xianji"] = "献祭",
	[":xianji"] = "当你进入濒死状态时，你可以选择装备区里有牌的一名其他角色，你死亡（无来源），然后令其失去或回复X点体力（X为其装备区里的牌数）。",
