...
--*************************************
	...
	["shenshou"] = "神授",
	[":shenshou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一张手牌并将此牌交给一名其他角色（若此牌是你最后的手牌，此牌在展示时视为点数为5的<font size=\"5\", color=\"#808080\"><b>♠</b></font>【杀】）。若你以此法展示：<br /> 1. 【杀】，你可以令其视为对其攻击范围内你选择的一名角色使用【杀】。<br />2. <font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你可以令其获得其攻击范围内你选择的一名角色的一张手牌。 <br />3. 点数为5-9的牌，你可以摸一张牌。",
...
--*************************************
	...
	[":xianshi"] = "你可将一张基本牌/锦囊牌当作效果为“本回合指定过目标角色的普通锦囊/基本牌原效果 + 本牌效果”的同名牌使用。（【闪】【无懈可击】的追加效果结算对象为目标牌的使用者）<font color=\"green\"><b>每回合限一次</b></font>",
	
	["#Xianshi"] = "%from 发动 <font color=\"#00FF00\">贤石</font>， 令下一张牌【%arg】效果为 【%arg2】 + 【%arg】 " ,
	["riyue"] = "日月",
	[":riyue"] = "限定技，你于出牌阶段空闲点使用红色牌/黑色牌时，你可额外指定任意名目标。若此牌令目标受到火属性伤害/回复体力，回合结束后，重置此技能。",
	["riyao"] = "日曜",
...
--*************************************
	...
	["wenyue"] = "文乐",
	[":wenyue"] = "一名角色的装备牌进入弃牌堆后，你可弃置一张非装备牌，将之置入另一名角色的装备区。若如此做，你可将技能“千枪”或“献祭”转移给其中一名角色。",
	["#wenyue_temp"] = "文乐",
	["@wenyue"] = "你可发动“文乐”，弃置一张非装备牌，将进入弃牌堆的一张装备牌置入一名角色的装备区。",
	["~wenyue"] = "选择一张装备牌和要弃置的手牌--》选择装备移动的目标-->确定。",
	["@wenyue_handleAcquireDetachSkill"] = "你可发动“文乐”，将技能“千枪” 或 “献祭”转移给一名角色。",
	["qianqiang"] = "千枪",
	[":qianqiang"] = "出牌阶段限一次，你可以将一张装备牌置入其他角色的装备区，视为对其使用【杀】。",
	["xianji"] = "献祭",
	[":xianji"] = "你进入濒死状态时，你可选择一名装备区有牌的其他角色，你死亡（无来源），然后令其失去或回复x点体力（x为其装备区牌数）。",
	["@xianji"] = "你可以对一名装备区有牌的角色发动“献祭”。",
	["xianji:loseHP"] = "失去体力" ,
