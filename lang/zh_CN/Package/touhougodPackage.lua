...
--*************************************
	...
	[":xianshi"] = "每回合限一次。你可将一张基本牌/锦囊牌当作效果为“本回合指定过目标角色的普通锦囊/基本牌原效果 + 本牌效果”的同名牌使用。（【闪】【无懈可击】所含追加效果的结算对象为目标牌的使用者）",
...
--*************************************
	...
	["wenyue"] = "文乐",
	[":wenyue"] = "一名角色的装备牌进入弃牌堆后，你可弃置一张非装备牌，将之置入另一名角色的装备区。你令其中一名角色获得技能“千枪”或“献祭”直到有角色以此法获得同名技能。",
	["qianqiang"] = "千枪",
	[":qianqiang"] = "出牌阶段限一次，你可以将一张装备牌置入其他角色的装备区，视为对其使用【杀】。",
	["xianji"] = "献祭",
	[":xianji"] = "你进入濒死时，你可死亡（无来源），令一名其他角色失去或回复x点体力（x为其装备区牌数）。",
