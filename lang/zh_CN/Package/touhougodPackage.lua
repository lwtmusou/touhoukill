...
--*************************************
	...
	[":xianshi"] = "你可以将基本牌或普通锦囊牌与一张于此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌<font color=\"orange\"><b>组合</b></font>并使用本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />" ..
					"♦<font color=\"orange\"><b>组合</b></font>后牌的效果为“被组合的牌的效果 + 本牌效果”。若本牌的目标是牌，则被组合的效果对目标牌的使用者结算。【酒】被组合时，效果改为“目标回复1点体力”。",
...
--*************************************
	...
	["xiuye"] = "朽叶",
	[":xiuye"] = "你可以使用弃牌堆中的♣基本牌或♣普通锦囊牌。以此法使用的牌结算完毕后，你将之置于人物牌上，称为“叶”。你的回合结束时，你将所有“叶”以任意的顺序放于牌堆底。<br />♦将多张牌置于牌堆底时，牌越往右边放，越接近底部。",
	["kuangji"] = "狂季",
