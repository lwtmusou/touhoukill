...
--*************************************
	...
	[":xianshi"] = "你使用基本牌或普通锦囊牌时可以<font color=\"orange\"><b>组合</b></font>一张于此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />♦<font color=\"orange\"><b>组合</b></font>后的效果为“被组合的牌的效果 + 本牌效果”。若本牌的目标是牌，则被组合的效果对目标牌的使用者结算。【酒】被组合时，效果为回复1点体力。",
...
--*************************************
	...
	["dimai"] = "地脉",
	[":dimai"] = "<font color=\"#808080\"><b>永久技，</b></font>若你存活：一名角色的判定阶段开始时，若你存活且其判定区没有牌，其执行下列一张对应的延时锦囊牌的效果：【闪电】【乐不思蜀】【春息】【养精蓄锐】【兵粮寸断】；每以此法执行效果后或每回合首次有角色受到伤害后，须依照从左往右顺序循环切换下一张要执行的锦囊。<br /><br />♦游戏开始后，最先行动的角色对应的锦囊是【闪电】。",
