...
--*************************************
	...
	["#aya_god"] = "风雨之鸦" ,
	["tianqu"] = "天衢",
	[":tianqu"] = "<font color=\"blue\"><b>锁定技，</b></font>锁定技，回合开始时，若场上无路标记，你获得一枚路标记。计算一名角色到另一名角色（路标记角色除外）的基础距离时，均以路标记角色为起点。",
	["jifeng"] = "疾风",
	[":jifeng"] = "当一名角色A使用杀指定目标时，若你可以选择一名有路标记的角色B，并将标记挪至B下家。若如此做，你可以选择 以此法进入杀的使用者A的攻击范围内的一名角色，令其成为此杀的额外目标。",
