...
--*************************************
	...
	["qinlue"] = "侵略" ,
	[":qinlue"] = "其他角色的出牌阶段开始前，若当前回合不是额外回合，你可以弃置一张【杀】或装备牌，令该角色选择一项：弃置一张【闪】，或跳过此出牌阶段。若该角色以此法跳过出牌阶段，此回合结束后，你进行一个仅有出牌阶段的额外回合。此额外回合开始时，你将所有手牌面朝下置于你的人物牌上，称为“战备”，然后获得该角色的所有手牌。此额外回合结束时，你将所有手牌交给该角色，然后将所有“战备”加入手牌。",
	["zhanbei"] = "战备" ,
...
--*************************************
	...
	["#seiga_god"] = "古老的邪仙",
	["huanhun"] = "还魂",
	[":huanhun"] = "<font color=\"#808080\"><b>永久技，</b></font>当一名其他角色死亡后，若你已死亡，你以游戏开始时的状态重新加入游戏。",
	["tongling"] = "通灵",
