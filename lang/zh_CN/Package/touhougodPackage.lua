...
--*************************************
	...
	["cuixiang"] = "萃想",
	[":cuixiang"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时，所有其他角色各弃置一张手牌（若其没有手牌，将牌堆顶的一张牌置入弃牌堆），然后你获得零至两张以此法置入弃牌堆的牌。",
	["cuixiang-exchange"] = "<font color=\"#00FF00\"><b>%src </b></font> 的“%dest”被触发，请弃置一张手牌。",
	["xuying"] = "虚影",
	[":xuying"] = "<font color=\"#808080\"><b>永久技，</b></font>当你抵消【杀】时，你摸一张牌；当【杀】对你生效时，若你有手牌，你弃置一半的手牌（至少为1）。",
...
--*************************************
	...
	["yibian_give"] = "【异变】：你可以将一张牌交给身份牌明置的同阵营的一名其他角色。",
	["fengyin"] = "封印",
...
--*************************************
	...
	["hongfo"]= "弘佛",
	[":hongfo"]= "摸牌阶段摸牌后，你可以令势力与你相同的所有角色各摸一张牌，然后令与你势力不同的一名角色将其势力改变成你的势力。",
	["#hongfoChangeKingdom"] = "%from 被改变成 %arg 势力",
	["@hongfo"]= "你须将势力与你不同的一名其他角色的势力改变为和你相同的势力",
	["junwei"]= "君威",
	...
	["gaizong"]= "改宗",
	[":gaizong"]= "<font color=\"purple\"><b>觉醒技，</b></font>结束阶段开始时，若势力数不大于2，你减1点体力上限，然后重新决定势力，失去“弘佛”，获得“问道”（出牌阶段开始时，你可以选择势力各不相同的有手牌的至少一名角色，弃置这些角色各一张手牌，每当你以此法弃置一张红色牌后，你回复1点体力）。",
	["#GaizongWake"] = "场上势力数不大于2， %from 触发“%arg”觉醒。",
	["$gaizongAnimate"]= "skill=miko_god:gaizong",
	["wendao"]= "问道",
	[":wendao"]= "出牌阶段开始时，你可以选择势力各不相同的有手牌的至少一名角色，弃置这些角色各一张手牌。每当你以此法弃置一张红色牌后，你回复1点体力。",
	["@wendao"] = "你可以发动“问道”，选择势力各不相同的有手牌的至少一名角色，你弃置这些角色各一张手牌。",
	["~wendao"] = "选择角色 -> 确定",
