...
--*************************************
	...
	["illustrator:yukari_god"] = "Hong (p号:18527886)",
	--个人id:306422（香港）
	["illustrator:yukari_god_1"] = "NEKO (p号:28123130)",
	--个人id:2600911 （国人）
...
--["designer:utsuho_god"] = "星野梦美 | 程序:三国有单", 
    ...
    ["shikong"] = "失控", 
    [":shikong"] = "<font color=\"blue\"><b>锁定技，</b></font>你于出牌阶段使用【杀】时须指定你攻击范围内的所有角色为目标。", 
    ["ronghui"] = "熔毁", 
    [":ronghui"] = "<font color=\"blue\"><b>锁定技，</b></font>当你于出牌阶段内使用【杀】对目标角色造成伤害时，你须弃置其装备区里的所有牌。", 
    ["jubian"] = "聚变", 
...
--*************************************
	...
	["huanxiang"] = "幻乡",
	[":huanxiang"] = "<font color=\"blue\"><b>锁定技，</b></font>结束阶段开始时，若现存阵营之间身份牌明置的角色数均不相同，你须弃置一张牌。反之，你摸一张牌。",
	["huanxiang_discard"] = "【幻乡】的效果被触发，你需要弃置一张牌",
	["fengyin"] = "封印", 
	[":fengyin"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，暗置一名角色的身份牌并令其翻面。", 
	["#FengyinHide"] = "%from 将 %arg 的身份牌 暗置 。",
	["yibian"] = "异变",
	[":yibian"] = "一名角色的准备阶段开始时，若其身份牌暗置，其可以明置身份牌，然后若存在身份牌明置且与其不同阵营的角色，其须令其中一名角色摸一张牌；反之，其可以交给一名身份明置且与其阵营相同的角色一张牌。",
