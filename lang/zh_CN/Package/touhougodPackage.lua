...
--*************************************
	...
	["shenshou"] = "神授",
	[":shenshou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一张手牌并将此牌交给一名其他角色（若此牌是你最后的手牌，展示后你依然能发动下列三个效果），若你以此法展示：<br /> 1. 【杀】，你可以令其视为对其攻击范围内你选择的一名角色使用【杀】。<br />2. <font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你可以令其获得其攻击范围内你选择的一名角色的一张手牌。 <br />3. 点数为5-9的牌，你可以摸一张牌。",
...
--*************************************
	...
	[":xianshi"] = "你可以将一张基本牌/锦囊牌当作效果为“此回合内指定过角色为目标的普通锦囊/基本牌的原效果 + 本牌效果”的同名牌使用（【闪】和【无懈可击】的附加效果结算对象为目标牌的使用者；追加【酒】的原效果固定为回复体力）。<font color=\"green\"><b>每回合限一次。</b></font>",
