...
--*************************************
	...
	["xiuye"] = "朽叶",
	[":xiuye"] = "你可以使用弃牌堆中的♣基本牌和♣普通锦囊牌。此牌使用结算完毕后，置于你的人物牌上，称为“叶”。回合结束时，你将所有“叶”置入弃牌堆。",
	["kuangji"] = "狂季",
	[":kuangji"] = "当你使用基本牌或普通锦囊牌指定目标角色时，若目标数为1，则你可弃置任意张同名牌并令：x名角色成为额外目标或者 令此牌的效果值+x。若x不小于你当前的体力值，你摸x张牌。（x为弃牌数）",
