...
--*************************************
	...
	[":xianshi"] = "你使用基本牌或普通锦囊牌时可以<font color=\"orange\"><b>组合</b></font>一张于此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />" ..
					"♦<font color=\"orange\"><b>组合</b></font>后的效果为“被组合的牌的效果 + 本牌效果”。若本牌的目标是牌，则被组合的效果对目标牌的使用者结算。【酒】被组合时，效果为回复1点体力。",
...
--*************************************
	...
	["xiuye"] = "朽叶",
	[":xiuye"] = "你可以使用弃牌堆中的♣基本牌或♣普通锦囊牌。以此法使用的牌结算完毕后，你将之置于人物牌上，称为“叶”。你的回合结束时，你将所有“叶”以任意的顺序放于牌堆底。",
	["kuangji"] = "狂季",
	...
	["dimai"] = "地脉",
	[":dimai"] = "<font color=\"blue\"><b>永久技，</b></font>一名角色的判定阶段开始时，若你存活且其判定区没有牌，其执行一张延时锦囊的效果。每当以此法执行延时锦囊后或每回合首次有角色受到伤害，若你存活，需依照如下顺序循环切换下一次要执行的锦囊：【闪电】【乐不思蜀】【春息】【兵粮寸断】【养精蓄锐】",
	["#dimai"]= "天气预报，下一次的天气为：  <font color=\"green\"><b>%arg</b></font>。",
	["#dimai_judge"]= "由于“%arg”的效果，%from 将执行 %arg2 的效果。",
	["#dimai_unknownErr"] = "由于 %arg 原因，%from 的天气失效。",
	["tiandao"] = "天道",
	[":tiandao"] = "当一名角色的判定牌生效后，你可以对其使用此牌，若如此做，你中止此次判定的后续结算或效果。",
	
	["tenshi_god_sp"] = "神 比那名居天子",
	["&tenshi_god_sp"] = "神比那名居天子",
	["#tenshi_god_sp"] = "有顶天变",
	["designer:tenshi_god_sp"] = "dawda",
	["qizhialernative"] = "气质",
	[":qizhialernative"] = "一名角色的出牌阶段限一次，其可以将一张牌置入另一名角色的判定区（无视规则），若置入黑桃或红桃牌，其摸一张 牌；此技能不能被获得。",
	["tianbian"] = "天变",
	[":tianbian"] = "永久技，一名角色的判定阶段，若其判定区里有牌且你存活，你选择其中的零至两张牌，然后依次对其使用其中能对其 使用且未被选择的牌（无距离限制；按原牌面结算，在指定目标后开始结算效果），最后弃置其中剩余的牌，每以此法弃置两张 牌，你令其结算任意一种一次性延时类锦囊牌的效果。当你死亡时，你弃置所有角色判定区里的牌。",	
