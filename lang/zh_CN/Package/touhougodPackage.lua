...
--*************************************
	...
	["wenyue"] = "文乐",
	[":wenyue"] = "<font color=\"blue\"><b>锁定技，</b></font>其他角色的装备牌进入弃牌堆后，若你装备区没有同类装备，置入你的装备区。反之，置于人物牌上，称为“人偶”。其他角色摸牌阶段开始前，若其装备区没有牌且你有人偶，跳过此阶段，获得至多2张人偶；反之，其获得技能“千枪”直到回合结束。",
	["qianqiang"] = "千枪",
	[":qianqiang"] = "出牌阶段，你可以将一张装备牌置入其他角色的装备区，视为对其使用【杀】。（计入次数）",
	["diaoou"] = "吊偶",
	[":diaoou"] = "其他角色进入濒死时，若其装备区牌数不小于体力上限，你可令其死亡。",
