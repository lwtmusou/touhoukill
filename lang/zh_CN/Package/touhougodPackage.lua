...
--*************************************
	...
	["qinlue"] = "侵略" ,
	[":qinlue"] = "其他角色的出牌阶段开始前，你可以弃置一张【杀】或装备牌，令其选择一项：弃置一张【闪】，或 结束回合，然后你翻至正面朝上，进行一个仅有出牌阶段的额外回合。此额外回合开始时与结束时，你与其交换手牌。",
...
--*************************************
    ...
    ["anyun"] = "暗云",
	[":anyun"] = "游戏开始时，你将3张人物牌扣置于你的人物牌旁，称为“X”。你可以公开X并发动及拥有其上的技能，直到失去此X。（永久技，限定技，觉醒技除外）（每回合限公开一张X）。",
	["benzun"] = "本尊",
	[":benzun"] = "<font color=\"blue\"><b>锁定技，</b></font>任意回合结束时，若你有明置的X，移除之，然后观看y张人物牌并将其中一张扣置为X。然后将体力上限调整为游戏开始时，并移除标记和人物牌上的牌。（若为你的回合，y为1，反之为2）",
    ["#GetHuashen"] = "%from 获得了  %arg 张 X",
    ["huashencard"] = "X化身",
    ["#anyunShowStatic"] = "暗云（公开状态技）",
	...
	["huixing"] = "彗星",
	[":huixing"] = "出牌阶段开始时，你可以选择：若你于此阶段使用基本牌或普通锦囊牌对唯一其他角色的目标生效后，视为对其下家另一名其他角色使用一张同名牌。",
	["mofu"] = "魔符",
	[":mofu"] = "你使用<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌无视距离。你使用基本牌或普通锦囊牌结算完毕后，若此牌为♠且对所有其他角色目标均为无效，你可获得之。",
