...
--*************************************
	...
	["xianshi"] = "贤石",
	[":xianshi"] = "你可以将基本牌或普通锦囊牌与一张于此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌<font color=\"orange\"><b>组合</b></font>并使用本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />♦<font color=\"orange\"><b>组合</b></font>后的效果为“被组合的牌的效果 + 本牌效果”。若本牌的目标是牌，则被组合的效果对目标牌的使用者结算。【酒】被组合时，效果改为“目标回复1点体力”。",
