...
--*************************************
	...
	["aoyi"] = "奥义",
	[":aoyi"] = "<font color=\"blue\"><b>锁定技，</b></font>装备区有武器牌的角色使用【杀】指定目标后，此【杀】的伤害来源改为你。",
	["jiwu"] = "极武",
	[":jiwu"] = "<font color=\"#808080\"><b>永久技，</b></font>其他角色因受到你的伤害而进入濒死状态时，其获得冻结标记。你对有冻标记的角色造成伤害时，防止此伤害。回合开始时，若所有的其他角色均有冻结标记，你所属阵营获胜。",
	["ice_nature"] = "冰属性",
	["ice_slash"] = "冰杀",
	["#Jiwu"] = "%from 的“%arg”被触发， 防止了对 %to 的伤害",
	["#JiwuWin"] = "%from 的 身份是 “%arg”， 其阵营获胜",
