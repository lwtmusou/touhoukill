...
--*************************************
	...
	["#aya_god"] = "风雨之鸦" ,
	["tianqu"] = "天衢",
	[":tianqu"] = "<font color=\"blue\"><b>锁定技，</b></font>锁定技，当前回合人于本回合第一次使用【杀】结算完毕后，若场上无路标记，你获得一枚路标记。反之，你须选择：对其使用一张【杀】，或将路标记由原角色移至下家。计算一名角色到另一名角色（路标记角色除外）的基础距离时，均以路标记角色为起点。",
	["jifeng"] = "疾风",
	[":jifeng"] = "你可以将x张手牌当【杀】使用。（此杀无距离限制，且须指定至少一名距离为x的角色为目标。） 你以此法使用红色【杀】时，摸一张牌",
