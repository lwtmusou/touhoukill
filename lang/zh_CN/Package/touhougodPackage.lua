return{
	...
	["chuanghuan"] = "创幻",
	[":chuanghuan"] = "<font color=\"#808080\"><b>永久技，</b></font>所有玩家亮出人物牌后，你随机观看游戏外人物牌堆中的X张牌（X为角色数），选择其中一张牌替换此人物牌（体力上限和体力值调整至相应的数值，势力相应改变）。",
...
--*************************************
	...
	["shikong"] = "失控",
	[":shikong"] = "<font color=\"blue\"><b>锁定技，</b></font>当你使用【杀】时，此牌的目标改为是你使用此【杀】的合法目标的所有角色。",
...
--*************************************
	...
	["jinguo"]= "禁果",
	[":jinguo"]= "<font color=\"blue\"><b>锁定技，</b></font>出牌阶段结束时，你判定，若结果为<font size=\"5\", color=\"#808080\"><b>♠</b></font>，你跳过弃牌阶段，否则你选择一项：弃置X张牌（X为“禁忌”标记数）；或失去X/2点体力（结果取整数）。",
...
--*************************************
	...
	["renguidraw"] = "人鬼(摸牌)",
	["renguidiscard"] = "人鬼(弃牌)",
	[":rengui"] = "准备阶段开始时，你可以令一名角色摸X张牌，然后你可以依次弃置一名角色的Y张牌（X和Y分别为你已损失的灵体力值和你已损失的人体力值且均至多为2）。",
...
--*************************************
	...
	["gaoao"] = "高傲",
	[":gaoao"] = "<font color=\"blue\"><b>锁定技，</b></font>当一张牌于你的回合外置入你的区域前，此牌移动的目标区域改为弃牌堆。",
...
--*************************************
	...
	["shenshou"] = "神授",
	[":shenshou"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一张手牌并将此牌交给一名其他角色（若此牌是你最后的手牌，交出后你依然能发动下列三个效果），若你以此法展示：<br /> 1. 【杀】，你可以令其视为对其攻击范围内你选择的一名角色使用【杀】。<br />2. <font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你可以令其获得其攻击范围内你选择的一名角色的一张手牌。 <br />3. 点数为5-9的牌，你可以摸一张牌。",
...
--*************************************
	...
	--[[["yibian"] = "异变",
	[":yibian"] = "一名角色的准备阶段开始时，若其身份牌：暗置，其可以明置其身份牌，然后令一名与其阵营不同的角色摸一张牌；明置，其可以将一张牌交给一名与其阵营相同的其他角色。",
	...
	["yibian_give"] = "【异变】：你可以将一张牌交给一名身份牌明置的同阵营的其他角色。",
	["fengyin"] = "封印",
	[":fengyin"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌并选择一名身份牌明置的角色，令其翻面并将其身份牌暗置。",
	["#FengyinHide"] = "%from 将 %arg 的身份牌 暗置 。",
	["huanxiang"] = "幻乡",
	[":huanxiang"] = "<font color=\"blue\"><b>锁定技，</b></font>结束阶段开始时，若各现存阵营之间的身份牌明置的角色数均不相同，你弃置一张牌。否则你摸一张牌。",
...
--*************************************
	...
	["quanjie"] = "劝诫" ,
	[":quanjie"] = "其他角色的出牌阶段开始时，你可以令其选择一项：摸一张牌，然后其于此回合内不能使用【杀】；或弃置一张【杀】。" ,
	["@quanjie-discard"] = "请弃置一张【杀】，否则你摸一张牌并于此回合内不能使用【杀】。" ,
	["@duanzui-extra"]= "断罪",
	["duanzui"] = "断罪" ,
	[":duanzui"] = "其他角色的回合结束时，若此回合内有角色死亡，你可以将人物牌翻至正面朝上，然后获得一个额外的回合。若如此做，你于此额外回合结束之前拥有“审判”。" ,
...
--*************************************
	...
	["huaxiang"] = "华想",
	[":huaxiang"] = "当你需要使用/打出任意基本牌或【无懈可击】时，你可以声明之（若你的体力上限大于：3，不能声明【闪】；2，不能声明【桃】；1，不能声明【无懈可击】）并将一张与你人物牌上所有“虹”的花色均不同的手牌置于人物牌上，称为“虹”，视为使用/打出之。",
	["huaxiang_skill_slash"]= "华想";
	["huaxiang_skill_saveself"]= "华想";
	["rainbow"] = "虹",
	["caiyu"] = "彩雨",
	[":caiyu"] = "一名角色的结束阶段开始时，若“虹”数为4，你可以获得所有“虹”，弃置两张手牌，然后你可以减1点体力上限。",
	["caiyu:discard"] ="你可以其发动“彩雨”，收回所有“虹”，然后将弃置两张手牌。",
	["caiyu_discard"]="“彩雨”：收回“虹”后，请弃置%src张手牌。",
	["caiyu:loseMaxHp"] = "你是否执行“彩雨”效果，减1点体力上限。",
	["xuanlan"] = "绚烂",
...
--*************************************
	...
	["qinlue"] = "侵略" ,
	[":qinlue"] = "其他角色的出牌阶段开始前，你可以弃置一张【杀】或武器牌，令其选择一项：弃置一张【闪】或防具牌；或结束此回合，将你人物牌翻至正面朝上，然后令你获得一个仅有出牌阶段的额外的回合，且此额外回合开始时与结束时，你与其交换手牌。",
...
--*************************************
	...
	["benwo"] = "本我",
	[":benwo"] = "<font color=\"blue\"><b>锁定技，</b></font>结束阶段开始时，你选择一项：使用一张非转化的手牌；或展示均不能被使用的手牌（若你没有永久技，你不能以此法使用【杀】；若你拥有限定技，你以此法使用牌时，你摸一张牌，且若此牌为【杀】，你回复1点体力）。",
...
--*************************************
	...
	["zuosui:discard"]= "弃牌",
	["worao"] = "沃饶",
	[":worao"] = "当你成为其他角色使用的非转化的【杀】或普通锦囊牌的目标后，你可以摸两张牌并获得1枚“信仰”标记，然后将一张手牌交给其。",
...
--*************************************
	...
	["gaizong"]= "改宗",
	[":gaizong"]= "<font color=\"purple\"><b>觉醒技，</b></font>结束阶段开始时，若势力数不大于2，你减1点体力上限，然后重新决定势力，失去“弘佛”，获得“问道”（出牌阶段开始时，你可以选择至少一名势力各不相同的有手牌的角色，弃置这些角色各一张手牌，每当你以此法弃置一张红色牌后，你回复1点体力）。",
	["#GaizongWake"] = "场上势力数不大于2， %from 触发“%arg”觉醒。",
	["$gaizongAnimate"]= "skill=miko_god:gaizong",
	["wendao"]= "问道",
	[":wendao"]= "出牌阶段开始时，你可以选择至少一名有手牌的势力各不相同的角色，弃置这些角色各一张手牌。每当你以此法弃置一张红色牌后，你回复1点体力。",
...
--*************************************
	...
	["yindu"] = "引渡",
	[":yindu"] = "当其他角色死亡时，你可以摸三张牌，然后不执行奖惩。",
...
--*************************************
	...
	["kuixin"] = "窥心",
	[":kuixin"] = "<font color=\"blue\"><b>锁定技，</b></font>当你使用牌对其他角色或其他角色使用牌对你结算结束后，若目标数为1且该角色的明置手牌数小于X，你明置其一张手牌。（X为你已损失的体力值+1）。",
...
--*************************************
	...
	["fengmi"] = "风靡",
	[":fengmi"] = "当你使用【杀】指定一个目标后，你可以令其弃置其区域里的所有牌，摸等量的牌。",
...
--*************************************
	...
	["tongling"] = "通灵",
	[":tongling"] = "<font color=\"red\"><b>限定技，</b></font>回合开始时，你可以选择一名死亡角色的人物牌并声明其上的一项除永久技、觉醒技，主公技、其他角色拥有的技能外的技能，获得此技能。",
...
--*************************************
	...
	[":xianshi"] = "你可以将基本牌或普通锦囊牌与一张于此回合内指定过角色为目标且不与本牌同名的普通锦囊或基本牌<font color=\"orange\"><b>组合</b></font>并使用本牌。<font color=\"green\"><b>每回合限一次。</b></font><br /><br />" ..
					"牌♦<font color=\"orange\"><b>组合</b></font>后的效果为“被组合的牌的效果 + 本牌效果”。若本牌的目标是牌，则被组合的效果对目标牌的使用者结算。【酒】被组合时，效果改为“目标回复1点体力”。",
	--[":xianshi"] = "当你使用基本牌或普通锦囊牌时，你可以将一张于此回合内指定过角色为目标且不与此牌同名的普通锦囊或基本牌的效果<font color=\"orange\"><b>组合</b></font>进此牌里（效果加在此牌效果前；若此牌的目标是牌，则被组合的效果对目标牌的使用者结算；【酒】被组合时，效果为回复1点体力）。每回合限一次。",
	["#Xianshi"] = "%from 发动 <font color=\"#00FF00\">贤石</font>， 令【%arg】 的效果为 【%arg2】 + 【%arg】 " ,
	["riyue"] = "日月",
	[":riyue"] = "你于出牌阶段空闲时间点使用具有伤害效果的红色牌或具有回复效果的黑色牌的额外目标数无上限。",
	--["riyao"] = "日曜",
	--[":riyao"] = "你使用效果里有“火焰伤害”的牌无距离限制和额外目标上限。",
	--["yueyao"] = "月曜",
	--[":yueyao"] = "你需要使用【闪】时，若当前回合角色处于异常状态，你可视为使用【闪】。此牌结算后，你视为使用【联军盛宴】。",
...
--*************************************
	...
	["qianqiang"] = "千枪",
	[":qianqiang"] = "出牌阶段限一次，你可以将一张装备牌置入一名其他角色的装备区，视为对其使用【杀】。",
	["xianji"] = "献祭",
	...
	["xiuye"] = "朽叶",
	[":xiuye"] = "你可以使用弃牌堆中的<font size=\"5\", color=\"#808080\"><b>♣</b></font>基本牌或<font size=\"5\", color=\"#808080\"><b>♣</b></font>普通锦囊牌。以此法使用的牌结算完毕后，你将之置于人物牌上，称为“叶”。你的回合结束时，你将所有“叶”以任意的顺序放于牌堆底。<br />♦将多张牌置于牌堆底时，牌越往右边放，越接近底部。",
	["kuangji"] = "狂季",
	--[":kuangji"] = "当你使用基本牌或普通锦囊牌指定角色为目标时，若目标数为1，你可以弃置至少一张同名牌，选择一项：令X名角色成为此牌的额外目标（X为此次弃置的牌数），或令此牌的效果值+X。选择后若X不小于你的体力值，你摸X张牌。",
	[":kuangji"] = "当你受到伤害后，你可以亮出牌堆顶X张牌（X为角色数）并置入弃牌堆。",

	--你可以如手牌一般的使用弃牌堆中花色的基本牌和非延时类锦囊牌，若如此做，当此牌即将进入弃牌堆前，你需将此牌置于人物牌旁称为“叶”，你的回合结束后，你需将人物牌上的“叶”以任意的顺序放于牌堆底。	
	["#xiuye_temp"] = "朽叶",
	["@kuangji"] = "狂季: 你可以弃置至少一张【%src】，让正使用的牌：<br />增加等量的额外目标 或 <br />效果值增加等量数值 ",
	["~kuangji"] = "请选择角色为额外目标 -> 确定 或  直接 确定 来增加效果值",
	...
	["dimai"] = "地脉",
	[":dimai"] = "<font color=\"#808080\"><b>永久技，</b></font>若你存活：一名角色的判定阶段开始时，若你存活且其判定区没有牌，其执行下列一张对应的延时锦囊牌的效果：【闪电】【乐不思蜀】【春息】【养精蓄锐】【兵粮寸断】；每以此法执行效果后或每回合首次有角色受到伤害后，须依照从左往右顺序循环切换下一张要执行的锦囊。<br /><br />" ..
