...
local t = {
	...
	["JueYing"] = "绝影",
	[":JueYing"] = "装备牌·坐骑<br />装备技能：其他角色与你的距离+1。",
	["DiLu"] = "的卢",
	[":DiLu"] = "装备牌·坐骑<br />装备技能：其他角色与你的距离+1。",
	["ZhuaHuangFeiDian"] = "爪黄飞电",
	[":-1 horse"] = "装备牌·坐骑<br />装备技能：你与其他角色的距离-1。",
	["ChiTu"] = "赤兔",
	[":ChiTu"] = "装备牌·坐骑<br />装备技能：你与其他角色的距离-1。",
	["DaYuan"] = "大宛",
	[":DaYuan"] = "装备牌·坐骑<br />装备技能：你与其他角色的距离-1。",
	["ZiXing"] = "紫骍",
	[":ZiXing"] = "装备牌·坐骑<br />装备技能：你与其他角色的距离-1。",
	...
	["wooden_ox"] = "木牛流马",
	[":wooden_ox"] = "装备牌·宝物<br /><b>装备技能</b>：<br />1. 出牌阶段限一次，你可以将一张手牌移出游戏并扣置于【木牛流马】下，称为“辎”，若如此做，你可以将装备区里的【木牛流马】置入一名其他角色的装备区。<br />2. 你能使用或打出“辎”。<br />3. 你拥有的转化技或转化效果中的“〈一个数值〉张（…）（手）牌”改为“〈相同数值〉张（…）‘辎’和／或（手）牌”。<br /><br />◆“辎”对你可见。<br />◆你装备区里的【木牛流马】进行移动结算：若目标区域为装备区，所有“辎”始终扣置于【木牛流马】下；若因交换而移动，所有“辎”始终扣置于【木牛流马】下；若并非因交换而移至装备区以外的区域，则所有“辎”和【木牛流马】同时开始移动结算，但所有“辎”移动的目标区域为弃牌堆且移动的方式为置入弃牌堆。",
	...
	["lure_tiger"] = "调虎离山",
	[":lure_tiger"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一至两名其他角色。<br />作用效果：目标角色神隐，若如此做，其于此回合结束时解除神隐状态。<br />执行动作：此牌结算结束时，你摸一张牌。<br /><br />◆神隐的角色处于神隐状态（其不计入距离和座次的计算，不能使用牌，不是牌的合法目标，不进行伤害结算和体力流失结算）。",
