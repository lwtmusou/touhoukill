...
local t = {
	...
	["amazing_grace"] = "五谷丰登",
	[":amazing_grace"] = "锦囊牌·全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：所有角色。<br />执行动作：当此牌指定目标后，你亮出牌堆顶的X张牌（X为角色数）。<br />作用效果：目标获得这些牌中（剩余）的<font color=\"green\"><b>一张</b></font>牌。<br />◆若你未将执行动作完整执行完毕，终止此牌的使用结算。<br />◆使用结算结束后，你将剩余的牌置入弃牌堆。<br />◆当此牌对目标角色生效后，若这些牌中无剩余的牌，则其不执行任何操作。",

	["god_salvation"] = "桃园结义",
	[":god_salvation"] = "锦囊牌·全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：所有角色。<br />作用效果：目标角色回复<font color=\"green\"><b>1点</b></font>体力。<br />◆对未受伤的角色无效。",

	["savage_assault"] = "南蛮入侵",
	[":savage_assault"] = "锦囊牌·全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：所有其他角色。<br />作用效果：目标角色需打出<font color=\"green\"><b>一张</b></font>【杀】，否则受到你造成的<font color=\"green\"><b>1点</b></font>伤害。<br />◆若改变此牌的第一个效果值，则目标执行此牌效果时，需依次打出X张【杀】（X为最终的效果值）。",
	["savage-assault-slash"] = "%src 使用了【南蛮入侵】，请打出 %dest 张【杀】来响应。 <br />本次询问 <font color=\"green\"><b>第%arg 张</b></font>【杀】",

	["archery_attack"] = "万箭齐发",
	[":archery_attack"] = "锦囊牌·全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：所有其他角色。<br />作用效果：目标角色需打出<font color=\"green\"><b>一张</b></font>【闪】，否则受到你造成的<font color=\"green\"><b>1点</b></font>伤害。<br />◆若改变此牌的第一个效果值，则目标执行此牌效果时，需依次打出X张【闪】（X为最终的效果值）。",
	["archery-attack-jink"] = "%src 使用了【万箭齐发】，请打出 %dest 张【闪】以响应。 <br />本次询问 <font color=\"green\"><b>第%arg 张</b></font>【闪】",

	["collateral"] = "借刀杀人",
	[":collateral"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一名装备区里有武器牌的其他角色。<br />作用效果：你选择目标角色攻击范围内的<font color=\"green\"><b>一名</b></font>角色，然后目标需对该角色使用【杀】，否则其将其装备区里的武器牌交给你。<br />◆若此牌的效果值增加，则当此牌对目标角色生效后，你须选择其攻击范围内的X名角色（X为最终的效果值且至多等于其攻击范围），然后目标需对这些角色依次使用【杀】。<br />◆若目标角色未对你所选择的角色均使用【杀】，则其依然须将其装备区里的武器牌交给你。",
	...
	["lure_tiger"] = "调虎离山",
	[":lure_tiger"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一至两名其他角色。<br />作用效果：目标角色神隐，若如此做，其于此回合结束时解除神隐状态。<br />执行动作：此牌结算结束时，你摸一张牌。<br />◆神隐的角色处于神隐状态（其不计入距离和座次的计算，不能使用牌，不是牌的合法目标，不进行因伤害或失去体力事件而导致的扣减体力结算）。",
