...
local t = {
	...
	["DoubleSword"] = "雌雄双股剑",
	[":DoubleSword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：每当你使用【杀】指定另一名角色为目标后，若两者所属势力不相同且其中一方所属势力与主公的所属势力相同时，你可以令其选择一项：弃置一张手牌，或令你摸一张牌。",
	--"装备牌·武器<br />攻击范围：２<br />武器特效：每当你使用【杀】指定一名异性角色为目标后，你可以令其选择一项：弃置一张手牌，或令你摸一张牌。",
	["double-sword-card"] = "%src 发动了【雌雄双股剑】效果，你须弃置一张手牌，或令 %src 摸一张牌",

	["QinggangSword"] = "青釭剑",
	[":QinggangSword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：<font color=\"blue\"><b>锁定技，</b></font>每当你使用【杀】指定一名角色为目标后，你无视其防具。",
	...
	["amazing_grace"] = "五谷丰登",
	[":amazing_grace"] = "锦囊牌<br />出牌时机：出牌阶段<br />使用目标：所有角色。<br />作用效果：你亮出牌堆顶等于现存角色数量的牌，每名目标角色获得其中一张牌，然后将其余的牌置入弃牌堆。",
	...
	["indulgence"] = "乐不思蜀",
	[":indulgence"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：一名其他角色。<br />作用效果：目标角色进行判定，若结果不为<font color=\"red\">♥</font>，目标角色跳过出牌阶段。",

	["lightning"] = "闪电",
	[":lightning"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：你<br />作用效果：目标角色进行判定，若结果为♠2~9，则目标角色受到3点无来源的雷电伤害；若结果不为♠2~9，将之移动到其下家的判定区里。",
