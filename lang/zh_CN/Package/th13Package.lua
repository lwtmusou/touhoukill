return{
	...
	["qingting"] = "倾听",
	[":qingting"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令所有其他角色各将其一张手牌交给你（“圣格”觉醒后，改为你获得这些角色各一张手牌），然后你依次将一张手牌交给以此法失去过手牌的角色。",
...
--*********************************************
	...
	["shijie"] = "尸解",
	[":shijie"] = "当处于濒死状态的一名角色向你求【桃】时，你可以弃置一张手牌，令其判定，然后你可以弃置场上与结果花色相同的一张装备牌，令其回复1点体力。",
...
--*********************************************
	...
	["leishi"] = "雷矢",
	[":leishi"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以视为对有手牌的一名其他角色使用不计入限制的使用次数的雷【杀】，若如此做，当此牌被【闪】抵消时，你失去1点体力。",
	["fenyuan"] = "愤怨",
