...
--*********************************************
	...
	["fengshui"] = "风水",
	[":fengshui"] = "当判定牌生效前，你可以观看牌堆顶的两张牌，并改变其中任意数量的牌的顺序，和将其余的牌以任意顺序置于牌堆底，然后你可以用牌堆顶的一张牌代替判定牌。",
...
--*********************************************
	...
	["buming"] = "不明",
	[":buming"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张牌并选择一名在你攻击范围内的角色，令其选择一项：令你视为对其使用【杀】，或令你视为对其使用【决斗】。",
