...
--*********************************************
	...
	["xiangdi"] = "相地",
	[":xiangdi"] = "当你于出牌阶段外因使用、打出或弃置而失去红色牌后，你可以判定，当判定牌生效后，你选择一项：令一名其他角色获得判定牌；或将场上一张与结果花色相同的牌置入一名角色装备或判定区里。<font color=\"green\"><b>每回合限一次。</b></font>",
	["@xiangdi-giveCard"] = "相地你可以（选择选项1）令一名角色获得判定牌，或者按“取消”稍后将场上一张与结果花色相同的牌置入一名角色装备或判定区里。",
	["@xiangdi-giveCard2"] = "相地（场上没有可移动的与结果花色相同的牌）你需令一名角色获得判定牌",
	["@xiangdi-movefrom"] = "相地你（选择选项2）选择一名角色，移动一张装备或判定区内的%arg牌",
