...
--*********************************************
	...
	["xihua"] = "戏画",
	[":xihua"] = "当你需要使用/打出任意基本牌或普通锦囊牌时，若你有手牌，你可以声明之（不能声明于此回合内以此法声明过的牌名）并选择一名其他角色，令其展示你的一张手牌，若此牌与你声明的牌名类别相同或此牌的点数为J-K，你将此牌当你声明的牌使用/打出，否则你弃置之。",
...
--*********************************************
	...
	["shijie"] = "尸解",
	[":shijie"] = "当一名处于濒死状态的角色向你求【桃】时，你可以弃置一张手牌，令其判定，你可以弃置场上的一张与结果花色相同的装备牌，令其回复1点体力。",
	["@@shijie_chosen"] = "你需要选择“尸解”装备，请选择一名有装备的角色",
	["fengshui"] = "风水",
	[":fengshui"] = "当判定牌生效前，你可以观看牌堆顶的两张牌并改变其中任意数量的牌的顺序并将其余的牌以任意顺序置于牌堆底。然后你可以用牌堆顶的一张牌代替判定牌。",
...
--*********************************************
	...
	["leishi"] = "雷矢",
	[":leishi"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以视为对一名有手牌的其他角色使用不计入限制的使用次数的雷【杀】。若如此做，当此牌被【闪】抵消时，你失去1点体力。",
	["fenyuan"] = "愤怨",
	[":fenyuan"] = "当你于回合外进入濒死状态时，你可以死亡（视为没有角色杀死过你）并令当前回合的角色受到无来源的2点雷电伤害。",
...
--*********************************************
	...
	["chuanbi"]= "穿壁",
	[":chuanbi"]= "当你需要使用/打出【闪】时，若当前回合的角色的装备区里没有武器牌，你可以视为使用/打出【闪】。",
...
--*********************************************
	...
	["duzhua"]= "毒爪",
	[":duzhua"]= "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一张红色手牌当不计入限制的使用次数的【杀】使用。",
	["#duzhuaTargetMod"]= "毒爪",
	["taotie"]= "饕餮",
...
--*********************************************
	...
	["gongzhen"] = "共振",
	[":gongzhen"] = "当在你的攻击范围内的一名角色受到【杀】造成的伤害后，你可以弃置一张与此【杀】花色相同的手牌，对其造成1点伤害。",
...
--*********************************************
	...
	["chuixue"] = "吹雪" ,
	[":chuixue"] = "弃牌阶段结束时，若你于此阶段内弃置过你的至少一张手牌，你可以令一名其他角色选择一项：弃置一张与这些牌花色均不同的手牌；或失去1点体力。" ,
	["@chuixue-select"] = "请选择要“吹雪”的角色。" ,
	["@chuixue-discard"] = "请弃置一张手牌且此牌的花色不能与此阶段内 <font color=\"#00FF00\"><b>%src </b></font> 弃置的任意一张牌相同，否则你失去1点体力。" ,
	["wushou"] = "无寿" ,
...
--*********************************************
	...
	["buming"] = "不明",
	[":buming"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张牌并选择你攻击范围内的一名角色，令其选择一项：令你视为对其使用【杀】；或令你视为对其使用【决斗】。",
	["slash_buming"] = "视为你被使用【杀】",
	["duel_buming"] = "视为你被使用【决斗】",
	["#buming_choose"]= "%from 选择了 “%arg”。",
	["zhengti"] = "正体",
	[":zhengti"] = "<font color=\"blue\"><b>锁定技，</b></font>其他角色的回合结束时，若你于此回合内受到过其造成的伤害，其横置装备区里的所有牌；当你受到伤害时，若其他角色装备区里有横牌，你重置其中的一名角色的装备区的所有牌，将此伤害转移给其。",
	["@zhengti"] = "正体",
	["@zhengti-choose"]= "请选择一名装备区里有横牌的其他角色，将伤害转移给该角色。",
	["zhengti_extra"] = "正体",
...
--*********************************************
	...
	["qingyu"] = "晴雨",
	[":qingyu"] = "当你受到伤害后，你可以将一张手牌当【兵粮寸断】置入你的判定区并选择体力值不小于你的所有其他角色，令这些角色各选择一项：弃置一张牌；或令你摸一张牌。" ,
	["@qingyu"] = "你可以发动“晴雨”，将一张手牌当做【兵粮寸断】置入你的判定区",
	["@qingyu-discard"] = "请弃置一张牌，否则 <font color=\"#00FF00\"><b>%src </b></font> 将摸一张牌。" ,
	["guoke"] = "过客",
	[":guoke"] = "当你判定区里的一张牌移至另一个区域后，你可以选择一项：摸一张牌；或回复1点体力。" ,
