...
--*********************************************
    ...
    ["xihua"] = "戏画", 
    [":xihua"] = "每当你需要使用或打出一张基本牌或非延时类锦囊牌时，你可以声明之，并令一名其他角色展示你的一张手牌：若此牌与你声明的牌类别相同或此牌的点数为J-K，你将此牌当你声明的牌使用或打出；否则，弃置之，你不能使用或打出你声明的牌，直到回合结束。", 
...
--*********************************************
    ...
    ["shijie"] = "尸解", 
    [":shijie"] = "当一名角色处于濒死状态并向你求【桃】时，你可以弃置一张手牌，令该角色判定，若场上有装备牌与判定牌的花色相同，你弃置其中的一张，该角色回复1点体力。", 
...
--*********************************************
    ...
    ["xiefa"]="邪法",
    [":xiefa"]="<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一张手牌交给一名其他角色，并视为该角色对其攻击范围内的由你指定的一名角色使用一张【杀】。当此【杀】被【闪】抵消时，该角色须失去1点体力。当目标角色受到此【杀】造成伤害后，你须摸一张牌。",
    ["chuanbi"]="穿壁",
...
--["designer:yoshika"] = "星野梦美 | 程序:幻兰幽梦", 
    ...
    ["taotie"]="饕餮",
    [":taotie"]="每当其他角色使用一张【闪】时，若你已受伤，你可以判定，若结果为黑色，你回复1点体力。",
...
--*********************************************
    ...
    ["zhengti"] = "正体", 
    [":zhengti"] = "<font color=\"blue\"><b>锁定技，</b></font>每当你受到其他角色对你造成的伤害后，伤害来源须获得一枚“正体”标记。每当你受到伤害时，若其他角色有“正体”标记，你须弃一名其他角色的一枚“正体”标记，然后将此伤害转移给该角色。", 
    ["@zhengti"] = "正体", 
...
--*********************************************
    ...
    ["qingyu"] = "晴雨" ,
    [":qingyu"] = "每当你受到伤害后，你可以指定体力值不小于你的所有其他角色，这些角色依次选择一项：弃置一张牌，或令你摸一张牌。" ,
