return{
  ...
  ["slm001"] = "丰聪耳神子",["#slm001"] = "圣德道士",
	...
	["qingting"] = "倾听",
        [":qingting"] = "出牌阶段，你可令有手牌的所有其他角色（至少一名）依次交给你一张手牌（技能“圣格”发动后，改为你依次获得这些角色的一张手牌），然后你依次将一张手牌交给这些角色。<font color=\"green\"><b>每阶段限一次。</b></font>",
...
-- ["@xihua_target"]="你发动【戏画】选择了 %src ",
 --["#Xihua_response_use_slash"]="%from 发动 %arg, 选择【%arg2】的目标为 %to。",
...
["!slm003"] = "物部布都",
 ...
 [":fengshui"] = "在一张判定牌生效前，你可以观看牌堆顶的两张牌，将其中任意数量的牌以任意顺序置于牌堆顶，将其余的牌以任意顺序置于牌堆底。然后你可以用牌堆顶的一张牌代替判定牌。",  
...
--["@fengshui-retrial"]="你可以弃置一张手牌来发动【风水】",
 ...
 ["slm004"] = "苏我屠自古",["#slm004"] = "神明后裔的亡灵",
         ["!slm004"] = "苏我屠自古",
	 ["leishi"] = "雷矢",
        [":leishi"] = "出牌阶段，你可以指定一名有手牌的其他角色，视为你对其使用一张具雷电伤害的【杀】，此【杀】不计入每阶段的使用限制。当此【杀】被【闪】抵消时，你须失去1点体力。<font color=\"green\"><b>每阶段限一次。</b></font>",
 ...
 ["slm005"]="霍青娥",["#slm005"]="穿壁之邪仙人",
   ...
   ["slm006"]="宫古芳香",["#slm006"]="忠诚的尸体",
         ["!slm006"]="宫古芳香",     
	  ["duzhua"]="毒爪",
        [":duzhua"]="出牌阶段，你可以将一张红色手牌当【杀】使用，此【杀】不计入每阶段的使用限制。<font color=\"green\"><b>每阶段限一次。</b></font>",
 ...
 ["slm008"] = "神灵庙sp幽幽子" ,["&slm008"] = "神灵庙幽幽子" ,["#slm008"] = "不再彷徨的亡灵" ,
      ["!slm008"] = "神灵庙sp幽幽子" ,  
	 ["chuixue"] = "吹雪" ,
...
["slm009"] = "神灵庙sp鵺", ["&slm009"] = "神灵庙鵺",["#slm009"] = "古代妖怪之一",
  ["!slm009"] = "神灵庙sp鵺",
 ["buming"] = "不明", 
...
["zhengti_extra"] = "正体", 
 ...
 ["slm010"] = "神灵庙sp小伞" ,["&slm010"] = "神灵庙小伞" ,["#slm010"] = "为难的遗忘之物" ,
          ["!slm010"] = "神灵庙sp小伞" , 
		["qingyu"] = "晴雨" ,
