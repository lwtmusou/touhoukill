return{
	...
	["chiling"] = "敕令",
	[":chiling"] = "<font color=\"orange\"><b>主公技，</b></font>当其他灵势力角色获得你的手牌后，你可令该角色展示这些牌。若其中有【杀】，该角色可以使用【杀】。",
...
--*********************************************
	...
	["xihua"] = "戏画",
	[":xihua"] = "当你需要使用或打出基本牌或非延时类锦囊牌时，你可以声明之（不能声明于此回合内以此法声明过的牌），并令一名其他角色展示你的一张手牌：若此牌与你声明的牌类别相同或此牌的点数为J-K，你将此牌当你声明的牌使用或打出。否则，弃置之。",
...
--*********************************************
	...
	["chuanbi"]= "穿壁",
	[":chuanbi"]= "当你需要使用或打出【闪】时，若当前回合的角色的装备区里没有武器牌，你可以视为使用或打出一张【闪】。",
