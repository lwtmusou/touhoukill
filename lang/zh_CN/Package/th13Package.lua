...
--*********************************************
	...
	["huisheng"] = "回声",
	[":huisheng"] = "当其他角色使用的只指定了你为目标的基本牌或非延时类锦囊牌结算后，你可以视为对其使用一张与此牌名称相同且属性相同的牌。",
	["~huisheng"] = "回声",
...
--*********************************************
	...
	["zhengti"] = "正体",
	[":zhengti"] = "<font color=\"blue\"><b>锁定技，</b></font>当你受到其他角色对你造成的伤害后，来源须获得一枚“正体”标记。当你受到伤害时，若其他角色有“正体”标记，你弃一名其他角色的一枚“正体”标记，然后将此伤害转移给该角色。",
	["@zhengti"] = "正体",
