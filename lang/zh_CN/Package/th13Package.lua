return{
	...
	["qingting"] = "倾听",
	[":qingting"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令所有有手牌的其他角色各将一张手牌交给你（“圣格”发动后，改为你获得这些角色各一张手牌），然后你交给这些角色各一张手牌。",
...
--*********************************************
	...
	["fenyuan"] = "愤怨",
	[":fenyuan"] = "当你于回合外进入濒死状态时，你可以死亡（视为没有角色杀死过你），令当前回合角色受到无来源的2点雷电伤害。",
...
--*********************************************
	...
	["gongzhen"] = "共振",
	[":gongzhen"] = "当在你的攻击范围内的一名角色受到【杀】造成的伤害后，你可以弃置与此【杀】花色相同的一张手牌，对其造成1点伤害。",
