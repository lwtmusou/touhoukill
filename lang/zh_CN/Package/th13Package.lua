...
--*********************************************
	...
	["xiangdi"] = "相地",
	[":xiangdi"] = "当你于出牌阶段外因使用或弃置而失去红色牌后，你可以判定，当判定牌生效后，你选择一项：令一名其他角色获得判定牌；或将场上一张与结果花色相同的牌置入一名角色装备或判定区里。<font color=\"green\"><b>每回合限一次。</b></font>",
	["@xiangdi-giveCard"] = "相地：你可以选择一名角色并点击<font color=\"#FFA500\"><b>确定</b></font>以让他获得判定牌，或点击<font color=\"#90EE90\"><b>取消</b></font>准备移动场上一张与结果花色相同的装备或延时锦囊牌。",
	["@xiangdi-giveCard2"] = "相地：场上没有可移动的牌，你需选择一名角色，让他获得判定牌",
	["@xiangdi-movefrom"] = "相地：请选择一名角色，移动他一张装备或判定区内的%arg牌",
	["@xiangdi-self"] = "相地：请选择一张你装备或判定区内的%arg牌",
	["@xiangdi-moveto"] = "相地：请选另一名角色，此牌移至其%arg",
...
--*********************************************
	...
	["zhengti:@zhengti-rob"] = "正体你可以发动“正体”抢走 %src 一张装备区的牌",
