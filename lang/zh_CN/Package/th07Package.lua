return
{
	...
	["@sidie"] = "死蝶：选择一名手牌数小于你的角色，视为对其使用【杀】（无距离限制）。" ,
	["huaxu"] = "华胥",
...
--***********************************
	...
	["xijian"] = "隙间",
	[":xijian"] = "结束阶段开始时，你可以选择两名互不在对方攻击范围内的角色，将一方区域里的一张牌置入另一方相同的区域里。",
...
--***********************************
	...
	["zhanwang"] = "斩妄",
	[":zhanwang"] = "当你使用【杀】对角色造成伤害时，你可以令其选择一项：令你弃置其一张牌；或令此伤害值+1。",
	["zhanwang:target"] = "你是否对<font color=\"#00FF00\"><b>%src </b></font> 发动“斩妄”。" ,
	["zhanwang-self"] = "斩妄你对自己发动了“斩妄”，你可以弃置一张牌，否则此次伤害值+1",
	["zhanwang_discard:emmm"] = "<font color=\"#00FF00\"><b>%src </b></font>对你发动了“斩妄”，按“确定”选择令 %src 弃置你的一张牌，按“取消”选择此次伤害值+1",
...
--***********************************
	...
	[":qimen"] = "当你使用手牌中的【杀】或普通锦囊牌结算结束后，你可以视为只对一名装备区里牌数最多的角色使用同名牌（无距离限制），每回合限X次（X为5减当前你装备区里的牌数）。",
	["@qimen"] = "你可以发动“奇门”，视为对一名装备区里牌数最多的角色使用<font color=\"green\"><b>【%src】</b></font>。",
	["#qimen-dist"] = "奇门(距离)",
	["~qimen"] = "选择视为使用的牌的目标 -> 确定",
	["dunjia"] = "遁甲", -- 不是顿甲？
	[":dunjia"] = "当你对其他角色造成伤害后，或你受到其他角色造成的伤害后，若你与其装备区牌差不大于X（X为你已损失的体力值），你可以与其交换对方装备区里的牌。",
...
--***********************************
	...
	["youqu"]= "幽曲",
	[":youqu"]= "<font color=\"blue\"><b>锁定技，</b></font>结束阶段开始时，你将牌堆顶的一至三张牌扣置于人物牌上，称为“死灵”；准备阶段开始时，若“死灵”数不小于2，你获得所有“死灵”，然后对你造成1点伤害。",
	...
	["~wangwu"] = "选择一张同颜色的“死灵” -> 确定",
	["wangwu"]= "亡舞",
	[":wangwu"]= "当你成为其他角色使用的【杀】或普通锦囊牌的目标后，你可以将一张与之颜色相同的“死灵”置入弃牌堆，摸一张牌，然后对其造成1点伤害。",
