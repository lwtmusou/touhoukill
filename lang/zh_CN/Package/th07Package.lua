...
--***********************************
	...
	["youqu"]= "幽曲",
	[":youqu"]= "<font color=\"blue\"><b>锁定技，</b></font>分发起始手牌后或结束阶段开始时，你摸三张牌；准备阶段开始时，若你的手牌数大于你的手牌上限，你对自己造成1点伤害。",
	["wangwu"]= "亡舞",
	[":wangwu"]= "当你成为其他角色使用的【杀】或普通锦囊牌的目标后，你可以弃置两张与之颜色和类别都相同的手牌，摸一张牌，然后对其造成1点伤害。",
	["@wangwu-invoke"]= "<font color=\"#00FF00\"><b>%src</b></font> 使用【%dest】指定了你为目标，你可以发动“亡舞”。",
	["~wangwu"] = "选择两张与之颜色和类别都相同的手牌 -> 确定",
