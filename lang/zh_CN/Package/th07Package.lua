...
--***********************************
	...
	["shihui"] = "式辉",
	[":shihui"] = "当一名角色于其出牌阶段内首次造成伤害后，你可以令其可将X张牌当【无中生有】使用（此牌不是【无懈可击】的合法目标，X为其装备区里的牌数且至少为1）。",
	["shihuiuse"]= "“式辉”：请选择等同于装备区里的牌数的牌，然后点击<font color=\"#FFA500\"><b>确定</b></font>，将这些牌当【无中生有】使用；<br />否则请点击<font color=\"#90EE90\"><b>取消</b></font>",
	["~shihuiVS"]= "选择X张手牌 -> 确定 -> 转化 或 取消",
