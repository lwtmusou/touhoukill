...
--***********************************
    ...
    ["shenyin"] = "神隐",
	[":shenyin"] = "一名角色于另一名角色的回合内受到伤害后，你可令该角色进入神隐状态直到回合结束。然后，若你不为两者之一，此技能失效直到你下个回合开始。",
	["xijian"] = "隙间",
	[":xijian"] = "结束阶段开始时，你可以弃置一张牌并将一名角色区域内的一张牌移动至其下家或上家的相同区域内。",
	["@xijian"] = "你可以发动“隙间”，将一名角色区域内的一张牌移动至其下家或上家的相同区域内。",
	["~xijian"] = "选择一名有牌的角色，然后选择其上家或下家。",
...
--***********************************
	...
	["~qimen"] = "选择“奇门”的目标-> 确定。",
	["dunjia"] = "遁甲",
	[":dunjia"] = "当你受到有来源的普通/属性伤害时，若你在/不在其攻击范围内，你可以弃置一张装备牌，此伤害-1。",
	["#Dunjia1"]= "%from  对不在攻击范围内的目标 %to 的 普通伤害 因 %to 的 “%arg” 被触发， 减少了 %arg2 点伤害。",
	["#Dunjia2"]= "%from  对攻击范围内的目标 %to 的 属性伤害因 %to 的 “%arg” 被触发， 减少了 %arg2 点伤害。",
