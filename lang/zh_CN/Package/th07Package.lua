...
--***********************************
	...
	["shenyin:target"]= "神隐：你可以令  %src   <font color=\"red\"><b>神隐 </b></font> （神隐的角色处于神隐状态，其不计入距离和座次的计算、不能使用牌且不是牌的合法目标、不进行因伤害或失去体力而导致的扣减体力结算；<font color=\"#FFA500\"><b>回合结束时解除神隐状态</b></font>）。",
...
--***********************************
	...
	["jixiong"] = "吉凶" ,
	[":jixiong"] = "当一张牌不于一名角色的弃牌阶段内置入弃牌堆后，若此牌为：<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>J-K，你可以令当前回合角色回复1点体力；<font size=\"5\", color=\"#808080\"><b>♠</b></font>J-K且没有角色处于濒死状态，你可以令当前回合角色受到1点无来源的伤害。<font color=\"green\"><b>每名角色的每个阶段内限一次。</b></font>",
	["#jixiong1"] = "吉凶(回血)" ,
	["#jixiong2"] = "吉凶(伤害)" ,
	["jixiong1"] = "吉凶(回血)" ,
	["jixiong2"] = "吉凶(伤害)" ,
