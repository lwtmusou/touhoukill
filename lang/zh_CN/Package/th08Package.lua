return
{
    ...
    ["miyao"] = "秘药",
    [":miyao"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可令一名有手牌的其他角色回复1点体力（可以为未受伤的角色），然后该角色弃置一张手牌。",
    ...
    [":gesheng"] = "其他角色的判定阶段开始时，若场上没有非方块的【乐不思蜀】，你可以摸两张牌。若如此做，此阶段结束时，你选择一项：将一张手牌当【乐不思蜀】对该角色使用，或失去2点体力。",
