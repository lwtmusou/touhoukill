...
--*********************************************
	...
	["shishi"] = "噬史",
	[":shishi"] = "当其他角色使用【杀】或普通锦囊牌时，若你的人物牌上没有“历史”，你可令此牌无效。若如此做，将此牌置于你的人物牌上，称为“历史”，然后你弃置一张手牌。",
	["lishi"] = "历史",
...
--*********************************************
	...
	["chuangshi"] = "创史",
	[":chuangshi"] = "摸牌阶段开始时，你可令一名其他角色视为使用你指定的任意基本牌或普通锦囊牌（【酒】、【南蛮入侵】、【万箭齐发】、【桃园结义】除外）。若此牌需要指定目标，目标由你选择。若如此做，此阶段你少摸一张牌。",
	["chuangshi_victim"]= "创史",
