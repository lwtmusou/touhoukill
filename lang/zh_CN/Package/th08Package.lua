...
--*********************************************
	...
	["#buxian"] = "布陷(后续)",
	["xingyun"] = "幸运",
	[":xingyun"] = "当你获得牌后，你可以展示其中至少一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，你每以此法展示一张牌，你选择一项：回复1点体力；或令一名角色摸一张牌。",
...
--*********************************************
	...
	[":yinghuo"] = "当你需要使用/打出任意基本牌时，你可以明置一张同名手牌，视为使用/打出之。每名角色的回合内每种牌限一次。",
