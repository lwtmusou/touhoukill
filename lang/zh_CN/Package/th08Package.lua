...
--*********************************************
	...
	[":xushi"] = "当其他角色于其出牌阶段内首次使用牌时，若该角色可以使用此牌指定当前目标以外的角色，你可令其重新选择另外的目标。",
...
--yyc011  势力：永 3血
	...
	["mingmu"] = "明目",
	[":mingmu"] = "<font color=\"green\"><b>其他角色的出牌阶段限一次，</b></font>其可交给你一至两张牌，然后令你选择一至两项：1.交给其一张【杀】；2.令你的技能“夜盲”于此阶段内无效。",
	["mingmu_attach"]= "明目送牌",
