...
--*******************************************
	...
	["rudao"] = "入道",
	[":rudao"] = "当你使用牌指定其他角色为唯一目标时，或成为其他角色使用牌的唯一目标时，你可以取消此目标，令此牌的使用者摸两张牌，每回合限一次。",
	["huicui"] = "挥摧",
...
--*******************************************
	...
	["nuhuo"] = "怒火",
	[":nuhuo"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令一名其他角色选择一名在你攻击范围内的角色，令前者对你造成1点伤害，然后你视为对被选择的角色使用【杀】。",
...
--*******************************************
	...
	["@shuxin"] = "“赎心”：请弃置至少一张黑色牌（可以是装备区里的牌），若弃置的牌数不小于你的体力值，你回复1点体力。",
