...
--*******************************************
	...
	["jinghua"] = "净化",
	[":jinghua"] = "你可以将一张红色牌当【无懈可击】使用。你使用【无懈可击】时，你可将此牌的目标的普通锦囊牌以任意顺序置于牌堆底。",
	["$jinghua"] = " %card 将由 %from  以任意顺序置于牌堆底 " ,
	
	["weiguang"] = "威光",
	[":weiguang"] = "一名角色使用普通锦囊（【无懈可击】除外）指定目标后，若你为此牌的使用者或目标，你可获得牌堆底的一张牌。",
...
--*******************************************
	...
	["xunbao"] = "寻宝",
	[":xunbao"] = "当你使用牌时，你可以观看牌堆底的一张牌，你可以亮出之，若与你使用的牌花色相同，你获得之。",
	["lingbai"] = "灵摆",
	[":lingbai"] = "当你成为普通锦囊牌的目标后，你于此回合内可以将一张普通锦囊牌当【杀】或【闪】使用或打出。当你成为基本牌的目标后，你于此回合内可以将一张基本牌当【无懈可击】使用。",
