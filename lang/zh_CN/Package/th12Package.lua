return{
	...
	["baota"] = "宝塔",
	[":baota"] = "若你失去的牌置入弃牌堆，你可以将其中的一张置于牌堆底。结束阶段开始时，你可令一名其他角色获得牌堆底的一张牌。", 
	["@baota"] = "选择一名其他角色，令其获得牌堆底的一张牌。", 
	["$baota"] = "%from 发动“%arg” 将 %card 置于牌堆底",
    --["jinghua"] = "净化",
    --[":jinghua"] = "一名角色的准备阶段开始时，你可以将场上的一张延时类锦囊牌置于牌堆底。若此回合不是你的回合，你须失去1点体力。",
    --["@targetchoose"]="你可以指定一名角色，将其判定区的一张牌置于牌堆底。",

   
   --[":zhengyi"] = "<font color=\"blue\"><b>锁定技，</b></font>若你的装备区里有防具牌，弃置之。你手牌中的防具牌均视为【无懈可击】。每当你成为黑色【杀】或黑色非延时类锦囊牌的目标时，此牌对你无效，此牌的使用者获得牌堆底的一张牌。",
    ...
    ["!xlc004"] = "村纱水蜜", 
    --["chuannan"] = "船难", 
    --[":chuannan"] = "每当你对其他角色造成伤害后，你可以将一张手牌当【兵粮寸断】对该角色使用。每当你受到其他角色对你造成的伤害后，你可以摸一张牌，然后你可以将一张手牌当【兵粮寸断】对伤害来源使用。", 
