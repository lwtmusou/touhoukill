return{
	...
	["pudu"] = "普渡",
	[":pudu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择已受伤的一名其他角色，令其回复1点体力，然后你失去1点体力。",
	["jiushu"] = "救赎",
...
--*******************************************
	...
	["yiwang"] = "遗忘" ,
	[":yiwang"] = "当你失去装备区里的牌后，你可以令已受伤的一名角色回复1点体力，若其不为你，你摸一张牌。" ,
	["@yiwang-recover"] = "请选择已受伤的一名角色" ,
	["jingxia"] = "惊吓" ,
...
--*******************************************
	...
	["shuxin"] = "赎心" ,
	[":shuxin"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令有手牌的一名其他角色选择一项：展示均为红色的手牌；或弃置至少一张黑色牌，若其以此法弃置的牌数不小于其体力值，其回复1点体力。",
