return{
    ...
    ["!xlc003"] = "寅丸星",  
	["zhengyi"] = "正义",
	[":zhengyi"] = "每当你成为黑色【杀】或黑色非延时类锦囊牌的目标时，你可以将一张红色手牌置于牌堆底，令此牌对你无效。",
	["@zhengyi"]="你可以发动“正义”将一张红色手牌置于牌堆底，令【%src】对你无效。",
	
	["weiguang"] = "威光",
	[":weiguang"] = "每当其他角色于其摸牌阶段外从牌堆顶摸牌时，你可令其获得牌堆底的一张牌，然后你观看其手牌并将其中的一张置于牌堆底。", 
