...
--*******************************************
	...
	["jinghua"] = "净化",
	[":jinghua"] = "你可以将一张红色牌当【无懈可击】使用。当其他角色使用的普通锦囊牌对你结算后，若你于此回合内使用过【无懈可击】，你可以将此普通锦囊牌以任意顺序置于牌堆底。",
	["$jinghua"] = " %card 将由 %from  以任意顺序置于牌堆底 " ,
	["jinghua:invoke"]= "普通锦囊牌【%src】对你结算完毕，你可以发动“净化”。",
...
--*******************************************
	...
	["shuinan"] = "水难",
	[":shuinan"] = "当你成为其他角色使用锦囊牌的目标后，你可以弃置其一张手牌。",
	["nihuo"] = "溺惑",
...
--*******************************************
	...
	["yunshang"] = "云上",
	[":yunshang"] = "<font color=\"blue\"><b>锁定技，</b></font>当你成为其他角色使用普通锦囊牌的目标后，若你不在其攻击范围内，此牌对你无效。",
...
--*******************************************
	...
	["xunbao"] = "寻宝",
	[":xunbao"] = "当你使用牌时，你可以观看牌堆底的两张牌，你可以亮出并获得其中的一张与你使用的牌花色相同的牌。",
	["$xunbaoDrawpile"] = "牌堆底的牌为： %card" ,
	["lingbai"] = "灵摆",
	[":lingbai"] = "当你于回合外成为普通锦囊牌的目标后，你于此回合内可以将一张手牌当【杀】或【闪】使用或打出。",
...
--*******************************************
	...
	["jingxia"] = "惊吓" ,
	[":jingxia"] = "每当你受到1点伤害后，你可以选择一项：依次弃置来源的两张牌，或依次弃置场上的一至两张牌。" ,
	["jingxia:dismiss"] = "不发动" ,
...
--*******************************************
	...
	["yexiang"] = "夜响",
	[":yexiang"] = "当一次性延时锦囊牌离开其他角色的判定区时，你可以依次弃置其两张手牌。",
	["huisheng"] = "回声",
