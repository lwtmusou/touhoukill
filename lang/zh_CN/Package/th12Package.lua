return{
	...
	["pudu"] = "普渡",
	[":pudu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名已受伤的其他角色，令其回复1点体力，然后你失去1点体力。",
	["jiushu"] = "救赎",
...
--*******************************************
	...
	["weiguang"] = "威光",
	[":weiguang"] = "当你使用非转化且非视为的锦囊牌时，你可以获得牌堆底的一张牌。",
	
	--["zhengyi"] = "正义",
	--[":zhengyi"] = "当你成为黑色【杀】或黑色普通锦囊牌的目标后，你可以弃置一张红色牌，令此牌对你无效。",
	--["@zhengyi"]= "你可以发动“正义”弃置一张红色牌，令【%src】对你无效。",
	--["baota"] = "宝塔",
	--[":baota"] = "当你失去的牌置入弃牌堆后，你可以将其中的一张置于牌堆底。结束阶段开始时，你可以令一名其他角色获得牌堆底的一张牌。",
...
--*******************************************
	...
	["origin:nazrin_2"] = "p号：15716844，个人ID：192311",
...
--*******************************************
	...
	["nuhuo"] = "怒火",
	[":nuhuo"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令一名其他角色选择你攻击范围内的一名角色，令其对你造成1点伤害，然后你视为对被选择的角色使用【杀】。",
...
--*******************************************
	...
	["shuxin"] = "赎心" ,
	[":shuxin"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令一名有手牌的其他角色选择一项：展示均为红色的手牌；或弃置至少一张黑色牌。若其以此法弃置的牌数不小于其体力值，其回复1点体力。",
	...
	["huisheng"] = "回声",
	[":huisheng"] = "当其他角色使用的基本牌或普通锦囊牌结算后，若你为此牌唯一目标，你可以视为对其使用与此牌牌名、属性、效果均相同的牌。",
	["~huisheng"] = "回声",
