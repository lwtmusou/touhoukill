...
return {
	...
	["analeptic"] = "酒",
	[":analeptic"] = "基本牌<br />使用方法①<br />使用时机：出牌阶段，每回合限一次。<br />使用目标：包括你在内的一名角色。<br />作用效果：目标角色于此回合内使用的下一张【杀】的伤害值基数+<font color=\"green\"><b>1</b></font>。<br />◆一名角色使用的【杀】是否会受到【酒】（使用方法①）的效果的影响是根据其声明使用的牌的牌名（【杀】）时是否为其使用【酒】（使用方法①）的那个回合内来判断的。<br />◆不处于濒死状态的角色使用【酒】默认是以使用方法①使用【酒】。<br /> <br />使用方法②<br />使用时机：当你处于濒死状态时。<br />使用目标：你。<br />作用效果：你回复<font color=\"green\"><b>1</b></font>点体力。<br />◆处于濒死状态的角色使用【酒】默认是以使用方法②使用【酒】。",
	...
	["fire_attack"] = "火攻",
	[":fire_attack"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一名有暗置手牌的角色。<br />作用效果：目标角色明置<font color=\"green\"><b>一张</b></font>手牌。然后你可弃置一张与其所明置的一种花色相同的手牌，若如此做，其受到你造成的<font color=\"green\"><b>1</b></font>点火焰伤害",
