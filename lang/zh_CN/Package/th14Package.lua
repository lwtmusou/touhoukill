...
--****************************
    ...
    [":feitou"] ="结束阶段开始时，你可以将一张牌置于你的人物牌上，称为“飞头”。你可以将一张“飞头”当【杀】使用或打出，此【杀】不计入每阶段的使用限制，无距离限制。",
...
--****************************
    ...
    ["liange"] = "恋歌",
    [":liange"]="<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一张牌置于牌堆顶，然后令一名其他角色观看牌堆顶的两张牌并获得其中的一张，将另一张置入弃牌堆。",
