...
--****************************
 --hzc003  势力：辉 3血
	...
	["nizhuan"] = "逆转",
	[":nizhuan"] = "当一名角色成为【杀】的目标后，若此【杀】只指定了该角色为目标，且该角色已损失的体力值大于此【杀】的使用者，你可以弃置该角色的一张手牌，令此【杀】无效，然后令该角色视为对此【杀】的使用者使用【杀】。",
...
--****************************
  --hzc006  势力：辉 4血
	...
	["langying"] = "狼影",
	[":langying"] = "当你需要使用或打出【闪】时，你可以将你装备区里的所有牌（至少一张）返回手牌，视为你使用或打出了【闪】。",
	["yuanfei"] = "远吠",
