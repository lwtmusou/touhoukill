return{
	...
	["moyi"] = "末裔",
	[":moyi"] = "<font color=\"orange\"><b>主公技，</b></font>其他辉势力角色的弃牌阶段结束时，其可以令你获得由其选择的于此阶段内置入弃牌堆的一张基本牌。",
	["@moyi-select"]= "你可以选择拥有主公技“末裔”的角色，令其获得由你选择的于此阶段内置入弃牌堆的一张基本牌。",
...
--****************************
	...
	["leiting"] = "雷霆",
	[":leiting"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名其他角色并摸两张牌，然后弃置一张手牌，若以此法弃置了：<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，其摸一张牌，然后受到1点无来源的雷电伤害；<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，其视为使用雷【杀】。",
...
--****************************
 --hzc003  势力：辉 3血
	...
	["nizhuan"] = "逆转",
	[":nizhuan"] = "当一名角色成为【杀】的唯一目标后，若其已损失的体力值大于此【杀】的使用者，你可以弃置其一张手牌，令此【杀】无效，然后令其视为对此【杀】的使用者使用【杀】。",
	...
	["@guizha"] = "由于“诡诈”的效果，你必须对 <font color=\"#00FF00\"><b>%src </b></font> 使用一张【桃】（若【桃】均不能使用，则请点击<font color=\"#90EE90\"><b>取消</b></font>）。",
 ...
 --****************************
	...
	["yuyin"] = "余音",
	[":yuyin"] = "当你受到伤害后，你可以获得体力值大于你的一名角色的一张牌。",
	["@yuyin"] = "你可以发动“余音”，选择体力值大于你且有牌的一名角色，获得其一张牌。",
	["wuchang"] = "无常",
	--[":wuchang"] = "其他角色的弃牌阶段结束时，若其于此阶段内没有弃置过红色手牌，你可以令其弃置一张手牌。",
	[":wuchang"] = "其他角色的弃牌阶段开始时，你可以明置其一张手牌，令其于此阶段内不能弃置明置手牌。",
	["wuchang_discard"]= "由于“无常”的效果，你不能弃置明置手牌。",
...
--****************************
	...
	["canxiang"] = "残响",
	[":canxiang"] = "当你造成伤害后，你可以获得体力值大于你的一名角色的一张牌。",
	["@canxiang"] = "你可以发动“残响”，选择体力值大于你且有牌的一名角色，获得其一张牌。",
	["juwang"] = "俱亡",
	[":juwang"] = "当你于回合外需要使用或打出【闪】时，你可以令当前回合的角色选择一项：弃置一张红色手牌；或受到你造成的1点伤害。",
...
--****************************
  --hzc006  势力：辉 4血
	...
	["yuanfei"] = "远吠",
	[":yuanfei"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择不在你攻击范围内的一名其他角色，或弃置一张牌并选择你攻击范围内的一名角色，令其于此回合内不能使用或打出牌。",
	["#yuanfei"] = "因为 %arg 的效果，%from 于此回合内不能使用或打出牌。",
	["yuanfeinear"] = "远吠",
...
--****************************
	...
	["feitou"] = "飞头",
	["#feitou_slash"]= "飞头",
	[":feitou"] ="结束阶段开始时，你可以摸一张牌，然后将一张手牌置于人物牌上，称为“飞头”；你可以将一张“飞头”当【杀】使用（无距离限制且不计入限制的使用次数）或打出。",
	["#feitoumod"] = "飞头",
...
--****************************
	...
	["shizhu"] = "拾珠",
	[":shizhu"] = "其他角色的结束阶段开始时，你可以选择于此回合内置入弃牌堆的一张【桃】，若你：没有手牌，你获得之；有手牌，你展示手牌，若其中没有【桃】，你获得之。",
	["liange"] = "恋歌",
...
--****************************
	...
	["duobao"] = "夺宝",
	[":duobao"] = "<font color=\"blue\"><b>锁定技，</b></font>当你使用牌对其他角色造成伤害后，你获得其装备区里的一张牌；当你受到其他角色使用牌造成的伤害后，你令其获得你装备区里的一张牌。",
}
