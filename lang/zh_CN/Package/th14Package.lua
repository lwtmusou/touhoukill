...
--****************************
	...
	["@leiting_chosen"] = "<font color=\"#00FF00\"><b>%src </b></font> 对你发动了“雷霆”，请选择将要使用雷【杀】的合法目标（有距离限制）。",
...
--****************************
	...
	["shizhu"] = "拾珠",
	[":shizhu"] = "其他角色的结束阶段开始时，你可以选择一张于此回合内置入弃牌堆的【桃】并展示手牌（手牌数可以为零），若其中没有【桃】，你获得之。",
	["liange"] = "恋歌",
...
--****************************
	...
	["tianxie"] = "天邪",
	[":tianxie"] = "当一张基本牌或普通锦囊牌对你结算结束后，若此牌未对你生效，你可以摸一张牌，否则你可以弃置此牌使用者的一张牌。",
	["tianxie:target1"] = "你可以发动“天邪”弃置<font color=\"#00FF00\"><b>%src </b></font>一张牌",
	...
	["@duobao-rob"] = "夺宝你选择一名角色获得其装备区或判定区一张牌",
	["@duobao-give"] = "夺宝你将 1 张装备牌交给 %src.",
}
