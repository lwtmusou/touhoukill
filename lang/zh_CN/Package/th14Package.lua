return{
    ...
    ["!hzc002"] = "堀川雷鼓",
    ["leiting"] = "雷霆",
    [":leiting"] = "<font color=\"green\"><b>出牌阶段</b></font>你可以指定一名其他角色，然后你摸两张牌，弃置一张手牌。若以此法弃置了<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，该角色须摸一张牌，然后受到1点无来源的雷电伤害。若以此法弃置了<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，视为该角色对其攻击范围内的由该角色指定的一名角色使用一张雷【杀】。",
