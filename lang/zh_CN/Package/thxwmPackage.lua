return{
	...
	["kongpiao"] = "控票",
	[":kongpiao"] = "<font color=\"blue\"><b>锁定技，</b></font>其他角色的出牌阶段开始时，若其的手牌数多于你且你的手牌数小于五，你摸一张牌。",
	["shouhuivs"] = "手绘",
	[":shouhui"] = "出牌阶段或当你向自己求【桃】时，你可以弃置X张装备牌，然后摸X张牌。",
...
--*********************************
	...
	["beisha"] = "倍杀",
	[":beisha"] = "准备阶段开始时，若你有手牌，你可以选择一项：视为你对一名手牌数不大于你的其他角色使用【杀】，或令一名手牌数不大于你的一半的其他角色失去1点体力。",
	["@beisha"] = "请指定“倍杀”的目标。",
	["beisha:useslash"] = "视为对其使用【杀】",
...
--*********************************
	...
	["jubao"] = "举报", -- 菊爆？
	[":jubao"] = "当你受到伤害后，你可以弃置一名角色的一张手牌，然后弃置其装备区里的所有与此牌颜色相同的牌。",
...
--*********************************
	...
	["qingcang"] = "倾仓",
	[":qingcang"] = "摸牌阶段，若你的判定区里没有延时锦囊牌，你可以多摸四张牌，然后将一张手牌当【兵粮寸断】置于你的判定区里。",
