...
return {
	...
	["spell_duel"] = "符斗",
	[":spell_duel"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一名有手牌的其他角色<br />作用效果：你与其拼点：当你赢后，你对其造成<font color=\"green\"><b>1</b></font>点伤害；当你没赢后，你令其对你造成<font color=\"green\"><b>1</b></font>点伤害。",
