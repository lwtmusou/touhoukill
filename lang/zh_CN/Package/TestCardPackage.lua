...
return {
	...
	["bone_healing"] = "刮骨疗毒",
	[":bone_healing"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：处于异常状态的一名其他角色。<br />作用效果：你对目标角色造成<font color=\"green\"><b>1点</b></font>伤害，若如此做，其暗置所有手牌，重置装备区里的所有牌，重置人物牌。◆若一名角色的人物牌处于连环状态，或其装备区里有横牌，或其手牌里有明牌，则该角色处于异常状态。",
