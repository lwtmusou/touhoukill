...
return {
	...
	["magic_analeptic"] = "果酒",
	[":magic_analeptic"] = "基本牌<br />使用方法①<br />使用时机：出牌阶段限一次。<br />使用目标：包括你在内的一名角色。<br />作用效果：目标角色于此回合内使用的下一张普通锦囊牌的第一个效果值+<font color=\"green\"><b>1</b></font>。<br />◆不处于濒死状态的角色使用【酒】默认是以使用方法①使用【酒】。<br /> <br />使用方法②<br />使用时机：当你处于濒死状态时。<br />使用目标：你。<br />作用效果：你回复<font color=\"green\"><b>1点</b></font>体力。<br />◆处于濒死状态的角色使用【酒】默认是以使用方法②使用【酒】。",

	["super_peach"] = "仙桃",
	[":super_peach"] = "基本牌<br />使用方法①<br />使用时机：出牌阶段。<br />使用目标：处于异常状态的一名角色。<br />作用效果：目标角色暗置其所有明置手牌，重置装备区里的所有横牌，重置人物牌，最后回复<font color=\"green\"><b>1点</b></font>体力。<br />◆若一名角色的人物牌处于连环状态，或其装备区里有横牌，或其手牌里有明牌，则该角色处于异常状态。 <br /><br />使用方法②<br />使用时机：当一名角色处于濒死状态时。<br />使用目标：处于濒死状态的一名角色。<br />作用效果：目标角色暗置其所有明置手牌，然后重置并重置装备区里的所有横牌，最后回复<font color=\"green\"><b>1点</b></font>体力。",
	...
	["Camouflage"] = "光学迷彩",
	[":Camouflage"] = "装备牌·防具<br />装备技能：<font color=\"blue\"><b>锁定技，</b></font>当你受到伤害时，若场上仅有一张防具牌，防止此伤害；当此牌以使用的方式置入你的装备区后，你弃置场上一张与之牌名不同的防具牌。",
	...
	["bone_healing"] = "刮骨疗毒",
	[":bone_healing"] = "锦囊牌·非全体性的普通锦囊牌<br />使用时机：出牌阶段。<br />使用目标：处于异常状态的一名其他角色。<br />作用效果：你对目标角色造成<font color=\"green\"><b>1点</b></font>伤害，若如此做，其暗置所有手牌，重置装备区里的所有牌，重置人物牌。<br />◆若一名角色的人物牌处于连环状态，或其装备区里有横牌，或其手牌里有明牌，则该角色处于异常状态。",
