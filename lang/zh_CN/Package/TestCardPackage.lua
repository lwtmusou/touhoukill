...
return {
	...
	["Pagoda"] = "宝塔",
	[":Pagoda"] = "装备牌·宝物<br />装备技能：你可以将一张黑色手牌当【无懈可击】使用。每阶段限一次；<br />当你使用【无懈可击】抵消目标牌后，你可以令此牌对所有目标角色无效。",
	...
	["spring_breath"] = "春息",
	[":spring_breath"] = "锦囊牌·一次性的延时类锦囊牌<br />使用时机：出牌阶段。<br />使用目标：一名角色。<br />作用效果：目标角色判定，若结果为<font size=\"5\", color=\"#FF0000\"><b>♥2-9</b></font>，其摸6张牌，否则其将此牌置入其判定区且此阶段不再执行此牌效果。",
