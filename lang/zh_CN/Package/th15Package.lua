...
--***********************************
	...
	["designer:junko"] = "三国有单",
	["xiahui"] = "瑕秽",
	[":xiahui"] = "你造成或受到伤害后，你可明置来源与受伤者的各一张手牌。",
	["@xiahui"] = "你可以发动瑕秽明置 受伤者或来源 的一张手牌。",
	["chunhua"] = "纯化",
	[":chunhua"] = "一名角色使用明置的基本牌或普通锦囊指定角色为目标后，你可根据其明置手牌的颜色（含此牌）令之效果改为：黑色“造成1点伤害”，红色“回复1点体力”。<font color=\"green\"><b>每阶段限一次，</b></font>",
...
--***********************************		
	...
	[":kuangluan"] = "没有明置手牌的其他角色于其摸牌阶段外获得牌后，你可令其明置之。其他角色失去最后的明置手牌后，你可令其技能（永久技除外）于此回合内失效。",
	...
	[":yuyi"] = "你受到【杀】造成的伤害时，你可弃置一张手牌，然后弃置来源的一张手牌，若弃置了颜色不同的两张牌，此伤害-1。",
...
--***********************************	
	...
	["shehuo"] = "舌祸",
	[":shehuo"] = "你指定或成为【杀】或普通锦囊牌的唯一目标时，若使用者和目标角色不同，你可令目标角色选择一项： 对使用者使用一张类别不同的牌并取消原目标，或此牌不能被响应。",
	...
	["#shehuo"] = "舌祸",
	["shenyan"] = "慎言",
	[":shenyan"] = "其他角色的弃牌阶段开始时，若其本回合没有使用牌指定过其以外的角色，你可视为对其与你使用【以逸待劳】。",
...
--15005 哆来咪·苏伊特 3hp
	...
	["bumeng"] = "捕梦",
	[":bumeng"] = "其他角色的牌因被其弃置而进入弃牌堆后，你可令其获得其中一张牌并明置之，然后你可获得其中一张牌并明置之。<font color=\"green\"><b>每回合限一次，</b></font>",
	["rumeng"] = "入梦",
	[":rumeng"] = "其他角色的出牌阶段，有角色因使用或打出失去最后的明置手牌后，你可令其结束此阶段。",
	["rumeng_skip"]= "出牌阶段",
...
--***********************************	
	...
	["designer:ringo"] = "三国有单",
	["yuejian"] = "月见";
	[":yuejian"] = "你使用非转化的牌结算完毕后，若你为此牌目标，你可以与一名角色拼点。若你赢/没赢，你可视为使用【知己知彼】/【以逸待劳】。";
	["dango"] = "团子";
