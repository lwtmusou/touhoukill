...
--***********************************
	...
	["santi"] = "三体",
	[":santi"] = "<font color=\"blue\"><b>锁定技，</b></font>非额外回合开始时，你令此回合执行阶段为“准备-判定-（摸牌-出牌-弃牌） x3 -结束”；你于此回合的出牌阶段使用牌时，你令本阶段/余下的出牌阶段不能使用与之类型不同/相同的牌。",
...
--***********************************
	...
	["designer:ringo"] = "三国有单",
	["yuejian"] = "月见";
	[":yuejian"] = "<font color=\"green\"><b>每阶段限一次。</b></font>你可以与一名角色拼点：当你赢后，你视为使用【以逸待劳】。否则，你将你的拼点牌置于人物牌上，称为“团子”。";
