...
--***********************************	
	...
	[":yuejian"] = "<font color=\"green\"><b>出牌阶段对每名其他角色限一次。</b></font>你可与其拼点。若你没赢，你视为使用果【酒】。否则，你视为使用【以逸待劳】且此阶段不能再发动“月见”。";
...
--***********************************	
    ...
    [":yidan"] = "<font color=\"green\"><b>出牌阶段各限一次</b></font>，你可以将一张手牌当缚【杀】/秽【杀】使用。（无距离与次数限制，处于异常状态的角色不是合法目标）",
	["#yidan"] = "异弹",
