...
--***********************************
	...
	["chunhua"] = "纯化",
	[":chunhua"] = "当一名角色使用基本或普通锦囊牌指定角色为目标后，你可以选择一项：1.选择并暗置其一张明置手牌；2.（若使用的是明置手牌）选择此牌。然后根据选择的牌的颜色改变效果：黑色，使用者对目标造成1点伤害；红色，目标回复1点体力。每阶段限一次。",
...
--***********************************
	...
	["chihou"] = "斥候",
	[":chihou"] = "出牌阶段开始时，你可以令一名其他角色与你各明置一张手牌，然后本阶段内双方的明置手牌有：红色牌，你可以于本阶段视为使用【以逸待劳】；黑色牌，你可以于本阶段将一张手牌当果【酒】使用。（每种牌每回合限转化一次）<br /><br />" ..
