return {
	...
	["meimeng"] = "美梦",
	[":meimeng"] = "其他角色的牌因弃置进入弃牌堆后，你可令其选择并获得其中一张牌并明置之，然后你可以获得其中一张并明置之。<font color=\"green\"><b>每阶段限一次，</b></font>",
	["emeng"] = "恶梦",
	[":emeng"] = "<font color=\"blue\"><b>锁定技，</b></font>你使用明置手牌指定有明置手牌的一名角色后，你令其摸x张牌并翻面。（x为其明置手牌数）",
