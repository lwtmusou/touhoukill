...
--***********************************
	...
	["yidan"] = "异弹",
	[":yidan"] = "<font color=\"green\"><b>出牌段限一次，</b></font>你可以将一张手牌当不计入次数的秽【杀】对一名有手牌且无明置手牌的角色使用。",
	["#yidan"] = "异弹",
	["xuechu"] = "血杵",
	[":xuechu"] = "<font color=\"blue\"><b>锁定技，</b></font>你使用指定【杀】目标后，你令其不能使用【闪】响应此牌。你对其他角色造成伤害后，你令其选择是否弃置一张【闪】并回复1点体力。",
	["@xuechu"] = "因“血杵”的效果，你可以弃置一张【闪】回复1点体力",
}
