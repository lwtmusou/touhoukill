...
--***********************************
	...
	[":yuejian"] = "<font color=\"green\"><b>出牌阶段，</b></font>你可以与一名你未于此阶段内对其发动过此技能的角色拼点：当你没赢后，你视为使用果【酒】；当你赢后，你视为使用【以逸待劳】且你于此阶段内不能再发动此技能。";
...
--***********************************
	...
	["yidan"] = "异弹",
	[":yidan"] = "<font color=\"green\"><b>出牌阶段，</b></font>你可以将一张手牌当缚【杀】或秽【杀】使用（无距离与次数限制，但处于异常状态的角色不是合法目标；这两种【杀】于此阶段内各限转化一次）。",
	["#yidan"] = "异弹",
