return {
	...
	["meiling"] = "魅灵",
	[":meiling"] = "当一名角色受到其他角色造成的伤害后，若其存活，你可以获得造成伤害的牌。若你与其距离大于X（X为你已损失的体力值），来源对你造成1点伤害。",
...
--************************************************
	...
	["chongdong"] = "虫洞",
	[":chongdong"] = "<font color=\"orange\"><b>主公技，</b></font>当你于其他角色的出牌阶段内受到伤害后，你可以令其他旧势力角色选择是否弃置一张红色手牌，若其选择是，结束此回合。",
...
--************************************************
	...
	["~zhence"]= "选择一名角色，确认",
	["shiqu"] = "时驱",
	[":shiqu"] = "一名角色的结束阶段开始时，你可以声明一个于此回合未执行的阶段并弃置一张牌并选择其或你，令该角色获得一个仅有你声明的阶段的额外回合。",
	["shiqu_start"] = "准备阶段",
	["shiqu_judge"] = "判定阶段",
	["shiqu_draw"] = "摸牌阶段",
	["shiqu_play"] = "出牌阶段",
...
--************************************************
	...
	["qiusuo"] = "求索",
	[":qiusuo"] = "结束阶段开始时（若你于此回合内造成过伤害）或准备阶段开始时，你可以获得至少一张点数均相同的“真理”。",
	["@qiusuo"] = "你可以展示并获得 任意张点数均相同 的“真理”牌";
	["~qiusuo"] = "选择至少一张点数均相同的“真理”牌 -> 确定"; 
...
--************************************************
	...
	["yeyan"] = "夜魇",
	[":yeyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当你使用【杀】或普通锦囊牌指定目标后，除你外的目标角色各弃置一张手牌并令你选择一项：展示一张与之类别相同手牌；或令此牌对其无效。",
...
--************************************************
	...
	--["xuxiang"] = "虚像",
	--[":xuxiang"] = "当其他角色使用【杀】对目标角色造成伤害时，你可以与其拼点：当你赢后，若拼点牌中有【闪】，你可以令伤害值+1。若拼点牌中有【杀】，你可以令伤害值-1。<font color=\"green\"><b>每阶段限一次。</b></font>",
	--["xuxiang:target"]= "<font color=\"#FF8000\"><b>%src </b></font> 使用【%arg】对  %dest 造成了 %arg2 点伤害。 你可以发动“虚像”与 <font color=\"#FF8000\"><b>%src </b></font> 拼点。",
	...
	--["#xuxiang"] = "虚像(伤害修正)",
	--["huanjue"] = "幻觉",
	--[":huanjue"] = "当你需要选择拼点牌时，若对方在你的攻击范围内，你可以观看牌堆顶的两张牌并将其中一张作为你的拼点牌。若如此做，对方选择拼点牌时可以将另一张作为其拼点牌。",

    ["huantong"] = "幻痛",
    --[":huantong"] = "当你或你攻击范围内的一名角色受到伤害时，你可以选择一项：将牌堆顶的一张牌扣置于你的人物牌上，称为“梦幻”；或展示两张“梦幻”，其获得其中的基本牌并将其余的置入弃牌堆，然后将伤害值改为X点（X为基本牌数）。",
    [":huantong"] = "当你或你攻击范围内的一名角色受到伤害时，你可以将牌堆顶的一张牌扣置于你的人物牌上，称为“梦幻”，然后你可以展示两张“梦幻”，令其获得其中的基本牌并将其余的置入弃牌堆并将伤害值改为X点（X为其中的基本牌数）。 ",
    ...
    ["dream"] = "梦幻",
    ["mengyan"] = "梦湮",
    --[":mengyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当一名角色受到伤害后，若伤害值大于1且有“梦幻”，你将所有“梦幻”置入弃牌堆，然后回复1点体力并摸两张牌。",
	[":mengyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当一名角色受到大于1点的伤害后，你获得所有“梦幻”，然后回复1点体力。",
...
--************************************************
	...
	["lianmu"] = "镰幕",
	[":lianmu"] = "当你使用【杀】结算结束后，若此牌未造成过伤害，你可以视为使用【杀】并能额外选择一个目标。<font color=\"green\"><b>每阶段限一次。</b></font>",
...
--************************************************
	...
	["baosi"] = "报死",
	[":baosi"] = "当你使用【杀】或黑色普通锦囊牌指定一名角色为目标时，你可以选择至少一名不是此牌目标且体力值不大于其体力下限的其他角色，这些角色也成为此牌的目标。",
...
--************************************************
	...
	["xingyou"] = "星幽",
	["#xingyou"] = "星幽",
	--[":xingyou"] = "当你使用【杀】时，若你有与此【杀】花色相同的明置手牌，你可以摸一张牌；当你使用的【杀】被目标角色使用的【闪】抵消时，若你有与此【闪】花色相同的明置手牌，你可以弃置其一张牌。",
...
--************************************************	
	...
	--["jinduan"] = "禁断",
	--[":jinduan"] = "当一名角色于其回合外使用基本牌时，你可以横置其装备区里所有竖牌并令其获得此基本牌。",
	--["liuzhuan"] = "流转",
	--[":liuzhuan"] = "当你或你攻击范围内的一名角色区域里的牌被明置或暗置、横置或竖置后，你可以令其重铸其中任意张牌。",
	--["liuzhuanuse"]= "“流转”：你可以重铸此次放置方式已改变后的任意张牌。",
	--["~liuzhuanVS"]= "选择此次放置方式已改变后的任意张牌→点击“确定”。",
	
	--["xunlun"] = "循轮",
	--[":xunlun"] = "当一名角色于其回合外使用基本牌时，你可以明置其一张手牌，若与此基本牌颜色不同，其摸一张牌。",
	--[":xunlun"] = "当一名角色于其出牌阶段外/出牌阶段内使用基本牌时，你可以明置/暗置其一张手牌，若与之颜色相同/不同，其摸一张牌。",
	--["chenjue"] = "尘绝",
	--[":chenjue"] = "其他角色的结束阶段开始时，若其手牌数等于你，其可以令你与其各选择一张手牌，然后交给对方。以此法失去明牌的角色摸一张牌。",
	--[":chenjue"] = "其他角色的弃牌阶段开始时，若其手牌数大于你，你可以令其与你先各选择一张牌再同时交给对方，然后你与其各可以使用非锦囊牌。",
   -- ["@chenjue"] = "请选择因“尘绝”效果 需要交给 %src 的手牌",
	...
	["nuli"] = "戮力",
    [":nuli"] = "结束阶段开始时，你可以获得一名手牌数不小于你的其他角色的一张牌，然后将一张牌交给其，最后你与其各可以使用牌。",
	["@nuli"] = "你可以发动“戮力”，获得一名手牌数不小于你的其他角色的一张牌，然后将一张牌交给其，最后你与其各可以使用牌。",
	["nuliReturn"]= "请将一张牌交给“戮力”的目标角色 <font color=\"#00FF00\"><b>%src </b></font>。",
	["@nuli_use"] = "“戮力”： 你可以使用一张牌。";
...
--************************************************	
	...
	["anliu"] = "暗流",
	[":anliu"] = "当你造成或受到伤害后，若伤害牌为【杀】，你可以令受伤角色距离1以内的一名角色获得此牌，然后你可以展示其一张牌 。若为基本牌，其失去一点体力。",
}