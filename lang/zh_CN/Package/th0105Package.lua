...
--************************************************
	...
	["zhanche"] = "战车",
	[":zhanche"] = "锁定技，出牌阶段开始时，若“车”标记数：小于4，你获得1枚“车”标记，然后可以弃置一张牌，令一名装备区里有牌的其他角色将其一张装备牌交给你；不小于4，你于此阶段内：使用牌无距离限制且其他角色的防具和宝物于此回合内无效。",
	["@zhanche-rob"] = "战车你可以弃置一张牌令一名装备区里有牌的其他角色将一张装备牌交给你",
	["~zhanche"] = "选择要弃置的牌 -> 选择一名目标角色 -> 确定",
	["@zhanche-robbed"] = "战车你须交给 %src 一张装备牌",
	["#zhanche-engine"] = "%from 的 %arg 起飞了！！！",
	["@ju"] = "车",
	["huochong"] = "祸祟",
	[":huochong"] = "一名角色的回合结束时，若此回合内你的装备牌被弃置或你装备区有牌离开过，你可以视为对一名其他角色使用【杀】（此杀指定目标后，目标角色的防具无效直到1.，2.，3.，4.）。",
	["@huochong-victim"] = "火铳你可以视为使用杀（目标的防具无效）",
	...
	["yihuan"] = "易幻",
	[":yihuan"] = "出牌阶段限一次，你可以弃置一张非装备、不具有伤害效果的牌，对一名其他角色造成1点伤害。",
	["wuzui"] = "无罪",
	[":wuzui"] = "当你受到牌造成的伤害时，你可以选择一项：1.将一张与之类别相同的具有伤害效果的牌置于人物牌上 ，称为“罪”，令此伤害值-1；2.摸一张牌；当你对其他角色造成伤害时，你可以将一张“罪”置入弃牌堆，令其于本回合内体力下限+1。",
	["@wuzui-put"] = "无罪你可以选择将有伤害效果的%arg至于武将牌上成为“罪”令伤害-1或者摸一张牌",
	["~wuzui1"] = "（减免伤害）选择一张牌->确定（摸牌）取消",
	["@wuzui-discard"] = "无罪你可以将一张“罪”置入弃牌堆，令 %arg 于本回合内体力下限+1",
	["~wuzui2"] = "选择一张罪->确定",
	["guilt"] = "罪",
}
