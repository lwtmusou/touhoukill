return {
	...
	["meiling"] = "魅灵",
	[":meiling"] = "一名角色受到其他角色造成的伤害后，你可获得造成伤害的牌。若你与该角色的距离大于X（X为你已损失的体力值），来源对你造成1点伤害。",
...
--************************************************	
	...
	["xunlun"] = "循轮",
	[":xunlun"] = "当一名角色于其回合外使用基本牌后，你可明置其一张手牌，若与此基本牌颜色不同，其摸一张牌。",
	["chenjue"] = "尘绝",
	[":chenjue"] = "其他角色的结束阶段开始时，若其手牌数等于你，其可令你与其各选择一张牌，然后交给对方。以此法失去明牌的角色摸一张牌。",
