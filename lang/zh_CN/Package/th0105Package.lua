...
--************************************************
    ...
    [":huantong"] = "当你或你攻击范围内的一名角色受到伤害时，你可以将牌堆顶的一张牌扣置于你的人物牌上，称为“梦幻”。然后你可以展示两张“梦幻”，其获得其中的基本牌并将其余的置入弃牌堆，将伤害值改为X点（X为基本牌数）。 ",
    
	
	["#HuantongDamage"] = "%from 受到 %arg 影响，其受到的伤害值改为 %arg2 点。",
	["~huantong"] = "选择需要展示的梦幻->确定 ", --或 点击取消则增加一张梦幻
	...
	[":mengyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当一名角色受到伤害值大于1的伤害后，你获得所有“梦幻”，然后回复1点体力。",
...
--************************************************	
	...
	["xiewu"] = "协舞",
	[":xiewu"] = "当一名角色使用基本牌时，若其手牌数等于你，你可选择一项：令其摸一张牌；或令其弃置一张牌。<font color=\"green\"><b>每回合限一次。</b></font>",
    ["xiewu_discard"]= "%src 发动“协舞” 令你弃置 1 张牌",
	["nuli"] = "戮力",
    [":nuli"] = "结束阶段开始时，你可获得一名手牌数不小于你的其他角色的一张牌，然后将一张牌交给其，最后你与其各可使用牌。",
	["@nuli"] = "你可发动“戮力”，获得一名手牌数不小于你的其他角色的一张牌，然后将一张牌交给其，最后你与其各可使用牌。",
	["nuliReturn"]= "请将一张牌交给“戮力”对象 <font color=\"#00FF00\"><b>%src </b></font>。",
	["@nuli_use"] = "“戮力”： 你可使用一张牌";
}