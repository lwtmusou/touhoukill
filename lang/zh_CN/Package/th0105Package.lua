...
--************************************************
	...
	["qiusuo"] = "求索",
	[":qiusuo"] = "准备阶段开始时，你可以展示并获得至少一张点数均相同的“真理”。结束阶段开始时，若你造成过伤害，你可以展示并获得至少一张点数均相同的“真理”。",
...
--************************************************
	...
	["mengxiao"] = "梦消",
	[":mengxiao"] = "结束阶段开始时，你可以将一张手牌当任意一次性延时锦囊牌置入判定区。其他角色的准备阶段开始时，你可以将你判定区里的一张牌置入其判定区。",
    ...
    ["lubiao"] = "路标",
	[":lubiao"] = "<font color=\"blue\"><b>锁定技，</b></font>当你受到牌造成的伤害时，若场上有与之颜色不同的延时锦囊牌，此伤害-1。",
...
--************************************************
	...
	["sqchuangshi"] = "创世",
	[":sqchuangshi"] = "出牌阶段开始时，你可以选择任意名角色，这些角色依次可以使用一张牌。",
...
--************************************************
	...
	["modian"] = "魔典",
	[":modian"] = "<font color=\"green\"><b>一名角色的出牌阶段限一次，</b></font>其可以将一张【杀】或普通锦囊牌置于你的人物牌上，称为“魔典”。若“魔典”中没有与之名称相同的牌，其摸一张牌；若“魔典”数大于你的体力值，你将一张“魔典”置入弃牌堆并回复1点体力。",
	["guaiqi"] = "怪绮",
...
--************************************************
	...
	["baosi"] = "报死",
	[":baosi"] = "当你使用【杀】或黑色普通锦囊牌指定目标时，你可以选择至少一名不是此牌目标且体力值不大于其体力下限的其他角色，这些角色成为此牌的额外目标。",
...
--************************************************	
	...
	["huanshu"] = "幻术",
	[":huanshu"] = "<font color=\"blue\"><b>锁定技，</b></font>当其他角色使用的基本牌或普通锦囊牌对你结算完毕后，若你明置的手牌数小于你的体力值，你获得此牌并明置之。",
	["qiren"] = "奇刃",
	[":qiren"] = "你使用非转化的暗置手牌（装备牌和延时锦囊牌除外）可如使用你的一张明置手牌般地选择目标。若如此做，你暗置该明牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["#Qiren"] = "%from 发动“%arg2”，将如同使用 【%arg】一般地 使用暗置手牌",
...
--************************************************	
	...
	["liuzhuan"] = "流转",
	[":liuzhuan"] = "当你或你攻击范围内的一名角色区域里的牌的放置方式改变后，你可以令其选择是否重铸这些牌。",
	["liuzhuanuse"]= "“流转”：你可以重铸防止方式改变的牌。",
	["~liuzhuanVS"]= "选择之前放置方式改变的牌→点击“确定”。",
}