...
--************************************************
	...
	["~zhence"]= "选择一名角色，确认",
	["shiqu"] = "时驱",
	[":shiqu"] = "一名角色的结束阶段开始时，你可以声明于此回合未执行的一个阶段并弃置一张牌，令你或其获得仅有你声明的阶段的一个额外回合。",
	["shiqu_start"] = "准备阶段",
	["shiqu_judge"] = "判定阶段",
	["shiqu_draw"] = "摸牌阶段",
	["shiqu_play"] = "出牌阶段",
...
--************************************************
	...
	["qiusuo"] = "求索",
	[":qiusuo"] = "结束阶段开始时（若你于此回合内造成过伤害）或准备阶段开始时，你可以获得点数均相同的至少一张“真理”。",
	["@qiusuo"] = "你可以展示并获得 任意张点数均相同 的“真理”牌";
	["~qiusuo"] = "选择点数均相同的至少一张“真理”牌 -> 确定";
...
--************************************************
	...
	["yeyan"] = "夜魇",
	[":yeyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当你使用【杀】或普通锦囊牌指定目标后，除你外的目标角色各弃置一张手牌并令你选择一项：展示与之类别相同的一张手牌；或令此牌对其无效。",
