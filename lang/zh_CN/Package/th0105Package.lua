return {
	...
	["#mima"] = "将命运托付给久远的梦的精神" ,
	["eling"] = "恶灵",
	[":eling"] = "当你即将造成或受到的非属性伤害时，你可以判定，若结果不为<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>，此伤害改为雷属性伤害。",
	["xieqi"] = "邪气",
	...
	["#elly"] = "馆的门卫" ,
	["lianmu"] = "镰幕",
	[":lianmu"] = "当你使用的【杀】结算完毕后，若此【杀】未造成伤害，你可以视为使用【杀】，此【杀】无距离限制，且可以额外指定一名其他角色为目标。<font color=\"green\"><b>每阶段限一次。</b></font>",
