...
--************************************************
	...
	["zongjiu"] = "纵酒",
	[":zongjiu"] = "当你成为锦囊牌的目标后，若你未受【酒】的效果影响，你可以将一张手牌当【酒】使用；一名角色的结束阶段开始时，若你仍受【酒】的效果影响，你可以视为对一名其他角色使用【杀】。",
	["@zongjiu-card1"] = "纵酒：你可以将一张牌当【酒】使用",
	["~zongjiu1"] = "选择一张牌 -> （如果有）选择目标 -> “确定”",
	["@zongjiu-card2"] = "纵酒：你可以视为使用【杀】",
	["~zongjiu2"] = "选择目标 -> “确定”",
	["xingyou"] = "星幽",
	[":xingyou"] = "<font color=\"blue\"><b>锁定技，</b></font>当你造成或受到伤害后，若你已受伤且仍受【酒】的效果影响，你终止该效果并回复1点体力。",
