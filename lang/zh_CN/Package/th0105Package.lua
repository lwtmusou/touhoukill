...
--************************************************
	...
	["@ju"] = "车",
	["huosui"] = "祸祟",
	[":huosui"] = "一名角色的回合结束时，若此回合内你的装备牌被弃置或你装备区有牌离开过，你可以视为对一名其他角色使用【杀】；此【杀】指定目标后，目标的防具无效。",
	...
	["yihuan"] = "易幻",
	[":yihuan"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张非装备、不具有伤害效果的牌并选择一名其他角色，对造成1点伤害。",
	["wuzui"] = "无罪",
	...
	["designer:luize"] = "223",
	["illustrator:elis"] = "谁",
	["origin:elis"] = "p号：多少；个人id：多少",
	
	["yuejie"] = "越界",
	[":yuejie"] = "当仅一张牌置入你的一个区域后，你可以与一名你与其该区域里牌数之差不大于X（X为你已损失的体力值+1）的其他角色交换此区域的牌。每回合限一次。",
	["@yuejie-select"] = "你可以发动越界与一名符合条件的角色交换 %arg 的牌",
