...
--************************************************
	...
	["huantong"] = "幻痛",
	[":huantong"] = "当你或你攻击范围内的一名角色受到伤害时，若伤害值为1，你可以将牌堆顶的一张牌扣置于你的人物牌上，称为“梦幻”，然后你可以展示两张“梦幻”，令其获得其中的基本牌并将其余的置入弃牌堆并将伤害值改为X点（X为其中的基本牌数）。 ",
	...
	["dream"] = "梦幻",
	["mengyan"] = "梦湮",
	[":mengyan"] = "<font color=\"blue\"><b>锁定技，</b></font>当一名角色受到大于1点的伤害后，你将所有“梦幻”置入弃牌堆，摸两张牌，回复1点体力，。",
...
--************************************************
	...
	[":qiren"] = "你使用非转化的暗置手牌（装备牌或延时类锦囊牌除外）选择目标时，可如使用一张明置手牌般选择目标角色并暗置此牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
...
--************************************************
	...
	["anliu"] = "暗流",
	[":anliu"] = "当你使用【杀】造成或受到【杀】造成的伤害后，你可以令受到伤害的角色距离为1或0的一名角色获得之，若如此做，你可以展示其一张手牌，若此牌为基本牌，其失去1点体力。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["@anliu"] = "当你可发动“暗流”，令<font color=\"#FF8000\"><b>%src </b></font> 距离为1或0的一名角色获得对其造成伤害的【杀】",
}
