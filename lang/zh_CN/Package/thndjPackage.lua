...
--**********************************
	...
	["@yaoliequip"] = "请选择 1 名装备区或判定区有牌的角色，弃置其装备区和判定区的所有牌。",
	...
	["#yaolitrick_nullification"] = "%from 执行“药理”（普通锦囊牌）的效果，但此普通锦囊牌为【无邪科技】，因而无法修改目标。",
	["#yaolitrick_noAvailable"] = "%from 执行“药理”（普通锦囊牌）的效果，但此锦囊牌当前无目标且无合法目标，因而无法修改目标。",
}
