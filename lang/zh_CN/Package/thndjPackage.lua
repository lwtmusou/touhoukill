return{
    ...
    ["rexue"]="热血",
    [":rexue"]="<font color=\"blue\"><b>锁定技，</b></font>你的回合（额外回合除外）结束后，若你的体力为1且此回合内没有角色死亡，你回复1点体力，摸一张牌，并进行一个额外的回合。",
    ["sidou"] = "死斗",
...
--**********************************
    ...
    ["huanyue"]="幻月",
	[":huanyue"]="当其他角色受到非延时类锦囊牌造成的伤害时，你可令该角色弃置你的一张手牌，若为黑色，此伤害+1。",
    ...
    ["sizhai"] = "死宅",
    [":sizhai"] = "一名角色的结束阶段开始时，若该角色于此回合内没有使用或打出过非装备牌，你可以摸一张牌。 ",
...
--**********************************
    ...
    ["fanji"] = "反击",
    [":fanji"] = "当你受到其他角色对你造成的伤害后，你可以对伤害来源造成1点伤害。当你攻击范围内的角色受到另一名角色对其造成的伤害后，若伤害来源不是你且你的体力上限大于1，你可以失去1点体力上限，对伤害来源造成1点伤害。",
...
--**********************************
    ...
    ["kexue"] = "科学",
    [":kexue"] = "若你处于连环状态，你于出牌阶段空闲时间点使用【杀】时没有距离限制，且可以额外指定任意数量的其他角色为目标。",
}
