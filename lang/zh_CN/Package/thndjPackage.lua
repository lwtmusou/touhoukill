...
--**********************************
	...
	[":yaoli"] = "“药理”的描述（太TM长了）",
	["yaoliattach"] = "药理",
	[":yaoliattach"] = "“药理”附加技能的描述（懒得编了）",
	["yaoli-basic"] = "药理（基本牌）",
	[":yaoli-basic"] = "其使用的基本牌的第一个效果值+1。",
	["yaoli-equip"] = "药理（装备牌）",
	[":yaoli-equip"] = "其使用装备牌时，其可摸X张或弃置场上至多X张牌（若为武器牌，X等于此牌的攻击范围，否则X为1）。",
	["yaoli-trick"] = "药理（锦囊牌）",
	[":yaoli-trick"] = "其使用的普通锦囊牌（以此法使用时除外）结算完毕后，其可以视为使用同名牌。",
