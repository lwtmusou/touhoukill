...
--**********************************
	...
	["liangzi"]= "量子",
	[":liangzi"]= "<font color=\"blue\"><b>锁定技，</b></font>当你使用或打出基本牌或锦囊牌时，你选择一项：横置；或重置。你于你的回合内与其他角色的距离-X（X为你于当前回合内使用过的牌数）。",
	["kexue"] = "科学",
	[":kexue"] = "若你处于连环状态，你于出牌阶段的空闲时间点使用的【杀】和普通锦囊牌的额外目标数无上限。",
	["#kexue-effect"] = "科学",
	["#kexue-dis"] = "科学",
...
--**********************************
	...
	["youle"]= "忧乐",
	[":youle"]= "一名角色的非额外回合结束时，若你于此回合内造成或受到过伤害，你可以弃置一名角色两个区域里各一张牌，若如此做，其获得一个额外的回合。",
	["@youle"]= "你可以选择至少两个区域内有牌的一名角色作为“忧乐”的目标。",
	...
	["yaoliattach"] = "药理",
	[":yaoliattach"] = "<font color=\"green\"><b>你的出牌阶段限一次，</b></font>你可以弃置一张牌，若如此做，有“药理”技能的角色可以摸一张牌，然后弃置一张牌，若弃置的这两张牌对应下列同一种分类，则当你于此阶段内使用下一张该类的牌指定目标时，触发相应效果：<br /><font color=\"orange\"><b>基本</b></font>：此牌的第一个效果值+1。<br /><font color=\"orange\"><b>普通锦囊</b></font>：你令一名角色成为此牌的额外目标或取消一个目标角色。<br /><font color=\"orange\"><b>装备、延时类锦囊</b></font>：你弃置一名角色的装备区和判定区里所有的牌。",
	["yaolibasic"] = "药理（基本牌）",
	...
	["@yaoli-equip"] = "请选择 1 名装备区或判定区有牌的角色，弃置其装备区和判定区的所有牌。",
	["#yaoliequip_noAvailable"] = "%from 执行“药理”（装备牌或延时锦囊牌）的效果，但没有装备区或判定区有牌的角色。",
	["#yaoliequip"] = "%from 执行“药理”（装备牌或延时锦囊牌）的效果，目标为 %to。",
