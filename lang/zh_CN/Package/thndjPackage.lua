return{
    ...
    ["!ndj010"] = "年代记SP梅莉" ,     
        --[[["mengwei"]="梦违",
        [":mengwei"]="<font color=\"blue\"><b>(必须配合东方卡牌包使用)</b></font><font color=\"blue\"><b>锁定技，</b></font>分发起始手牌时，共发给你七张牌。选四张做手牌。将其余的牌面朝下置于你的装备区，称为“？”。结束阶段开始时，若你的装备区里的牌少于四张，你须摸一张牌，然后将一张手牌作为“？”面朝下置于装备区。每当你受到一次伤害时，若你的装备区有“？”，防止该伤害，将一张“？”收入手牌。",
