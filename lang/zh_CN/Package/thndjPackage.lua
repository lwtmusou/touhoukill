...
--**********************************
	...
	["kexue"] = "科学",
	[":kexue"] = "若你处于连环状态，你于出牌阶段的空闲时间点使用的【杀】和普通锦囊牌无距离限制且无额外目标数无上限。",
	["#kexue-effect"] = "科学",
...
--**********************************
	...
	["yaoli"] = "药理",
	[":yaoli"] = "<font color=\"green\"><b>每名角色的出牌阶段限一次，</b></font>其可以弃置一张牌，若如此做，你可以摸一张牌，然后弃置一张牌，若这弃置的两张牌类别相同，其获得对应类别的效果直到此阶段结束：<br /> 基本：其使用的基本牌的第一个效果值+1。<br /> 锦囊：其使用的普通锦囊牌（以此法使用时除外）结算完毕后，其可以视为使用同名牌。<br /> 装备：其使用装备牌时，其可以选择一项：摸X张或弃置场上至多X张牌（若为武器牌，X等于此牌的攻击范围，否则X为1）。",
	["yaoliattach"] = "药理",
