return{
	...
	["rexue"]= "热血",
	[":rexue"]= "<font color=\"blue\"><b>锁定技，</b></font>非额外的回合结束时，若你的体力值不大于体力下限且没有角色于此回合内死亡，你回复1点体力，然后摸一张牌，获得一个额外回合。",
	["sidou"] = "死斗",
...
--**********************************
	...
	["fanji"] = "反击",
	[":fanji"] = "当你或你攻击范围内的角色受到另一名其他角色造成的伤害后，若两者存活，你可以失去1点体力或减1点体力上限，对来源造成1点伤害。",
...
--**********************************
	...
	["liangzi"]= "量子",
	[":liangzi"]= "<font color=\"blue\"><b>锁定技，</b></font>当你使用或打出基本牌或锦囊牌时，你须横置或重置；你于你的回合内与其他角色的距离-X（X为你于此回合内使用过的牌数）。",
	["kexue"] = "科学",
	[":kexue"] = "若你处于连环状态，你于出牌阶段的空闲时间点使用的【杀】和普通锦囊牌能额外选择任意数量的目标。",
	["#kexue-effect"] = "科学",
	["#kexue-dis"] = "科学",
...
--**********************************
	...
	["xiubu"]= "修补",
	[":xiubu"]= "当一名角色于其出牌阶段内使用第一张牌时，若其为你或在你的攻击范围内，你可以弃置其一张手牌，若如此做，其于此阶段内使用最后的一张手牌无距离限制且不计入使用次数限制，且当此阶段结束时，若其于此阶段内使用过的牌数大于1，其摸两张牌。",
...
--**********************************
	...
	["yaoli"] = "药理",
	[":yaoli"] = "<font color=\"green\"><b>其他角色的出牌阶段限一次，</b></font>其可以展示一张牌，令你摸一张牌，然后你弃置一张牌，若展示与弃置的牌类别相同，你获得展示的牌，使其于此阶段内使用下一张同类的牌指定目标时，可以触发相应效果：<br /><font color=\"orange\"><b>基本</b></font>：其令一名在其攻击范围内的角色成为此牌的额外目标。<br /><font color=\"orange\"><b>普通锦囊</b></font>：使此牌的第一个效果值+1。<br /><font color=\"orange\"><b>装备</b></font>：其摸三张牌。",
	["yaoli_attach"] = "药理",
	[":yaoli_attach"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以展示一张牌，若如此做，有“药理”技能的角色可以摸一张牌，然后弃置一张牌，若展示与弃置的牌类别相同，其获得展示的牌，使你于此阶段内使用下一张同类的牌指定目标时，可以触发相应效果：<br /><font color=\"orange\"><b>基本</b></font>：你令一名在你攻击范围内的角色成为此牌的额外目标。<br /><font color=\"orange\"><b>普通锦囊</b></font>：使此牌的第一个效果值+1。<br /><font color=\"orange\"><b>装备</b></font>：你摸三张牌。",
	["yaolibasic"] = "药理（基本牌）",
	["yaoliequip"] = "药理（装备牌）",
	["yaolitrick"] = "药理（普通锦囊牌）",
	...
	["yaoli-draw:hahahahahaha"] = "%src 对你发动“药理”(展示的牌为 %arg)，你可以摸 1 张牌然后弃置 1 张牌。" ,
	["@yaoli-discard"] = "请弃置 1 张牌，包括装备" ,
	["#yaolitrick"] = "%from 执行 <font color=\"#FF8000\"><b>“药理”</b></font>（普通锦囊牌） 的效果，此次使用的 %arg 的第一个效果值 <font color=green><b>+1</b></font>。",
	["@yaolibasic"] = "您执行“药理”（基本牌）的效果，请选择 %arg 的额外目标。",
	["#yaolibasic_jink"] = "%from 执行“药理”（基本牌）的效果，但此牌是【%arg】，因而无法修改目标。",
	["#yaolibasic_noAvailable"] = "%from 执行“药理”（基本牌）的效果，但此牌当前无其他合法目标，因而无法增加额外目标。",
}
