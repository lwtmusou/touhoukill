...
--**********************************
	...
	["huanyue"]= "幻月",
	[":huanyue"]= "当你使用牌造成或受到牌造成的伤害后，你可以将此牌置于人物牌上，称为“符”，然后选择一张“符”，将除此“符”外的“符”置入弃牌堆；当其他角色受到牌造成的伤害时，你可以将与此牌类别不同的一张“符”置入弃牌堆，令伤害值+1。",
	...
	["wanggou"] = "网购",
	[":wanggou"] = "出牌阶段开始时，你可以检索具有伤害效果的一张牌并获得之，然后你可以弃置以此法获得的普【杀】，重复此流程。",
...
--**********************************
	...
	["liexi"] = "裂隙",
	[":liexi"]= "出牌阶段结束时，你可以视为使用【杀】（无距离限制），若如此做，当你使用此【杀】指定目标时，你令不为此牌目标的一名其他角色选择是否摸一张牌并成为此牌的目标，若其选择否，此牌无效。",
	["@liexi"]= "你可以发动“裂隙”， 视为使用【杀】（无距离限制）",
	["~liexi"]= "选择【杀】的合法目标 -> 确定",
	["@liexi_extra"]= "你发动“裂隙”使用了【杀】， 你须指定不为此【杀】的目标且为合法目标的一名其他角色",
	...
	["mengwei"] = "梦违",
	[":mengwei"] = "当你成为【杀】的目标时，你可以令不为此牌目标的一名其他角色选择是否摸一张牌并成为目标，若其选择是，当此【杀】对一名目标角色结算结束后，若其未受到此牌造成的伤害，此牌对所有目标角色无效。",
	["@mengwei"] = "梦违",
...
--**********************************
	...
	["xiubu"]= "修补",
	[":xiubu"]= "当一名角色于其出牌阶段内使用第一张牌时，若其为你或在你的攻击范围内，你可以弃置其一张手牌，若如此做，其于此阶段内使用最后的一张手牌无距离限制且不计入限制的使用次数。当此阶段结束时，若其于此阶段内使用过的牌数大于1，其摸两张牌。",
...
--**********************************
	...
	["jineng"]= "机能",
	[":jineng"]= "准备阶段开始时或当你造成伤害后，你可以判定，若结果与你人物牌上的所有“机”花色均不同，你将之置于人物牌上，称为“机”；你可以将一张“机”按下列规则使用（无距离限制）或打出：黑桃当【杀】，红桃当【闪】，梅花当【知己知彼】，方块当【酒】。",
	["jinengPile"]= "机",
	["kuaibao"]= "快报",
