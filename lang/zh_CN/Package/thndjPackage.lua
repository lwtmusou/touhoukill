...
--**********************************
	...
	[":huanyue"]= "当你造成或受到伤害后，你可以将来源牌置于人物牌上，称为“符”，然后选择一张“符”，将其余的置入弃牌堆。当其他角色受到伤害时，你可以将一张与来源牌类别不同的“符”置入弃牌堆，令伤害值＋1。",
	...
	["wanggou"] = "网购",
	[":wanggou"] = "出牌阶段开始时，你可以检索一张伤害牌并获得之。然后你可以弃置以此法获得的普通【杀】，重复此流程。",
	--[":wanggou_retry"] = "",
	["wanggou:retry"]= "网购:你可以弃置以此法获得的普通【杀】，重复此流程。",
