...
--**********************************
	...
	["huanyue"]= "幻月",
	--[":huanyue"]= "当其他角色受到普通锦囊牌造成的伤害时，你可以令其弃置你的一张手牌，若为黑色，此伤害+1。",
...
--**********************************
	...
	--["zaiwu"]= "载物",
	--[":zaiwu"]= "其他角色的摸牌阶段：若你的体力值大于该角色，你可以令其多摸一张牌；若你的体力值为1且不大于其，你可以令其少摸一张牌。",
	--["zaiwu:minus"]= "你可以发动“载物”，令<font color=\"#FF8000\"><b>%src </b></font> 少摸一张牌",
	--["zaiwu:plus"]= "你可以发动“载物”， 令<font color=\"#FF8000\"><b>%src </b></font> 多摸一张牌",
	["liexi"] = "裂隙",
	[":liexi"]= "出牌阶段结束时，你可以视为使用【杀】。若如此做，当你使用此【杀】指定目标时，你令一名不为此牌目标的其他角色选择是否摸一张牌并成为此牌的目标，若其选择否，此牌无效。",
...
--**********************************
	...
	["kexue"] = "科学",
	[":kexue"] = "若你处于连环状态，你于出牌阶段空闲时间点使用的【杀】无距离限制且额外目标数无上限。",
    ["#kexue-effect"] = "科学",
