...
--***********************************
	...
	["hpymsiyu"] = "死欲",
	[":hpymsiyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当你的体力值于你的回合外扣减至低于体力下限后，你不进入濒死状态，你翻至正面朝上，将你判定区里的牌置入弃牌堆，终止一切结算，当前回合结束。此回合结束后进行一个额外的回合。该额外回合结束时，若你的体力值小于体力下限，你进入濒死状态。<br /><br />" ..
