...
return {
	...
	["qixiang"] = "绮想",
	[":qixiang"] = "当一名角色的判定牌生效后，若其手牌数小于你的体力上限，你可令该角色摸一张牌。",
...
--************************************************
 --zhu005  势力：主 4血
	...
	["baoyi"] = "爆衣",
	[":baoyi"] = "准备阶段开始时，你可以弃置任意数量的装备牌和你判定区里的所有牌。每以此法弃置一张牌，你可以视为对一名其他角色使用【杀】。若以此法弃置了不少于一张<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，此阶段结束时，你摸两张牌。",
