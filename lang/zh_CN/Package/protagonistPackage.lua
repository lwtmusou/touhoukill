...
return {
	...
	["@fengmo-target"] = "你可以发动“封魔”，令一名角色判定，若结果为红色，其于此回合内不能使用或打出除<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌外的牌",
...
--************************************************
	...
	["mofa"] = "魔法",
	[":mofa"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张手牌，若如此做，你于此回合内使用的【杀】或普通锦囊牌的伤害值基数+1。若以此法弃置了<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你摸一张牌。",
...
--************************************************
	...
	["shoucang"] = "收藏",
	[":shoucang"] = "弃牌阶段开始时，你可以展示至少一张花色各不相同的手牌，若如此做，你的手牌上限于此回合内+X（X为你以此法展示的牌数）。",
...
--************************************************
 --zhu005  势力：主 4血
	...
	["baoyi"] = "爆衣",
	[":baoyi"] = "准备阶段开始时，你可以弃置任意数量的装备牌，弃置判定区里的所有牌，然后依次视为使用至多X张【杀】（无距离限制；X为此次共以此法弃置的牌数）。最后若你以此法弃置过<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你摸两张牌。",
	["@baoyi"] = "你可以发动“爆衣”，弃置任意数量的装备牌，然后弃置判定区里的所有牌（以此法弃置的牌数至少为一张）。",
...
--************************************************
  --zhu006  势力：主 4血
	...
	["zhize"]= "职责",
	[":zhize"]= "<font color=\"blue\"><b>锁定技，</b></font>摸牌阶段开始时，你选择一项：你选择一项：失去1点体力并跳过出牌阶段；或放弃摸牌，观看一名有手牌的其他角色的手牌并可以获得其中的一张牌。",
	["@@zhize"]= "请选择一名有手牌的其他角色，观看其手牌并可以获得其中的一张牌，否则你将失去1点体力并跳过此回合内的出牌阶段。",
	["chunxi"]= "春息",
	[":chunxi"]= "当你获得牌后，你可以展示其中至少一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌。若如此做，你每以此法展示一张牌，你可以获得一名其他角色的一张手牌。",
	["@chunxi"]= "你可以发动“春息”，展示你获得的至少一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌",
	["~chunxi"]= "选择此次获得的任意数量的红桃牌 -> 确定",
...
--************************************************
	...
	["bllmwuyu"] = "五欲" ,
	[":bllmwuyu"] = "准备阶段开始时，你可以将“欲”标记补至X枚（X为你已损失的体力值+1）；你可以弃1枚“欲”标记或弃置一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，发动下列中的一项技能：<br /><font color=\"blue\"><b>“名欲”</b></font>（你跳过判定阶段）。<br /><font color=\"blue\"><b>“财欲”</b></font>（摸牌阶段开始时，你摸一张牌）。<br /><font color=\"blue\"><b>“色欲”</b></font>（出牌阶段，你于此回合内使用【杀】的额外次数上限+1）。<br /><font color=\"blue\"><b>“睡欲”</b></font>（弃牌阶段开始时，你的手牌上限于此阶段内视为4）。<br /><font color=\"blue\"><b>“食欲”</b></font>（你可以将一张手牌当【酒】使用）" ,
	["bllmcaiyu"] = "财欲" ,
	["#bllmcaiyu"] = "财欲" ,
	["bllmseyu"] = "色欲" ,
	["#bllmseyu"] = "色欲" ,
...
--************************************************
	...
	["qiangyu"] = "强欲",
	[":qiangyu"] = "当你从牌堆顶摸牌时，你可以多摸两张牌，若如此做，此次摸牌后你选择一项：弃置两张手牌；或弃置一张<font size=\"5\", color=\"#808080\"><b>♠</b></font>手牌。",
...
--***********************************
	...
	["hpymsiyu"] = "死欲",
	[":hpymsiyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当你于其他角色回合内首次进入濒死状态前，你翻至正面朝上，然后将你判定区里的所有牌置入弃牌堆，终止一切结算，结束当前回合，获得一个额外的回合。此额外回合结束时，若你的体力值小于体力下限，你进入濒死状态。<br /><br />" ..
					"♦此技能效果可以突破无法多重执行额外回合效果的限制进行额外回合。",
	["juhe"] = "居合",
	[":juhe"] = "摸牌阶段，你可以多摸三张牌，然后弃置X张手牌（X为你的体力值）。",
...
--***********************************
	...
	["yinyang"] = "阴阳" ,
	[":yinyang"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名有手牌的其他角色，令其弃置一张手牌，然后你弃置一张手牌，最后若以此法弃置了两张颜色：不同的牌，其摸一张牌，然后回复1点体力；相同的牌，你摸两张牌，然后失去1点体力。" ,
...
--***********************************
	...
	["~toushi"]= "选择基本牌或黑桃牌并选择此转化牌的合法目标 -> 确定",
	["moli"] = "魔力" ,
...
--***********************************
	...
	["bodong"] = "波动" ,
	[":bodong"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可弃置一张手牌并选择场上一至三张装备牌，依次横置之。",
	["huanlong"] = "幻胧",
	[":huanlong"] = "当一名角色受到或造成伤害后，你可以重置其装备区的一张横牌，摸一张牌。",
