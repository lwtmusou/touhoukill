...
return {
	...
	[":qixiang"] = "一名角色的红色判定牌生效后，你可令其回复一点体力。",
	...
	[":fengmo"] = "当一名角色于其回合外使用【闪】或【无懈可击】时，你可弃一张手牌并判定，若结果花色与你弃置的牌不同，当前回合角色选择一项：不能使用非<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>的牌直到回合结束； 或受到其造成1点伤害。",
	["@fengmo"] = "你可弃置一张手牌发动“封魔”",
    ["fengmo:card"] = "用牌受到限制",
	["fengmo:damage"] = "受到伤害",
...
--************************************************
	...
	["shoucang"] = "收藏",
	[":shoucang"] = "弃牌阶段开始时，你可以展示任意张花色各不相同的手牌，令你的手牌上限于此回合内+X（X为你以此法展示的牌数）。",
...
--************************************************
 --zhu005  势力：主 4血
	...
	["baoyi"] = "爆衣",
	[":baoyi"] = "准备阶段开始时，你可以弃置任意数量的装备牌和判定区里的所有牌（至少弃置一张牌），你每以此法弃置一张牌，你可以视为对一名其他角色使用【杀】，最后若你以此法弃置过<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你摸两张牌。",
	["@baoyi"] = "你可以发动“爆衣”，弃置任意数量的装备牌并弃置判定区里的所有牌（以此法弃置的牌数至少为一张；即判定区里可以没有牌，但要弃置装备牌，反之要判定区里有牌，但可以不弃置装备牌）。",
...
--************************************************
  --zhu006  势力：主 4血
	...
	["zhize"]= "职责",
	[":zhize"]= "<font color=\"blue\"><b>锁定技，</b></font>摸牌阶段开始时，你选择一项：失去1点体力并跳过出牌阶段；或放弃摸牌并观看一名有手牌的其他角色的手牌并可以获得其中的一张牌。",
