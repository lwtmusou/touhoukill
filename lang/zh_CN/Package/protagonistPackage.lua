...
--************************************************
	...
	["jiezou"] = "借走",
	[":jiezou"] = "出牌阶段，你可以将一张牌当【顺手牵羊】使用（以此法使用黑桃牌无距离限制）。以此法使用非黑桃牌时，或获得装备区里的黑桃牌后，你结束当前阶段。",
...
--************************************************
  --zhu006  势力：主 4血
	...
	["zhize"]= "职责",
	[":zhize"]= "<font color=\"blue\"><b>锁定技，</b></font>你少摸一张牌，观看一名有手牌的其他角色的手牌并获得其中一张牌。",
	["@zhize"]= "请选择一名有手牌的其他角色，观看其手牌并获得其中的一张牌。",
	["chunxi"]= "春息",
	[":chunxi"]= "当你获得牌后，你可以展示其中一张红桃牌并选择一名有手牌的其他角色（其不能是此回合内以此法选择过的角色），获得其一张手牌。",
	["@chunxi"]= "你可以发动“春息”，展示你获得的一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌，并选择一名有手牌的其他角色，获得其一张手牌",
	["~chunxi"]= "选择此次获得的一张红桃牌 -> 选择一名其他角色 -> 确定",
