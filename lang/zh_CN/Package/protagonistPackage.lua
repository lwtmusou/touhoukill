...
--************************************************
	...
	["&marisa_old"] = "旧作魔理沙" ,
	["toushi"] = "偷师" ,
	[":toushi"] = "其他角色的出牌阶段结束时，若其于此阶段内使用的最后的牌是杀或非延时锦囊，你可以将一张基本牌或<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌当与此牌名称相同的牌使用。" ,
	["@toushi"]= "你可以发动“师从”，视为你使用将一张 基本牌 或<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌当做 【%src】使用。",
