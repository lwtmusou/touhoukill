...
return {
	...
	["fengmo"] = "封魔",
	[":fengmo"] = "当有角色使用【闪】或【无懈可击】时，你可令一名角色判定，若结果为红色，本回合内其不能使用或打出<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>以外的牌。<font color=\"green\"><b>每阶段限一次，</b></font>",
...
--************************************************
	...
	["#mofa_notice"]= "由于 %arg 的效果，此回合内 %from 使用的【杀】或普通锦囊造成的伤害+1。",
...
--************************************************
	...
	["mokai"] = "魔开",
	[":mokai"] = "你于出牌阶段使用黑色锦囊牌时，你可弃置一张装备牌，然后摸两张牌。每阶段限x次（x为你的体力值且至少为1）。",
