...
--************************************************
	...
	["mofa"] = "魔法",
	[":mofa"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张手牌，令你于此回合内使用的【杀】或普通锦囊牌的伤害值基数+1，然后若被弃置的此牌花色为<font size=\"5\", color=\"#808080\"><b>♠</b></font>，你摸一张牌。",
...
--************************************************
 --zhu005  势力：主 4血
	...
	["baoyi"] = "爆衣",
	[":baoyi"] = "准备阶段开始时，你可以弃置任意数量的装备牌和判定区里的所有牌（至少一张，但判定区里的牌数可以为零），你每以此法弃置一张牌，你可以视为对一名其他角色使用【杀】，最后若这些牌中有<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，你摸两张牌。",
...
--***********************************
	...
	[":toushi"] = "其他角色的出牌阶段结束时，若其于此阶段内使用的最后的牌为【杀】或普通锦囊牌，你可以将一张非锦囊牌当同名牌使用。你以此法使用<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌时，摸一张牌。" ,
