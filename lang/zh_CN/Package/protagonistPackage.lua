...
--***********************************
	...
	["hpymsiyu"] = "死欲",
	[":hpymsiyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当你于其他角色回合内首次进入濒死状态前，你将人物牌翻至正面朝上，然后将你判定区里的所有牌置入弃牌堆，终止一切结算，结束当前回合，获得一个额外的回合。此额外回合结束时，若你的体力值小于体力下限，你进入濒死状态。<br /><br />♦此技能效果可以突破无法多重执行额外回合效果的限制进行额外回合。",
	["juhe"] = "居合",
