...
return {
	...
	["qixiang"] = "绮想",
	[":qixiang"] = "当牌因使用、打出或弃置以外的原因置入弃牌堆后，你可以令一名角色获得其中的<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌。",
	["@qixiang-select"] = "你可以发动“绮想”，令一名角色获得此次置入弃牌堆所有的红桃牌。",

	["fengmo"] = "封魔",
	[":fengmo"] = "当其他角色于一个回合内首次使用基本牌时，你可以弃置一张手牌，令该角色判定，若结果为红色，此牌无效。",
