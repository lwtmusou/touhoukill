...
return {
    ...
    [":boli"] ="<font color=\"orange\"><b>主公技，</b></font>当判定牌生效前，若此牌不为<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>，你可令其他角色依次选择是否打出一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>手牌代替之。",
 ...
 --zhu005  势力：主 4血
    ...
    ["!zhu005"] = "超魔理沙",
    ["baoyi"] = "爆衣",
    [":baoyi"] ="准备阶段开始时，你可以弃置任意数量的装备牌并弃置判定区里的所有牌。每以此法弃置一张牌，你可以选择：视为你对一名其他角色使用一张【杀】。若以此法弃置了不少于一张<font size=\"5\", color=\"#808080\"><b>♠</b></font>牌，此阶段结束时，你可以摸两张牌。",
