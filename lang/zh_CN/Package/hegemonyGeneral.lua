...
--春（花）
	...
	["lizhi_hegemony"] = "理智",
	[":lizhi_hegemony"] = "当你使用的具有伤害效果的牌结算完毕后，若此牌未造成过伤害，你可以令一名与你阵营相同的角色获得此牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["@lizhi"] = "理智： 你使用的牌并未造成伤害，你可以令一名与你阵营相同的角色获得此牌。 ",
...
--夏（月）
	...
	["kaifeng_hegemony"] = "凯风",
	[":kaifeng_hegemony"] = "当你对一名其他角色造成火焰伤害后或你受到一名其他角色造成的火焰伤害时，若你的体力值小于该角色，你回复1点体力。",
