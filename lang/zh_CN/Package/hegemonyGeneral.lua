...
--春（花）
	...
	["yunshang_hegemony"] = "云上",
	[":yunshang_hegemony"] = "<font color=\"blue\"><b>锁定技，</b></font>当你成为其他角色使用的普通锦囊牌的目标后，若你不在其攻击范围内，此牌对你无效。",
...
--秋（风）
	...
	["tongju_hegemony"] = "桶居",
	[":tongju_hegemony"] = "<font color=\"blue\"><b>锁定技，</b></font>当你成为【南蛮入侵】或【万箭齐发】或【铁索连环】的目标时，你取消自己。",
