...
3v3：摸牌阶段，你可以少摸一张牌，令其他己方角色各摸一张牌。" ,
	...
	["huanshi"] = "缓释",
	[":huanshi"] = "每当一名角色的判定牌生效前，你可以令该角色观看你的手牌，然后该角色选择一张牌，你打出该牌代替之。\
3v3：每当己方角色的判定牌生效前，你可以打出一张牌代替之。" ,
	...
	["zhiri"] = "炙日" ,
	[":zhiri"] = "<font color=\"purple\"><b>觉醒技，</b></font>准备阶段开始时，若焚的数量达到3或者更多，你减1点体力上限，然后获得技能“心惔”(<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将两张“焚”置入弃牌区并选择一名角色，该角色失去一点体力。)" ,
	["xintan"] = "心惔" ,
