...
return{ ["th06"] = "红魔乡",
    ...
    ["huisu"] = "回溯",
    [":huisu"] = "每当你受到一次伤害后，你可以判定，若结果为红色2-9，你回复1点体力。每当你失去一次体力后，你可以判定，若结果为<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>2-9，你回复1点体力。",
    ["huisu1"] = "回溯（伤害）",
    ["huisu2"] = "回溯（体力流失）",
    ...
    ["!hmx007"] = "露米娅",  
    ["zhenye"] = "真夜",
    [":zhenye"] = "结束阶段开始时，你可以将你的人物牌翻面，然后将一名其他角色的人物牌翻面。",
    ...
    ["!hmx009"]="大妖精",                 
    ["juxian"]="具现",
    [":juxian"]="当你进入濒死状态时，若你的人物牌正面朝上，你可以将你的人物牌翻面，亮出牌堆顶的三张牌，然后选择一种花色并获得与所选花色不同的牌，将其余的牌置入弃牌堆并回复等量的体力。",
