...
["hmx001"] = "蕾米莉亚·斯卡雷特",["&hmx001"] = "蕾米莉亚",["#hmx001"] = "红之恶魔",
		...
		["mingyun"] = "命运",
        [":mingyun"] = "在一次判定开始前，你可以观看牌堆顶的两张牌并获得其中的一张，将另一张置于牌堆顶。",
...
["!hmx004"] = "帕秋莉",
	["bolan"] = "博览",
	[":bolan"] = "若其他角色使用的非延时类锦囊牌（【无懈可击】除外）在结算后置入弃牌堆，你可以将其置于你的武将牌上，称为“曜”。此回合结束时，你须将所有“曜”加入手牌，然后将手牌弃至体力上限的张数。",
...
["hmx006"] = "琪露诺",["#hmx006"] = "湖上的冰精",
    ["!hmx006"] = "琪露诺",   
	["dongjie"] = "冻结",
    [":dongjie"] = "每当你使用【杀】对目标角色造成一次伤害时，你可以防止此伤害并摸一张牌，然后该角色将其武将牌翻面并摸一张牌。",
...
["@zhenye-select"]="你可以指定一名其他角色，你和该角色依次将武将牌翻面。",
 ["$zhenyeAnimate"]="image=image/animate/zhenye.png",
 

["anyu"] = "暗域",
[":anyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当你成为黑色【杀】或黑色非延时类锦囊牌的目标时，你须选择一项：摸一张牌，或将你的武将牌翻面。",
["anyu:turnover"] = "将你的武将牌翻面",
        ["anyu:draw"] = "摸一张牌" ,
...
["hmx009"]="大妖精",["#hmx009"]="雾之湖畔的妖精",
    ["!hmx009"]="大妖精",                 
	["juxian"]="具现",
        [":juxian"]="当你进入濒死状态时，若你的武将牌正面朝上，你可以将你的武将牌翻面，展示牌堆顶的三张牌，然后选择一种花色并获得与所选花色不同的牌，将其余的牌置入弃牌堆并回复等量的体力。",
