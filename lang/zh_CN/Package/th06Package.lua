...
--************************************************
	...
	["bolan"] = "博览",
	[":bolan"] = "出牌阶段开始时或当你成为其他角色使用锦囊牌的目标后，你可以观看牌堆顶的三张牌，并改变其中任意数量的牌的顺序并将其余的牌以任意顺序置于牌堆底。<br />♦将多张牌置于牌堆底时，牌越往右边放，越接近底部。",
	["#bolanResult"] = "%from 的“<font color=\"yellow\"><b>博览</b></font>”结果：%arg 上，%arg2 下。",
	["hezhou"] = "合咒",
	[":hezhou"] = "当你需要使用/打出任意基本牌或普通锦囊牌时（除【无懈可击】外），你可以声明之并将牌堆底的两张牌置入弃牌堆，若两张牌花色与类型均不同，你视为使用/打出声明的牌。<font color=\"green\"><b>每回合限一次。</b></font>",
