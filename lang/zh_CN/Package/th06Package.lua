...
return{ ["th06"] = "红魔乡",
	...
	["skltkexue"] = "渴血",
	[":skltkexue"] = "当处于濒死状态时的你向其他角色求【桃】时，若其体力值大于其体力下限，其可以失去1点体力并摸两张牌，令你回复1点体力。",
	["skltkexue_attach"]= "渴血出桃",
	[":skltkexue_attach"]= "当拥有“渴血”的角色处于濒死状态时并向你求【桃】时，若你的体力值大于体力下限，你可以失去1点体力并摸两张牌，令其回复1点体力。",
	["mingyun"] = "命运",
...
--************************************************
	...
	["pohuai"] = "破坏",
	[":pohuai"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时，你判定，若结果为【杀】，你选择距离为1和0的所有角色，对这些角色各造成1点伤害。",
	["yuxue"] = "浴血",
...
--************************************************
	...
	["suoding"] = "锁定",
	[":suoding"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名有手牌的角色，将其一张手牌扣置于其人物牌旁，称为“锁定”，若“时”小于3，你可以重复此流程。若如此做，此回合结束时，以此法失去牌的角色获得其人物牌旁的所有“锁定”。",
	["suoding_cards"] = "锁定",
...
--************************************************
	...
	["origin:meirin_1"] = "p号：35872256，个人ID：2600911",
...
--************************************************
	...
	["dongjie"] = "冻结",
	[":dongjie"] = "当你使用牌对目标角色造成伤害时，你可以防止此伤害并摸一张牌，然后令其翻面，最后令其摸一张牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["#Dongjie"] = "%from 发动了“%arg”，防止了对 %to 的伤害",
	["bingpo"] = "冰魄",
	[":bingpo"] = "<font color=\"blue\"><b>锁定技，</b></font>当你受到除火焰伤害外的伤害时，若此伤害不小于你的体力值，防止此伤害。",
...
--************************************************
	...
	--["qiyue:hp"]= "失去1点体力",
	--["qiyue:target"] = "你可以发动技能“契约”，令<font color=\"#00FF00\"><b>%src </b></font>跳过此回合的判定阶段和摸牌阶段。",
	--["moxue"] = "魔血",
	...
	["@moqi"] = "魔契(后续): 你可以选择发动“魔契”的角色，令其失去1点体力； \n 或点击 取消 来视为使用果【酒】",

	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以检索一张锦囊牌，令一名角色获得之，若其不为你，你回复1点体力。然后你可以重复此流程（至多重复X次。X为发动此技能时你已损失的体力值）。",
...
--************************************************	
	...
	["fenghua"]= "风花",
	[":fenghua"]= "<font color=\"blue\"><b>锁定技，</b></font>游戏开始时或当一张“风花”从你的人物牌上移至另一个区域时，你将牌堆顶的一张牌置于人物牌上，称为“风花”；当你成为其他角色使用的【杀】或普通锦囊牌的目标后，若此牌与一张“风花”花色相同，你令此牌对你无效并获得所有“风花”。",
...
--************************************************	
	...
	["shixue"]= "嗜血",
	[":shixue"]= "<font color=\"blue\"><b>锁定技，</b></font>当你造成1点伤害后，你回复1点体力；你以此法外的原因回复体力时， 若你不处于濒死状态，防止回复效果并摸两张牌。",
	["#shixue1"]= "由于“%arg”的效果，%from 回复的 %arg2 点体力效果被防止了",
	["ziye"] = "子夜",
	[":ziye"] = "<font color=\"purple\"><b>觉醒技，</b></font>当其他角色因你造成的伤害而进入濒死状态时，你减1点体力上限，获得“暮尽”（当不处于濒死状态的其他角色回复体力后，若其体力值不小于你，你可以翻面，视为对其使用无视防具的【杀】）。",
	
	["#ZiyeWake"] = "%from 使一名其他角色进入了濒死状态， 触发了“%arg”觉醒",
	["$ziyeAnimate"]= "skill=rumia_sp:ziye",
	["anyue"]= "暗月",
	[":anyue"]= "其他角色回复体力后，若其不处于濒死状态且体力值不小于你，你可以翻面，视为对其使用无视防具的【杀】。",
}
