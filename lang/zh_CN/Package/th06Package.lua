...
return{ ["th06"] = "红魔乡",
	...
	["mingyun"] = "命运",
	[":mingyun"] = "当判定开始前，你可以观看牌堆顶的两张牌并获得其中的一张牌。",
	["mingyun:judge"] = "<font color=\"#00FF00\"><b>%src </b></font> 将要进行 “%dest” 的判定结算，你可以发动“命运”。",
	["xueyi"] = "血裔",
	[":xueyi"] = "<font color=\"orange\"><b>主公技，</b></font>当其他红势力角色回复体力后，其可以令你摸一张牌。",
	["@@xueyi"]= "你选择拥有主公技“血裔”的角色，令其摸一张牌。",
...
--************************************************
	...
	["illustrator:patchouli_4"] = "萩原",
	["origin:patchouli_4"] = "个人ID：37062",
	["illustrator:patchouli_5"] = "木子翔",
	["origin:patchouli_5"] = "p号：33195548，个人ID：652180",


	["bolan"] = "博览",
	[":bolan"] = "当其他角色于其出牌阶段内使用普通锦囊牌时，你可以亮出牌堆顶的两张牌，然后获得其中的锦囊牌和与此牌花色相同的牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["hezhou"] = "合咒",
	[":hezhou"] = "你于回合外可以将两张类别不同的牌当【桃】使用，当以此法使用的牌因结算完毕而置入弃牌堆后，你可以令一名其他角色获得这两张牌中的锦囊牌。",
	["@hezhou"] = "你可以发动“合咒” ，令一名其他角色获得 <font color=\"#FF8000\"><b>%src </b></font> ",
...
--************************************************
	...
	["#cirno"] = "湖上的冰精",
	["designer:cirno"] = "星野梦美☆",
	["comment:cirno"] = "<div align=right>⑨</div>",
	...
	["dongjie"] = "冻结",
	[":dongjie"] = "当你使用牌对目标角色造成伤害时，你可以防止此伤害，摸一张牌，然后令其翻面，令其摸一张牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
...
--************************************************
	...
	["#rumia"] = "宵暗的妖怪",
	["designer:rumia"] = "星野梦美☆",
	["comment:rumia"] = "<div align=center><i>“是~这样吗？”</i></div>",
...
--************************************************
	...
	["moqi"] = "魔契",
	[":moqi"] = "其他角色的摸牌阶段，你可以令其少摸一张牌，你摸一张牌，若如此做，此阶段结束时，其选择一项：视为使用果【酒】，或令你失去1点体力。",
	["@moqi"] = "魔契(后续): 你可以点击<font color=\"#FFA500\"><b>确定</b></font>，令发动“魔契”的角色失去1点体力；<br />或点击<font color=\"#90EE90\"><b>取消</b></font>，来视为使用果【酒】（你使用的第一张普通锦囊牌有增益）",

	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以检索一张普通锦囊牌，然后令一名角色获得之（若其不为你，你回复1点体力），最后你须重复以上流程X次（X为发动此技能时你已损失的体力值）。",
