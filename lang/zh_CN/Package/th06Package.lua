...
return{ ["th06"] = "红魔乡",
    ...
    ["xueyi"] = "血裔",
    [":xueyi"] = "<font color=\"orange\"><b>主公技，</b></font>每当其他红势力角色回复体力后，该角色可令你摸一张牌。",
...
--************************************************	
    ...
    ["pohuai"] = "破坏",
    [":pohuai"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时，你须判定，若结果为【杀】，你指定距离为1以内的所有角色，并对这些角色依次造成1点伤害。",
    ["yuxue"] = "浴血",
    [":yuxue"] = "每当你受到伤害后，你可以使用一张【杀】。此【杀】不计入每阶段的使用限制，无距离限制，且造成的伤害+1。",
...
--************************************************	
    ...
    ["huisu"] = "回溯",
    [":huisu"] = "每当你受到伤害后，你可以判定，若结果为红色2-9，你回复1点体力。每当你失去体力后，你可以判定，若结果为<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>2-9，你回复1点体力。",
    ["huisu1"] = "回溯（伤害）",
    ["huisu2"] = "回溯（体力流失）",
...
--************************************************	    
    ...
    ["bolan"] = "博览",
    [":bolan"] = "若其他角色使用的非延时类锦囊牌（【无懈可击】除外）在结算后置入弃牌堆后，你可以将其置于你的人物牌上，称为“曜”。此回合结束时，你须将所有“曜”加入手牌，然后将手牌弃至体力上限的张数。",
...
--************************************************	
    ...
    ["neijin"] = "内劲",
	[":neijin"] = "其他角色的出牌阶段结束时，若你的人物牌竖置且你的手牌数小于体力上限，你可以将你的人物牌横置，将手牌摸至体力上限的张数，然后将X张手牌交给该角色（X为你以此法摸牌的数量）。",
    ["neijin_exchange"] = "请将<font color=\"#00FF00\"><b>%dest </b></font> 张手牌交给当前回合人 <font color=\"#00FF00\"><b>%src </b></font>。",
	["taiji"] = "太极",
	[":taiji"] = "每当你受到非属性伤害后，若你的人物牌横置，你可以将你的人物牌竖置，对一名其他角色造成一点伤害。",
...
--************************************************		
    ...
    ["dongjie"] = "冻结",
    [":dongjie"] = "每当你使用【杀】对目标角色造成伤害时，你可以防止此伤害并摸一张牌，然后该角色翻面并摸一张牌。",
    ["$dongjieAnimate"]="image=image/animate/dongjie.png",
    ["#Dongjie"] = "%from 发动了“%arg”，防止了对 %to 的伤害",
    ["bingpo"] = "冰魄",
    [":bingpo"] = "<font color=\"blue\"><b>锁定技，</b></font>每当你受到火焰伤害以外的伤害时，若此伤害多于1点或你的体力值不大于1，防止此伤害。",
...
--************************************************	
    ...
    ["anyu"] = "暗域",
    [":anyu"] = "<font color=\"blue\"><b>锁定技，</b></font>当你成为黑色【杀】或黑色非延时类锦囊牌的目标时，你须选择一项：摸一张牌，或翻面。",
    ["anyu:turnover"] = "翻面",
    ["anyu:draw"] = "摸一张牌" ,
...
--************************************************	
    ...
    ["qiyue"] = "契约",
    [":qiyue"] = "其他角色的准备阶段开始时，你可以摸一张牌，然后失去1点体力或体力上限，并令该角色跳过此回合的判定阶段和摸牌阶段。",
