...
--************************************************
	...
	["zhenye"] = "真夜",
	[":zhenye"] = "出牌阶段限一次，你可以翻面并令一名其他角色选择一项：1.摸X张牌（X为其已损失的体力值且至少为1，至多为3），然后翻面；2.展示X张牌，令你获得其中的黑色牌，然后弃置其余的牌。",
	["@zhenye-exchange"] = "你受到 %src 发动的“真爷”的效果，你可以（第 2 项）展示 %arg 张牌，令 %src 获得其中的黑色牌并弃置其余牌，或者（第 1 项）点击“取消”摸 %arg 张牌并翻面。",
	["anyu"] = "暗域",
