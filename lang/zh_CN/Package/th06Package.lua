...
return{ ["th06"] = "红魔乡",
	...
	["origin:remilia_2"] = "p号：5273512，个人id：2475",
	...
	["skltkexue"] = "渴血",
	[":skltkexue"] = "当你向其他角色求【桃】时，若其体力值大于其体力下限，其可以失去1点体力，摸两张牌，然后令你回复1点体力。",
	["skltkexue_attach"]= "渴血出桃",
	[":skltkexue_attach"]= "当拥有“渴血”的角色处于濒死状态时并向你求【桃】时，若你的体力值大于体力下限，你可以失去1点体力，摸两张牌，然后令其回复1点体力。",
	["mingyun"] = "命运",
	[":mingyun"] = "当判定开始前或出牌阶段结束时，若你的手牌数不大于你的体力上限，你可以观看牌堆顶的两张牌并获得其中一张牌，反之你可以将一张手牌置于牌堆顶。",
	["mingyun:judge"] = "<font color=\"#00FF00\"><b>%src </b></font> 将要进行 “%dest” 的判定结算，你可以发动“命运”，观看牌堆顶的两张牌并获得其中一张牌。",
	["mingyun:playphase"] = "你的出牌阶段结束了。你可以发动“命运”观看牌堆顶的两张牌并获得其中一张牌。",
	["@mingyun_overmaxhp_judge"] = "<font color=\"#00FF00\"><b>%src </b></font> 将要进行 “%dest” 的判定结算，你可以发动“命运”，将一张手牌至于牌堆顶。",
	["@mingyun_overmaxhp_playphase"] = "你的出牌阶段结束。你可以发动“命运”，将一张手牌至于牌堆顶。",
	["xueyi"] = "血裔",
	[":xueyi"] = "<font color=\"orange\"><b>主公技，</b></font>当其他红势力角色回复体力后，其可以令你摸一张牌。",
...
--************************************************
	...
	["pohuai"] = "破坏",
	[":pohuai"] = "<font color=\"blue\"><b>锁定技，</b></font>准备阶段开始时，你判定，若结果为【杀】，你选择距离不大于1的所有角色，对这些角色各造成1点伤害。",
	["yuxue"] = "浴血",
	[":yuxue"] = "当你受到伤害后，你可以使用【杀】（无距离限制且伤害值基数+1）。",
	["@yuxue"] = "你可以发动“浴血”，使用【杀】（此【杀】无距离限制）。",
	["#yuxue_damage"]= "%from的“%arg”效果被触发，%from对%to造成的伤害值+1",
	["#yuxue-slash-ndl"] = "浴血（无距离限制）",
	["shengyan"] = "盛宴",
	[":shengyan"] = "当你造成1点伤害后，你可以摸一张牌。",
...
--************************************************
	...
	["illustrator:sakuya_6"] = "KiTA",
	["origin:sakuya_6"] = "p号：56316640，个人id：1922517",
	["illustrator:sakuya_7"] = "kino★きのこのみ",
	["origin:sakuya_7"] = "p号：50275980，个人id：40912",

	["suoding"] = "锁定",
	[":suoding"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一名角色的一张手牌扣置于其人物牌旁，称为“锁定”，然后你可以重复以上流程至多两次，且此回合结束时，以此法失去牌的角色获得其人物牌旁的“锁定”。",
	["suoding_cards"] = "锁定",
	["suoding_exchange"] = "你对你发动了“锁定”，请选择 %src 张牌。",
	["#suoding_Trigger"]= "%from 的 “%arg” 被触发， %to 获得了 %arg2 张“锁定”牌。",
	["huisu"] = "回溯",
	[":huisu"] = "一名角色的结束阶段开始时，若你于此回合内扣减过体力，你可以判定，若结果为红色，你回复1点体力。",
...
--************************************************
	...
	["#patchouli"] = "不动的大图书馆",
	["!patchouli"] = "帕秋莉·诺蕾姬",
	["designer:patchouli"] = "sp饼",

	["illustrator:patchouli"] = "希",
	["origin:patchouli"] = "p号：4780745，个人id：92364",

	["illustrator:patchouli_1"] = " ファルまろ ",
	["origin:patchouli_1"] = "p号：45374100，个人id：1218472",
	...
	["bolan"] = "博览",
	[":bolan"] = "当你成为其他角色使用锦囊牌的目标后，你可以观看牌堆顶的三张牌，并改变其中任意数量的牌的顺序并将其余的牌以任意顺序置于牌堆底。<br />♦将多张牌置于牌堆底时，牌越往右边放，越接近底部。",
	["#bolanResult"] = "%from 的“<font color=\"yellow\"><b>博览</b></font>”结果：%arg 上，%arg2 下。",
	["hezhou"] = "合咒",
	[":hezhou"] = "你于回合内需要使用非全体性普通锦囊或回合外需要使用【桃】时，你可以声明之并将牌堆底的两张牌置入弃牌堆，若两张牌花色与类型均不同，你视为使用声明的牌。<font color=\"green\"><b>每回合限一次。</b></font>",
	["#Hezhou"] = "%from 发动了“%arg2”，声明此牌为 【%arg】，选择的目标为 %to",
	["#HezhouNoTarget"] = "%from 发动了“%arg2”，声明此牌为 【%arg】",
...
--************************************************
	...
	["illustrator:meirin"] = "NEKO",
	["origin:meirin"] = "p号：35872256，个人id：2600911",
	["illustrator:meirin_1"] = "yudofu",
	["origin:meirin_1"] = "p号：3804946",
	["illustrator:meirin_2"] = "ke-ta",
	["origin:meirin_2"] = "p号：18637750，个人id：3104565",
	["illustrator:meirin_3"] = "もねてぃ",
	["origin:meirin_3"] = "p号：60314538，个人id：3066815",
	...
	["taiji"] = "太极",
	[":taiji"] = "当你使用【杀】指定唯一目标后或当你成为【杀】的唯一目标后，你可以令目标角色获得此【杀】，若如此做，此【杀】不计入使用次数限制，且当此【杀】被【闪】抵消时，此【杀】的使用者获得此【闪】。",
	["beishui"] = "背水",
	[":beishui"] = "你可以将X张牌当任意基本牌使用（X为你的体力值且至少为1）。<font color=\"green\"><b>每阶段限一次。</b></font>",
--************************************************
	--hmx006  势力：红 3血
	["cirno"] = "琪露诺",
	["#cirno"] = "湖上的冰精",
	...
	["origin:cirno_5"] = "",
    ["illustrator:cirno_6"] = "ちんちくりん",
	["origin:cirno_6"] = "p号：7616113，个人id：3401",
	
	
	["dongjie"] = "冻结",
	[":dongjie"] = "当你使用牌对目标角色造成伤害时，你可以防止此伤害并摸一张牌，然后其翻面并摸一张牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
...
--************************************************
	...
	["illustrator:rumia"] = "黒夢",
	["origin:rumia"] = "p号：35541348，个人id：1350867",
	...
	["illustrator:rumia_4"] = "ポップル",
	["origin:rumia_4"] = "p号：6034882，个人id：888775",
	["illustrator:rumia_5"] = " Spark621 ",
	["origin:rumia_5"] = "p号：52409111，个人id：2488754",
	["illustrator:rumia_6"] = "こぞう",
	["origin:rumia_6"] = "p号：40076871，个人id：5626224",
	["illustrator:rumia_7"] = " HenryTZ ",
	["origin:rumia_7"] = "p号：31543757，个人id：1038265",

	["zhenye"] = "真夜",
	[":zhenye"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以翻面并令一名其他角色选择一项：1.摸X张牌（X为其已损失的体力值且至少为1，至多为3），然后翻面；2.展示X张牌，令你获得其中的黑色牌，然后弃置其余的牌。",
	["@zhenye-exchange"] = "你因 %src “真夜”的效果，要么选择 %arg 张牌，然后点击 “确定” ，令 %src 获得其中的黑色牌和弃置其余的牌，要么点击 “取消” 来摸 %arg 张牌并翻面。",
	["anyu"] = "暗域",
	[":anyu"] = "当你成为黑色牌的目标后，你可以摸一张牌或翻面。",
	["anyu:turnover"] = "翻面",
	["anyu:draw"] = "摸牌" ,
...
--************************************************
	...
	["illustrator:koakuma"] = "しろさ",
	["origin:koakuma"] = "p号：27795527，个人id：374262",
	...
	["moqi"] = "魔契",
	[":moqi"] = "当一名角色于其出牌阶段内首次使用普通锦囊牌时，你可以令此牌的首个效果值+1。",
	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以重复以下流程X次（X为发动此技能时你已损失的体力值+1）：你检索一张普通锦囊牌，然后令一名角色获得之，若其不为你，你回复1点体力。",
...
--************************************************
	...
	["illustrator:daiyousei_3"] = "住吉眞白",
	["origin:daiyousei_3"] = "p号：19870726，个人id：2388526",
	["juxian"]= "具现",
	[":juxian"]= "当你进入濒死状态时，你可以翻面，然后若你人物牌正面朝下，你亮出牌堆顶的三张牌（存活角色数小于4时，改为一张），选择一种花色，获得其中与此花色不同的牌，将其余的牌置入弃牌堆并回复等量的体力。",
	["banyue"]= "半月",
	[":banyue"]= "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以令一至三名角色各摸一张牌，然后若此次选择了至少两名角色，你失去1点体力。",
...
--************************************************
	...
	["@mizong-ask"]= "你触发了“觅踪”，请选择一名其他角色。",
	["@mizong"] = "觅踪" ,
	["yinren"]= "银刃",
	[":yinren"]= "当你使用黑色【杀】指定一个目标后，你可以令其于此【杀】结算完毕之前不能使用或打出红色牌，且其除永久技外的技能无效。",
...
--************************************************
	...
	["xiaoyin"]= "消隐",
	[":xiaoyin"]= "其他角色的出牌阶段开始时，若你在其攻击范围内，你可以令其将一张手牌当【调虎离山】对你使用（其他角色不是此牌的合法目标）。",
	["xiaoyinuse"]= "你须将一张手牌当【调虎离山】对 <font color=\"#FF8000\"><b>%src </b></font> 使用。",
	["~xiaoyinVS"]= "选择一张手牌 -> 确定。",
	["#xiaoyin"]= "消隐",

	["fenghua"]= "风花",
	[":fenghua"]= "<font color=\"blue\"><b>锁定技，</b></font>游戏开始时或当一张“风花”从你的人物牌上移出后，你将牌堆顶的一张牌置于人物牌上，称为“风花”；当你成为其他角色使用的【杀】或普通锦囊牌的目标后，若此牌与一张“风花”花色相同，你令此牌对你无效并获得所有“风花”。",
	["$Fenghua"] = "%from 的“%arg” 被触发， 将获得 “%arg” 牌  %card ",
...
--************************************************
	...
	["ziye"] = "子夜",
	[":ziye"] = "<font color=\"purple\"><b>觉醒技，</b></font>当其他角色因你造成的伤害而进入濒死状态时，你减1点体力上限，获得“暗月”（当其他角色回复体力后，若其不为体力值唯一最小的角色且不处于濒死状态，你可以翻面，视为对其使用无视防具的【杀】）。",

	["#ZiyeWake"] = "%from 使一名其他角色进入了濒死状态， 触发了“%arg”觉醒",
	["$ziyeAnimate"]= "skill=rumia_sp:ziye",
	["anyue"]= "暗月",
	[":anyue"]= "当其他角色回复体力后，若其不是体力值唯一最小的角色且不处于濒死状态，你可以翻面，视为对其使用无视防具的【杀】。",
}
