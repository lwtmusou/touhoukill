...
--************************************************
	...
	["bolan"] = "博览",
	[":bolan"] = "出牌阶段开始时或当你成为其他角色使用锦囊牌的目标后，你可以观看牌堆顶的三张牌，然后以任意顺序放回牌堆顶或牌堆底。",
	["#bolanResult"] = "%from 的“<font color=\"yellow\"><b>博览</b></font>”结果：%arg 上，%arg2 下。",
	["hezhou"] = "合咒",
	[":hezhou"] = "当你需要使用/打出任意基本牌或普通锦囊牌（无懈可击除外）时，你可以声明之并将牌堆底两张牌置入弃牌堆，若其颜色与类型均不同，你将视为使用/打出声明的牌。<font color=\"green\"><b>每回合限一次。</b></font>",
