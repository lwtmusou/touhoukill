...
--************************************************
	...
	["bolan"] = "博览",
	[":bolan"] = "当你或你攻击范围内的角色使用锦囊牌时，你可以亮出牌堆顶的两张牌并获得其中的锦囊牌和与之花色相同的牌，将其余的牌置入弃牌堆。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["hezhou"] = "合咒",
	[":hezhou"] = "你可以将两张类别不同的牌于你的回合内当任意非全体性的普通锦囊牌，于回合外当【桃】使用。锦囊牌因此置入弃牌堆后，你可以令一名其他角色获得之。<font color=\"green\"><b>每回合限一次。</b></font>",
...
--************************************************
	...
	["shixue"]= "嗜血",
	[":shixue"]= "<font color=\"blue\"><b>锁定技，</b></font>当你造成1点伤害后，你回复1点体力；准备阶段开始时或当你不以此法回复体力后，若你的体力大于你的体力下限，你失去1点体力，摸两张牌。",
	["ziye"] = "子夜",
