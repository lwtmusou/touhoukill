...
--************************************************
	...
	["suoding"] = "锁定",
	[":suoding"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将一名角色的一张手牌扣置于其人物牌旁，称为“锁定”，若“锁定”数小于3，你可以重复此流程，若如此做，此回合结束时，以此法失去牌的角色获得其人物牌旁的“锁定”。",
	["suoding_cards"] = "锁定",
...
--************************************************
	...
	["bolan"] = "博览",
	[":bolan"] = "当其他角色于其出牌阶段内使用普通锦囊牌时，你可以亮出牌堆顶的两张牌，然后获得其中的锦囊牌和与此牌花色相同的牌。<font color=\"green\"><b>每名角色的每个阶段内限一次。</b></font>",
	["hezhou"] = "合咒",
	[":hezhou"] = "你可以于回合外将两张类别不同的牌当【桃】使用，当以此法使用的牌因结算完毕而置入弃牌堆后，你可以令一名其他角色获得这两张牌中的锦囊牌。",
...
--************************************************
	...
	["beishui"] = "背水",
	[":beishui"] = "你可以将X张牌当任意基本牌使用（X为你的体力值且至少为1）。<font color=\"green\"><b>每名角色的每个阶段内限一次。</b></font>",
--************************************************
	--hmx006  势力：红 3血
	["cirno"] = "琪露诺",
	["#cirno"] = "湖上的冰精",
	...
	["dongjie"] = "冻结",
	[":dongjie"] = "当你使用牌对目标角色造成伤害时，你可以防止此伤害，摸一张牌，然后令其翻面，令其摸一张牌。<font color=\"green\"><b>每名角色的每个阶段内限一次。</b></font>",
...
--************************************************
	...
	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以重复以下流程至多重复X次（X为发动此技能时你已损失的体力值）：你检索一张普通锦囊牌，然后令一名角色获得之，若其不为你，你回复1点体力。",
...
--************************************************
	...
	["@mizong"] = "觅踪" ,
	["yinren"]= "银刃",
	[":yinren"]= "当你使用黑色【杀】指定一个目标后，你可以令其于此【杀】结算完毕之前不能使用或打出红色牌且其除永久技外的技能无效。",
