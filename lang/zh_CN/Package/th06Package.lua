...
return{ ["th06"] = "红魔乡",
	...
	[":skltkexue_attach"]= "当拥有“渴血”的角色处于濒死状态并向你求【桃】时，若你的体力值大于体力下限，你可以失去1点体力并摸两张牌，然后令其回复1点体力。",
	["mingyun"] = "命运",
...
--************************************************
	...
	["yuxue"] = "浴血",
	[":yuxue"] = "当你受到伤害后，你可以使用【杀】，此【杀】无距离限制，且造成的伤害+1。",
	["@yuxue"] = "你可以发动“浴血”，使用【杀】。",
	["#yuxue_damage"]= "%from的“%arg”效果被触发,%from对%to的伤害+1",
	["#yuxue-slash-ndl"] = "浴血（距离）",
	["shengyan"] = "盛宴",
...
--************************************************
	...
	["bolan"] = "博览",
	[":bolan"] = "当其他角色于其出牌阶段使用普通锦囊牌时，你可以亮出牌堆顶的两张牌，你获得其中的锦囊牌和与此牌花色相同的牌。<font color=\"green\"><b>每阶段限一次。</b></font>",
	["hezhou"] = "合咒",
...
--************************************************
	...
	["beishui"] = "背水",
	[":beishui"] = "你可以将X张牌当任意基本牌使用（X为你的体力值且最少为1）。<font color=\"green\"><b>每阶段限一次。</b></font>",
--************************************************
	--hmx006  势力：红 3血
	["cirno"] = "琪露诺",
	["#cirno"] = "湖上的冰精",
	...
	["bingpo"] = "冰魄",
	[":bingpo"] = "<font color=\"blue\"><b>锁定技，</b></font>当你受到火焰伤害以外的伤害时，若此伤害不小于你的体力值，防止此伤害。",
...
--************************************************
	...
	["@mizong"] = "觅踪" ,
	["yinren"]= "银刃",
	[":yinren"]= "当你使用黑色【杀】指定一个目标后，你可令此回合内其不能使用或打出红色牌且其非永久技无效。",
...
--************************************************	
	...
	["xiaoyin"]= "消隐",
	[":xiaoyin"]= "有手牌的其他角色的出牌阶段开始时，若你在其攻击范围内，你可令其将一张手牌当【调虎离山】对你使用（你以外的角色不是此牌的合法目标）。",
	["xiaoyinuse"]= "你须将一张手牌当【调虎离山】对 <font color=\"#FF8000\"><b>%src </b></font> 使用。",
	["~xiaoyinVS"]= "选择一张手牌-->确认。",
	["#xiaoyin"]= "消隐",
	
	["fenghua"]= "风花",
	[":fenghua"]= "<font color=\"blue\"><b>锁定技，</b></font>游戏开始时或当牌从你的人物牌上离开时，将牌堆顶的一张牌置于你的人物牌上，称为“风花”。当你成为其他角色使用【杀】或普通锦囊牌的目标后，若此牌与任意一张“风花”花色相同，此牌对你无效，你获得所有“风花”牌。",
	["$Fenghua"] = "%from 的“%arg” 被触发， 将收回 “%arg” 牌  %card ",
}
