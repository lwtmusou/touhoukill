...
--************************************************
	...
	["hezhou"] = "合咒",
	[":hezhou"] = "你可以于回合外将两张类别不同的牌当【桃】使用，当以此法使用的牌因结算完毕而置入弃牌堆后，你可以令一名其他角色获得两张牌中的锦囊牌。",
...
--************************************************
	...
	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以重复以下流程至多重复X次（X为发动此技能时你已损失的体力值）：你检索一张普通锦囊牌，令一名角色获得之，若其不为你，你回复1点体力。",
