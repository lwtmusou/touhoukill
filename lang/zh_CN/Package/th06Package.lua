...
--************************************************	
	...
	["ziye"] = "子夜",
	[":ziye"] = "<font color=\"purple\"><b>觉醒技，</b></font>当其他角色因你造成的伤害而进入濒死状态时，你减1点体力上限，获得“暗月”（当不处于濒死状态的其他角色回复体力后，若其体力值不小于你，你可以翻面，视为对其使用无视防具的【杀】）。",
	
	["#ZiyeWake"] = "%from 使一名其他角色进入了濒死状态， 触发了“%arg”觉醒",
	["$ziyeAnimate"]= "skill=rumia_sp:ziye",
	["anyue"]= "暗月",
	[":anyue"]= "当其他角色回复体力后，若其不处于濒死状态且体力值不小于你，你可以翻面，视为对其使用无视防具的【杀】。",
}
