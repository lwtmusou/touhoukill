...
--************************************************
	...
	["@moqi"] = "魔契(后续): 你可以选择发动“魔契”的角色并点击 确定 ，令其失去1点体力； \n 或点击 取消 来视为使用果【酒】（用的第一张锦囊牌有增益）",

	["sishu"] = "司书",
	[":sishu"] = "<font color=\"red\"><b>限定技，</b></font>出牌阶段，你可以检索一张普通锦囊牌，令一名角色获得之，若其不为你，你回复1点体力。然后你可以重复此流程（至多重复X次。X为发动此技能时你已损失的体力值）。",
...
--************************************************
	...
	["anyue"]= "暗月",
	[":anyue"]= "当其他角色回复体力后，若其不为体力值唯一最小的角色且不处于濒死状态，你可以翻面，视为对其使用无视防具的【杀】。",
}
