...
--************************************************	
	...
	["shixue"]= "嗜血",
	[":shixue"]= "<font color=\"blue\"><b>锁定技，</b></font>你每造成1点伤害后，回复1点体力。你以此法以外的方式回复体力时，若你不处于濒死状态，防止之。",
	["#shixue1"]= "由于“%arg”的效果，%from 受到的 %arg2 点体力回复效果被防止。",
	["ziye"] = "子夜",
	[":ziye"] = "<font color=\"purple\"><b>觉醒技，</b></font>你杀死一名角色后，你失去1点体力上限，获得技能“暗月”（其他角色回复体力后，若其体力值不小于你且不处于濒死状态，你可以翻面，视为对其使用无视防具的【杀】）。",
	
	["#ZiyeWake"] = "%from 杀死了一名角色， 触发“%arg”觉醒",
