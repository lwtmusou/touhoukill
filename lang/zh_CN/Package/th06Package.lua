...
return{ ["th06"] = "红魔乡",
	...
	["skltkexue"] = "渴血",
	[":skltkexue"] = "当处于濒死状态时的你向其他角色求【桃】时，若其体力值大于其体力下限，其可以失去1点体力，摸两张牌，然后令你回复1点体力。",
...
--************************************************
	...
	["suoding"] = "锁定",
	[":suoding"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一名有手牌的角色，将其一张手牌扣置于其人物牌旁，称为“锁定”，若“锁定”数小于3，你可以重复此流程。若如此做，此回合结束时，以此法失去牌的角色获得其人物牌旁的所有“锁定”。",
	["suoding_cards"] = "锁定",
...
--************************************************
	...
	["hezhou"] = "合咒",
	[":hezhou"] = "你可以于回合外将两张类别不同的牌当【桃】使用，若如此做，当锦囊牌以此法被转化为【桃】使用并因结算完毕而置入弃牌堆后，你可以令一名其他角色获得之。",
...
--************************************************
	...
	["fenghua"]= "风花",
	[":fenghua"]= "<font color=\"blue\"><b>锁定技，</b></font>游戏开始时或当一张“风花”从你的人物牌上移至另一个区域后，你将牌堆顶的一张牌置于人物牌上，称为“风花”；当你成为其他角色使用的【杀】或普通锦囊牌的目标后，若此牌与一张“风花”花色相同，你令此牌对你无效并获得所有“风花”。",
