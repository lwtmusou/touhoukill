return
{
	...
	["doujiu"] = "斗酒",
	[":doujiu"] = "当其他角色于其出牌阶段内对该角色使用【桃】或【酒】时，若该角色的体力值不小于1，你可以摸一张牌并与该角色拼点，若你赢，此牌对该角色无效，你回复1点体力，结束当前阶段。",
	["yanhui"] = "宴会",
	...
	["huiwu"] = "悔悟" ,
	[":huiwu"] = "当你成为其他角色使用的【杀】或非延时类锦囊牌的目标后，该角色可令此牌对你无效并令你摸一张牌。" ,
	["huiwu:target"] = "你使用【%dest】时，指定了<font color=\"#00FF00\"><b>%src </b></font>为目标，你可以对<font color=\"#00FF00\"><b>%src </b></font>发动“悔悟”。" ,
	["huazhong"] = "花冢" ,
	[":huazhong"] = "<font color=\"orange\"><b>主公技，</b></font>每当其他战势力角色造成1点伤害后，该角色可以判定，当红色判定牌生效后，你获得之。" ,
...
--**********************************************
	...
	["origin:yuka_1"] = "p号：42739088，个人ID：800504",--(国人)
	...
	["weiya"] = "威压",
	[":weiya"] = "<font color=\"blue\"><b>锁定技，</b></font>当其他角色于你的回合内使用或打出基本牌或【无懈可击】时（代替判定牌时除外），该角色选择一项：令此牌无效，或弃置一张与此牌名称相同的牌。",
...
--**********************************************
	...
	["origin:medicine_1"] = "p号：39996142，个人ID：144174",--(表态可以)
	["illustrator:medicine_2"] = "亜音",
	["origin:medicine_2"] = "p号：30981893，个人ID：759647",--（国人？）
	...
	["henyi"]= "恨意",
	[":henyi"]= "一名角色的出牌阶段结束时，若你于此回合内受到过伤害，你可视为使用【万箭齐发】。当此【万箭齐发】对当前回合的角色造成伤害时，你回复1点体力。",
...
--**********************************************
	...
	["feixiang"] = "绯想",
	[":feixiang"] = "当判定牌生效前，你可以选择一名角色的一张牌并令该角色打出此牌代替判定牌。",
...
--**********************************************
	...
	["xiwang"] = "希望",
	[":xiwang"] = "<font color=\"orange\"><b>主公技，</b></font>当一名角色于其回合外使用或打出一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌时，若当前回合的角色是其他战势力角色，该战势力角色可以将一张手牌交给你。",
