...
--**********************************************
	...
	["toupai"]= "偷拍",
	[":toupai"]= "摸牌阶段开始时，你可以放弃摸牌并选择一至两名有手牌的其他角色，观看这些角色的各手牌并可以弃置其中的各一张基本牌。",
...
--**********************************************
	...
	[":nengwu"] = "当你于回合外回复体力后/获得牌后，你可令一名体力值/手牌数小于你的角色摸一张牌；当你于回合外受到伤害后/失去手牌后，你可弃置一名体力值/手牌数大于你的角色的一张手牌。",
	["nengwudraw"] = "能舞(摸牌)",
	["nengwudiscard"] = "能舞(弃牌)",
	["@nengwu-draw"] = "你可以令一名体力值/手牌数小于你的其他角色摸 1 张牌。",
	["@nengwu-discard"] = "你可以弃置体力值/手牌数大于你的一名其他角色的 1 张手牌。" ,
	["#nengwu2"] = "能舞",
	["xiwang"] = "希望",
