return
{
	...
	["doujiu"] = "斗酒",
	[":doujiu"] = "当其他角色于其出牌阶段内使用【桃】或【酒】时，你可以摸一张牌并与其拼点：当你赢后，此牌无效，你回复1点体力并结束当前阶段。",
	["yanhui"] = "宴会",
	--[":yanhui"] = "<font color=\"orange\"><b>主公技，</b></font>其他战势力角色可以于其出牌阶段对你使用【桃】；可以当你向其求【桃】时对你使用【酒】。",
...
--**********************************************
	...
	["toupai"]= "偷拍",
	[":toupai"]= "摸牌阶段开始时，你可以放弃摸牌，你可以放弃摸牌并选择一至两名有手牌的其他角色，观看这些角色的各手牌并可以弃置其中的各一张基本牌。",
	["@toupai"]= "<font color=\"orange\"><b>偷拍：</b></font>你可以放弃摸牌并观看一至两名其他角色的手牌，并可以在观看一名角色的手牌时弃置其中的一张基本牌。",
	["~toupai"]= "选择一至两名有牌的其他角色 -> 确定",
	["qucai"]= "取材",
...
--**********************************************
	...
	["feixiang"] = "绯想",
	--[":feixiang"] = "当判定牌生效前，你可以选择一名角色的一张牌，令其展示并打出此牌代替判定牌。",
...
--**********************************************
	...
	["nengwudraw"] = "能舞(摸牌)",
	["nengwudiscard"] = "能舞(弃牌)",
	["@nengwu-draw"] = "你可以令一名攻击范围内的角色摸 1 张牌。",
