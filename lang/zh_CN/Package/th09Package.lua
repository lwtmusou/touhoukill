return
{
	...
	["doujiu"] = "斗酒",
	[":doujiu"] = "当其他角色于其出牌阶段内对该角色使用【桃】或【酒】时，若其体力值不小于1，你可以摸一张牌并与其拼点，若你赢，此牌对其无效，你回复1点体力，结束当前阶段。",
	["yanhui"] = "宴会",
	...
	["shenpan"] = "审判" ,
	[":shenpan"] = "摸牌阶段开始时，你可以放弃摸牌，对一名其他角色造成1点雷电伤害。此阶段结束时，若其手牌数大于其体力值，你摸一张牌。" ,
	["@shenpan-select"] = "你可以对一名其他角色发动“审判”。",
	["huiwu"] = "悔悟",
	[":huiwu"] = "当你成为其他角色使用【杀】或非延时类锦囊牌的目标后，其可令此牌对你无效并令你摸一张牌。" ,
...
--**********************************************
	...
	["dizhen"] = "地震",
	[":dizhen"] = "当一名角色的红色判定牌生效后，若其体力值不小于1，你可以对其造成1点伤害。",
