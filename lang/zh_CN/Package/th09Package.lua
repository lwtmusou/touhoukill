...
--**********************************************
	...
	["toupai"]= "偷拍",
	[":toupai"]= "摸牌阶段开始时，你可以放弃摸牌并选择有手牌的一至两名其他角色，观看这些角色各的手牌并可以弃置各的一张基本牌。",
...
--**********************************************
	...
	["mengxiang"] = "梦乡",
	[":mengxiang"] = "你可以跳过出牌阶段，若如此做，此回合的弃牌阶段结束时，你可以选择X名角色（X为你于此阶段内弃置的牌的牌数），观看这些角色各的手牌并可以使用各的一张手牌，以此法使用牌结算结束后，失去此牌的角色摸一张牌。",
	--（不能使用此阶段内使用过的牌同类型的牌）
