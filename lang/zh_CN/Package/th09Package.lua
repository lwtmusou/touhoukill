...
--**********************************************
	...
	["mianling"] = "面灵",
	[":mianling"] = "<font color=\"blue\"><b>锁定技，</b></font>当你从牌堆获得牌时，你将牌堆顶等量的牌置于人物牌上，称为“面”，然后若“面”数大于X（X为存活角色数），你将多出的“面”都置入弃牌堆；你能使用或打出“面”，以此法使用或打出牌的结算完毕后，你选择一项：弃置一张牌，或失去1点体力。",
	...
	["ximshang"] = "心殇",
	[":ximshang"] = "一名角色的结束阶段开始时，若你于此阶段内失去过牌且此回合内置入弃牌堆的牌有四种不同的花色，你可以对一名角色造成1点伤害。",
