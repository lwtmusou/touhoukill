return
{
	...
	["huiwu"] = "悔悟",
	[":huiwu"] = "当你成为其他角色使用的【杀】或普通锦囊牌的目标后，其可以令此牌对你无效并令你摸一张牌。" ,
	["huiwu:target"] = "你使用【%dest】时，指定了<font color=\"#00FF00\"><b>%src </b></font>为目标，你可以对<font color=\"#00FF00\"><b>%src </b></font>发动其“悔悟”。" ,
	["huazhong"] = "花冢" ,
...
--**********************************************
	...
	["weiya"] = "威压",
	[":weiya"] = "<font color=\"blue\"><b>锁定技，</b></font>当其他角色于你的回合内使用或打出基本牌或【无懈可击】时（除代替或替换判定牌时外），其选择一项：令此牌无效；或弃置一张与之牌名相同的牌。",
...
--**********************************************
	...
	["toupai"]= "偷拍",
	[":toupai"]= "摸牌阶段开始时，你可以放弃摸牌并选择有手牌的一至两名其他角色，观看这些角色各手牌并可以弃置各的一张基本牌。",
	["@toupai"]= "<font color=\"orange\"><b>偷拍：</b></font>你可以放弃摸牌并观看一至两名其他角色的手牌，并可以在观看手牌的同时弃置其中的一张基本牌。",
	["~toupai"]= "选择有手牌的一只两名其他角色 -> 确定",
	["qucai"]= "取材",
...
--**********************************************
	...
	["@feixiang-playerchosen"] = "<font color=\"#00FF00\"><b>%src </b></font> 将要进行 “%dest” 的判定，你可以发动“绯想”，选择一名角色并选择该角色的一张牌。",
	["dizhen"] = "地震",
	[":dizhen"] = "当你使用【杀】指定一名目标后，你可以判定，若结果为红色，你观看其手牌并选择一项：弃置其中的一张牌；或将其中的一张牌置于牌堆顶。",
	["dizhen:put"] = "置于牌堆顶",
	["tianren"] = "天人",
	[":tianren"] = "<font color=\"orange\"><b>主公技，</b></font>当你于回合外需要使用/打出【闪】或【杀】时，你可以令其他战势力角色选择是否打出之（其打出的牌结算完毕后视为你使用/打出此牌）。",
	["@tianren-slash"]= "请打出【杀】响应 %src 的主公技“天人”",
	["@tianren-jink"] = "请打出【闪】响应 %src 的主公技“天人”",
...
--**********************************************
	...
	["kuaizhao"] = "快照",
	[":kuaizhao"] = "摸牌阶段，你可以少摸一张牌并令你攻击范围内的一名角色展示其手牌，若如此做，你摸多摸X张牌（X为其中的基本牌的牌数且至多为2）。",
...
--**********************************************
	...
	[":nengwu"] = "当你于回合外回复体力后/获得牌后，你可以令体力值/手牌数小于你的一名角色摸一张牌；当你于回合外受到伤害后/失去手牌后，你可以弃置体力值/手牌数大于你的一名角色的一张手牌。",
	["nengwudraw"] = "能舞(摸牌)",
	["nengwudiscard"] = "能舞(弃牌)",
	["@nengwu-draw"] = "若你回复了体力，你可以令<font color=\"#90EE90\"><b>体力值</b></font>小于你的一名角色摸一张牌；<br />若你获得了牌，你可以令<font color=\"#90EE90\"><b>手牌数</b></font>小于你的一名角色摸一张牌。",
	["@nengwu-discard"] = "若你受到了伤害，你可以弃置<font color=\"#FFA500\"><b>体力值</b></font>大于你的一名角色的一张手牌；<br />若你失去了手牌，你可以弃置<font color=\"#FFA500\"><b>手牌数</b></font>大于你的一名角色的一张手牌。" ,
	["#nengwu2"] = "能舞",
	["xiwang"] = "希望",
	[":xiwang"] = "<font color=\"orange\"><b>主公技，</b></font>当一名角色于其回合外使用或打出一张<font size=\"5\", color=\"#FF0000\"><b>♥</b></font>牌时，若当前回合的角色是其他战势力角色，其可以将一张手牌交给你。",
...
--**********************************************
	...
	["nianli"] = "念力",
	[":nianli"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以将牌堆顶的两张牌当不计入限制的使用次数的【杀】或【顺手牵羊】使用。若如此做，当你使用此牌指定目标后，你选择一项：将一张与此牌颜色相同的手牌置于牌堆顶；或失去1点体力。",
	["@nianli-discard"] = "念力牌 “%dest” 为 <font color=\"#00FF00\"><b>%src </b></font>， 请展示一张同颜色牌，并将之置于牌堆顶；否则你将失去1点体力。",
	["#nianlimod"] = "念力",

	["shenmi"] = "深秘",
	[":shenmi"] = "摸牌阶段摸牌后，若你的手牌数大于手牌上限，你可以观看牌堆顶的三张牌并改变其中任意数量的牌的顺序。",
	["liqun"] = "离群",
...
--**********************************************
	--zhan012  势力：战 4血
	["sumireko_sp"] = "密封梦魇堇子",
	[":sumireko_sp"] = "密封梦魇日记", --TODO 天子请修改称号
	...
	["mengxiang"] = "梦乡",
	[":mengxiang"] = "你可以跳过出牌阶段，若如此做，本回合的弃牌阶段结束时，你可以选择X名角色，依次执行：你观看其手牌，并可以使用其中一张牌（不能使用此阶段内使用过的牌同类型的牌），若如此做，该角色摸一张牌。X为此阶段你的弃牌数。",
	["@mengxiang"] = "A.你可以发动“梦乡”，观看目标的手牌并使用之",
	["@mengxiang_use"] = "B.你现在可使用 <font color=\"#00FF00\"><b>%src </b></font> 的一张手牌",
	["~mengxiang"] = "A.选择观看手牌的目标 ->确定<br> B.选择要使用的牌和牌的目标： ->确定",
	["$mengxiang"] = "%from 发动“%arg” 使用 %to 的 %card ",
	["mengxiangtarget"] = "梦乡",
	
	["jishi"] = "记事",
	[":jishi"] = "当你因非使用而失去的手牌进入弃牌堆时，你可以将其中任意数量的牌任意置于牌堆顶。",
	["#jishi_temp"] = "记事",
	["@jishi"] = "你可以发动“记事”，将牌置于牌堆顶",
	["~jishi"] = "先选择所有要放于牌堆顶的牌并确定 -> 接下来才会进行调整牌序的操作",
